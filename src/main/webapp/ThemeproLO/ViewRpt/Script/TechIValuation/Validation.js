...
"aoColumnDefs": [ 
	   { "sClass": "dpass", "aTargets": jQuery.parseJSON(hideClm)},
		...
		var rowno = meta.row;	 
		var HTML =	'<span><input type="text" id="PLAG_LNDASPERDOC'+rowno+'"  name="PLAG_LNDASPERDOC'+rowno+'" maxlength="10" data-item="Docu" class="form-control NoSpecialChar LandMultp TOTVAL LandMin form-control IsNumberFields">';			 
		HTML = HTML + '</span>'; 
		...
		if ($(htmldata).find('[name=PLAG_LNDASPERDOC'+rowno+']').hasClass("IsCURCommaFields"))
		 ...
		 { targets: 2, "render": function ( data, type, row, meta ) {                            
				...
				var rowno = meta.row;	 
				var HTML =	'<span><input type="text" id="PLAG_LNDACTUAL'+rowno+'"  name="PLAG_LNDACTUAL'+rowno+'" maxlength="10" data-item="Actual" class="form-control LandMultp TOTVAL LandMin NoSpecialChar form-control IsNumberFields">';			 
				HTML = HTML + '</span>'; 
				...
				if ($(htmldata).find('[name=PLAG_LNDACTUAL'+rowno+']').hasClass("IsCURCommaFields"))
				 ...
				 { targets: 3, "render": function ( data, type, row, meta ) {                            
						...
						var rowno = meta.row;	 
						var HTML =	'<span><input type="text" id="PLAG_LNAAREACONSD'+rowno+'"  name="PLAG_LNAAREACONSD'+rowno+'" maxlength="10" data-item="Area" disabled class="form-control TOTVAL LandMultp NoSpecialChar DSVLBL form-control IsNumberFields">';			 
						HTML = HTML + '</span>'; 
		 ...
		 { targets: 4, "render": function ( data, type, row, meta ) {                            
				...
				var rowno = meta.row;	 
				var HTML =	'<span><input type="text" id="PLAG_LNDRATSQFT'+rowno+'"  name="PLAG_LNDRATSQFT'+rowno+'" maxlength="10" data-item="Rate" class="form-control form-control NoSpecialChar LandMultp TOTVAL IsCURCommaFields IsNumberFields">';			 
				HTML = HTML + '</span>'; 
				...
				if ($(htmldata).find('[name=PLAG_LNDRATSQFT'+rowno+']').hasClass("IsCURCommaFields"))
				 ...
				 { targets: 5, "render": function ( data, type, row, meta ) {                            
						...
						var rowno = meta.row;	 
						var HTML =	'<span><input type="text" id="PLAG_LNDTOTVAL'+rowno+'"  name="PLAG_LNDTOTVAL'+rowno+'" maxlength="10" data-item="Result" disabled class="form-control NoSpecialChar TOTVAL IsCURCommaFields DSVLBL form-control IsNumberFields">';			 
						HTML = HTML + '</span>'; 
...
"aoColumnDefs": [ 
	   { "sClass": "dpass", "aTargets": jQuery.parseJSON(hideClm)},
		...
		var rowno = meta.row;	 
		var HTML =	'<span><input type="text" id="PBDG_BUILDASPERDOC'+rowno+'"  name="PBDG_BUILDASPERDOC'+rowno+'" maxlength="10" data-total1="THVD_CONSASPERDOC" data-total="THVD_CONSTOTVAL|THVD_TOTEXTIMVAL|PLAG_LNDTOTVAL" data-item="Docu" class="form-control FloorTot4 FloorTot FloorMin NoSpecialChar form-control">';			 
		HTML = HTML + '</span>'; 
			 
		var htmldata = $(HTML);
			
		if ($(htmldata).find('[name=PBDG_BUILDASPERDOC'+rowno+']').hasClass("IsCURCommaFields"))
			{
			data = CURCommaSep(data);
			}
			
			$(htmldata).find('[name=PBDG_BUILDASPERDOC'+rowno+']').attr("value",data);
		 ...
		 { targets: 2, "render": function ( data, type, row, meta ) {                            
				...
				var rowno = meta.row;	 
				var HTML =	'<span><input type="text" id="PBDG_BUILDACTUAL'+rowno+'"  name="PBDG_BUILDACTUAL'+rowno+'" maxlength="10" data-item="Actual" data-total1="THVD_CONSASPERACTUAL" data-total="THVD_CONSTOTVAL|THVD_TOTEXTIMVAL|PLAG_LNDTOTVAL" class="form-control FloorTot4 FloorTot1 FloorMin NoSpecialChar form-control">';			 
				HTML = HTML + '</span>'; 
					 
				var htmldata = $(HTML);
					
				if ($(htmldata).find('[name=PBDG_BUILDACTUAL'+rowno+']').hasClass("IsCURCommaFields"))
					{
					data = CURCommaSep(data);
					}
					$(htmldata).find('[name=PBDG_BUILDACTUAL'+rowno+']').attr("value",data);
					return htmldata[0].outerHTML;      		
		         } 
				 },
				 { targets: 3, "render": function ( data, type, row, meta ) {                            
						...
						var rowno = meta.row;	 
						var HTML =	'<span><input type="text" id="PBDG_BUILDAREACONSD'+rowno+'"  name="PBDG_BUILDAREACONSD'+rowno+'" maxlength="10" data-item="Area" data-total1="THVD_CONSAREACONS" data-total="THVD_CONSTOTVAL|THVD_TOTEXTIMVAL|PLAG_LNDTOTVAL" disabled class="form-control FloorTot4 FloorTot2 DSVLBL NoSpecialChar form-control">';			 
						HTML = HTML + '</span>'; 
							 
						var htmldata = $(HTML);
							
						if ($(htmldata).find('[name=PBDG_BUILDAREACONSD'+rowno+']').hasClass("IsCURCommaFields"))
							{
							data = CURCommaSep(data);
							}
							$(htmldata).find('[name=PBDG_BUILDAREACONSD'+rowno+']').attr("value",data);
							return htmldata[0].outerHTML;      		
				         } 
						 },
		 { targets: 4, "render": function ( data, type, row, meta ) {                            
				...
				var rowno = meta.row;	 
				var HTML =	'<span><input type="text" id="PBDG_BUILDRATSQFT'+rowno+'"  name="PBDG_BUILDRATSQFT'+rowno+'" maxlength="15" data-item="Rate" data-total1="THVD_CONSASPERRATE" data-total="THVD_CONSTOTVAL|THVD_TOTEXTIMVAL|PLAG_LNDTOTVAL" class="form-control form-control FloorTot4 FloorTot3 NoSpecialChar FloorMultp IsCURCommaFields IsNumberFields">';			 
				HTML = HTML + '</span>'; 
					 
				var htmldata = $(HTML);

				if ($(htmldata).find('[name=PBDG_BUILDRATSQFT'+rowno+']').hasClass("IsCURCommaFields"))
					{
					data = CURCommaSep(data);
					}
					$(htmldata).find('[name=PBDG_BUILDRATSQFT'+rowno+']').attr("value",data);
				 ...
				 { targets: 5, "render": function ( data, type, row, meta ) {                            
						...
						var rowno = meta.row;	 
						var HTML =	'<span><input type="text" id="PBDG_BUILDTOTVAL'+rowno+'"  name="PBDG_BUILDTOTVAL'+rowno+'" maxlength="10" data-item="Result" disabled data-total="THVD_CONSTOTVAL|THVD_TOTEXTIMVAL|PLAG_LNDTOTVAL" class="form-control FloorTot4 DSVLBL NoSpecialChar IsCURCommaFields form-control">';			 
						HTML = HTML + '</span>'; 
							 
						var htmldata = $(HTML);
							
						if ($(htmldata).find('[name=PBDG_BUILDTOTVAL'+rowno+']').hasClass("IsCURCommaFields"))
							{
							data = CURCommaSep(data);
							}
							$(htmldata).find('[name=PBDG_BUILDTOTVAL'+rowno+']').attr("value",data);
							return htmldata[0].outerHTML;      		
				         } 
						 },
						 {
			       			 targets: 7, "render": function ( data, type, row, meta ) {
			       				var rowno = meta.row; 
			           				...
			           				var HTML =	'<span><img src="ThemeproLO/Common/Images/Delete_Img.png"  class="DELETEFLOOR" title="Delete" attr-Upd="ACTION'+rowno+'"  width="20" height="20"/>';			 
			        				HTML = HTML + '</span>';  
			        				var htmldata = $(HTML);				
			        				return htmldata[0].outerHTML;
...
"aoColumnDefs": [ 
	   { "sClass": "dpass", "aTargets": jQuery.parseJSON(hideClm)},
		...
		var rowno = meta.row;	 
		var HTML =	'<span><input type="text" id="TEVL_AMENTIESNAME'+rowno+'"  name="TEVL_AMENTIESNAME'+rowno+'" maxlength="25" data-item="Docu" data-total="" class=" NoSpecialChar AMENAME form-control">';			 
		HTML = HTML + '</span>'; 
			 
		var htmldata = $(HTML);
			

		if ($(htmldata).find('[name=TEVL_AMENTIESNAME'+rowno+']').hasClass("IsCURCommaFields"))
			{
			data = CURCommaSep(data);
			}
			
		
			$(htmldata).find('[name=TEVL_AMENTIESNAME'+rowno+']').attr("value",data);
		 ...
		 { targets: 1, "render": function ( data, type, row, meta ) {                            
				...
				var rowno = meta.row;	 
				var HTML =	'<span><input type="text" id="TEVL_AMENTIESVALUE'+rowno+'"  name="TEVL_AMENTIESVALUE'+rowno+'" maxlength="25"   data-item="AMEVAL" class="form-control IsCURCommaFields NoSpecialChar AMENAME IsNumberFields Amenitval form-control">';			 
				HTML = HTML + '</span>'; 
					 
				var htmldata = $(HTML);
					

				if ($(htmldata).find('[name=TEVL_AMENTIESVALUE'+rowno+']').hasClass("IsCURCommaFields"))
					{
					data = CURCommaSep(data);
					}
					
				
					$(htmldata).find('[name=TEVL_AMENTIESVALUE'+rowno+']').attr("value",data);
				 ...
				 { targets: 2, "render": function ( data, type, row, meta ) {                            
						...
						var rowno = meta.row;	 
						var HTML =	'<span><input type="text" id="TEVL_REFID'+rowno+'"  name="TEVL_REFID'+rowno+'" maxlength="25" data-total="" data-item="Actual" class="form-control    form-control">';			 
						HTML = HTML + '</span>'; 
							 
						var htmldata = $(HTML);
							

						if ($(htmldata).find('[name=TEVL_REFID'+rowno+']').hasClass("IsCURCommaFields"))
							{
							data = CURCommaSep(data);
							}
							
						
							$(htmldata).find('[name=TEVL_REFID'+rowno+']').attr("value",data);
						 ...
						 
			           	  {
			       			 targets: 3, "render": function ( data, type, row, meta ) {
			       				var rowno = meta.row; 
			           				...
			           				var HTML =	'<span><img src="ThemeproLO/Common/Images/Delete_Img.png"  class="DELETEAMTIES" title="Delete" attr-Upd="ACTION'+rowno+'"  width="20" height="20"/>';			 
			        				HTML = HTML + '</span>';  
			        				var htmldata = $(HTML);				
			        				return htmldata[0].outerHTML;
