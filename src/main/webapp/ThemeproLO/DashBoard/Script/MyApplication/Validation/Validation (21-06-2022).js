...
function GridControlMIG (popTableModPageGrid1,TableID,dtData,dtcolumn,hideClm)
 {
...
"aoColumnDefs": [ 
	   ...
	   { targets: 0, "render": function ( data, type, row, meta ) {                            
			   ...
			   var rowno = meta.row;	
				var HTML =	'<span class="MigWF1"><input type="text" style="display:none" value="'+data+'" id="APPLNO'+rowno+'"  name="APPLNO" maxlength="10" class="form-control ">';			
				HTML = HTML + '<div class="HyperControls">'
				HTML = HTML + '<a type="button" class="Btxt4" href="#">'+data+'</a>'
				HTML = HTML + ' </div></span>'
