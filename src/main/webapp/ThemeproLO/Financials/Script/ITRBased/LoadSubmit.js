$(document).ready(function () {
	...
	$("#CITR_SCHEMEID").attr("value",$(".FormPageMultiTab li.active").attr("id"));
	$("#CITR_SCHEMENAME").attr("value",$(".FormPageMultiTab li.active").text());
	...
	FormDataFromDB("LSW_TITRBASEDDETAILS","CITR_", "CITRDBfields", "CITR_SCHEMEID")
	$("#CITR_PRCSID").val($("#PrcsID").val())
   ...
   if($(OP).find("LOANID").text()!="")
		...
		var CHKresult = FormDataToDB(tbl,prfx,$("#CITR_PRCSID").val()+"|"+$("#"+DATA).val()+"|" + DATA);
		if(CHKresult == "Fail")
	   		{
