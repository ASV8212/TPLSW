			 ...
			 var rowno = meta.row;	 
				...
				if ($(htmldata).find('[name=BUBM_DADE5TH'+rowno+']').hasClass("IsCURCommaFields"))
				 ...
				 { targets: 3, "render": function ( data, type, row, meta ) {                            
					 ...
					 var rowno = meta.row;	 
						var HTML =	'<span><input type="text" id="BUBM_DADE30TH'+rowno+'"  name="BUBM_DADE30TH'+rowno+'" maxlength="30" data-item="Amount" data-total="FCBD_AVG" class="form-control IsNumberFields IsCURCommaFields FinYrIncm form-control">';			 
						HTML = HTML + '</span>'; 
