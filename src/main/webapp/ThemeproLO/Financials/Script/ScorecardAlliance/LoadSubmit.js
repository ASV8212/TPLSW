var drpdwn = UI_getdata($("#PrcsID").val(),"","","","","LSW_SGETSCORECARDDRPDWN");
var obj = JSON.parse($(drpdwn).find("Result").text());
...
$(document).ready(function() {
    ...
    $(document).on("click", ".FormSave", function() {
       ...
       var CRSM_SCOREDET = TxtGridsubmitdata_SV1("Table2","CRSC_","CRSM_");
