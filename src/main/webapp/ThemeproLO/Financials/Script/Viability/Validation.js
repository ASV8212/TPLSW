...
"aoColumnDefs": [ 
	   { "sClass": "dpass", "aTargets": jQuery.parseJSON(hideClm)},
				 ...
				 { targets: 1, "render": function ( data, type, row, meta ) { 
					 ...
					 var rowno = meta.row;	 
						var HTML =	'<span><input type="text"  id="VRSG_MONTH1'+rowno+'" style="width:160px"  name="VRSG_MONTH1'+rowno+'" data-item="Amount" data-itemr="Amount" data-totalr="ITRVAL" data-total="EGCD_FINYRTOT" disabled maxlength="30" class="form-control NoSpecialChar IsCURCommaFields DSVLBL form-control VBSALDTL ">';			 
						HTML = HTML + '</span>'; 
						...
						if ($(htmldata).find('[name=VRSG_MONTH1'+rowno+']').hasClass("IsCURCommaFields"))
						 ...
						 { targets: 2, "render": function ( data, type, row, meta ) {                            
							 ...
							 var rowno = meta.row;	 
								var HTML =	'<span><input type="text"  id="VRSG_MONTH2'+rowno+'" style="width:160px" name="VRSG_MONTH2'+rowno+'" disabled data-item="Amount" data-itemr="Amount" data-totalr="ITRVAL" maxlength="30" data-total="EGCD_FINYRTOT" class="form-control NoSpecialChar IsCURCommaFields form-control DSVLBL VBSALDTL ">';			 
								HTML = HTML + '</span>'; 
						 ...
						 /*data-item="Amount" data-itemr="Amount" data-totalr="ITRVAL" data-total="EGCD_FINYRTOT"*/
						  ...
						  { targets: 4, "render": function ( data, type, row, meta ) {                            
							    ...
							    var rowno = meta.row;	 
								var HTML =	'<span><input type="text" disabled id="VRSG_AVERAGE'+rowno+'" disabled style="width:160px" name="VRSG_AVERAGE'+rowno+'" data-item="Average" maxlength="15" class="form-control NoSpecialChar IsCURCommaFields form-control DSVLBL">';			 
								    HTML = HTML + '</span>'; 
