		        ...
		        return htmldata[0].outerHTML;   		
				 ...
				 { targets: 3, "render": function ( data, type, row, meta ) {                            
						...
						if((row[2]=="")||(row[2]=="Yes"))
							{
							var rowno = meta.row;	 
							var HTML =	'<span><button type="button" style="display:none" id="RaiseQuery'+rowno+'" data-uniq-type="CAM Checklist" data-quey-sec="S05" data-aria="" data-form="PersonalInfo" style="height:15px" class="btn btn-Syeloutline waves-effect waves-light BTNDedupe PODSave RaiseQry">Raise Query</button>';			 
							HTML = HTML + '</span>'; 
							var htmldata = $(HTML);							
							return htmldata[0].outerHTML;  
							}
							...
							var rowno = meta.row;	 
							var HTML =	'<span><button type="button" id="RaiseQuery'+rowno+'" data-aria="" data-uniq-type="CAM Checklist" data-quey-sec="S05" data-form="PersonalInfo" style="height:15px" class="btn btn-Syeloutline waves-effect waves-light BTNDedupe PODSave RaiseQry">Raise Query</button>';			 
							HTML = HTML + '</span>'; 
							var htmldata = $(HTML);							
							return htmldata[0].outerHTML;  
						}
