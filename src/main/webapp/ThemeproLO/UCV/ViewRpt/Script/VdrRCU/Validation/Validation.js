			 ...
			 { targets: 14, "render": function ( data, type, row, meta ) {  
				 ...
				 ,
				  { targets: 16, "render": function ( data, type, row, meta ) {                            
       				...
       				var rowno = meta.row;       			 
       	       		var HTML =    '<span><select  class="Gridmdb-select md-form colorful-select dropdown-primary "  id="RCKY_RCUSTATUS'+rowno+'" name="RCKY_RCUSTATUS">';
       	       			HTML = HTML + '<option value="">Select</option>';
       	...
       	/*	 { targets: 2, "render": function ( data, type, row, meta ) {                            
			...
			var	HTML =  HTML + '<input type="hidden" id="RCOD_DOCNAME'+rowno+'"  name="RCOD_DOCNAME" disabled class="form-control DSVLBL form-control">';
				 ...
				 ,{ targets: 16, "render": function ( data, type, row, meta ) {                            
       				...
       				var rowno = meta.row;       			 
       	       		var HTML =    '<span><select class="Gridmdb-select md-form colorful-select dropdown-primary "  id="RCOD_RCUSTATUS'+rowno+'" name="RCOD_RCUSTATUS">';
       	       			HTML = HTML + '<option value="">Select</option>';
