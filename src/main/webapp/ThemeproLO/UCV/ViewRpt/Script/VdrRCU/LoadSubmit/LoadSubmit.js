...
//	 $("#IRCM_CUSID").val('C1104578')
	...
	//  {
	 ...
	 FormDataFromDB("LSW_TUPLOADDOCUMENT","IRCM_","IRCMDBfields", DATA);
	 ...
	 LoadMultiData("",$("#PrcsID").val(),$("#RCBK_CUSID").val(),"BankDetail1","RCBKDBfields","LSW_SGETRCUCUSWSACCNT");
	  LoadMultiData("",$("#PrcsID").val(),$("#RCBK_CUSID").val(),"BankDetail2","RPRDDBfields","LSW_SRCURPRDROPDTL");
...
/* 
	...
	/* --9,10,11,12,14,15 */
		 ...
		 FncallDocChkLst(this,'Table2',{spname:'LSW_TRCUKYCDOCUMENTLIST',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:'KYCDOC',brid:$('#PrcsID').val(),MnuId:$('#IRCM_CUSID').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||'+$("#HIDDENCOL").val(),'DocumentCheckList');
		 FncallDocChkLst(this,'Table3',{spname:'LSW_TRCUKYCDOCUMENTLIST',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:'Others',brid:$('#PrcsID').val(),MnuId:$('#IRCM_CUSID').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||'+$("#HIDDENCOL").val(),'DocumentCheckListOthers');
		 FncallDocChkLst(this,'Table4',{spname:'LSW_SRCUGETDEFRPFDTL',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:'',brid:$('#PrcsID').val(),MnuId:$('#IRCM_CUSID').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||','PFDEFR');
	...
	$('.FormSave').on('click', function() {
		...
		MndtryChk = CheckDocMndtry("Table2","RCKYGRDMNDTRY","KYC");
		if(MndtryChk != "")
			{
			alert(MndtryChk);
			return;
			}
		MndtryChk = CheckDocMndtry("Table3","RCODGRDMNDTRY","Others");
		if(MndtryChk != "")
			{
			alert(MndtryChk);
			return;
