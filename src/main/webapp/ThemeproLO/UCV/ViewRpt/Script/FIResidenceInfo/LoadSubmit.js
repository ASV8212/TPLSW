...
//	FormDataFromDB(tbl, prfx + "_", prfx+"DBfields", DATA);
	...
	$("#AudTrl").hide();
	 ...
	 for (i=0;i<row;i++)
	 {
	   ...
	   $("#FIAD_EXTERCOMMM option[value='"+EXTERCOMMMIVal[i]+"']").attr("selected","selected")
		 }
	 }
	 ...
	 for (i=0;i<row;i++)
	 {
	   ...
	   $("#FIAD_INTERERRESID option[value='"+INTERERRESIDIVal[i]+"']").attr("selected","selected")
		 }
	 }
	 ...
	 for (i=0;i<row;i++)
	 {
	   ...
	   $("#FIAD_ASSTSEENRESID option[value='"+ASSTSEENRESIDIVal[i]+"']").attr("selected","selected")
		 }
	 }
	 ...
	 for (i=0;i<row;i++)
	 {
	  ...
	  $("#FIAD_REASONS option[value='"+REASONSIVal[i]+"']").attr("selected","selected")
		 }
	 }
