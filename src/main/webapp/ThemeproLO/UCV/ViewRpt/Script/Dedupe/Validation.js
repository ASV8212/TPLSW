...
"aoColumnDefs": [ 
	   ...
	   { targets: 0, "render": function ( data, type, row, meta ) {                            
			 ...
			 var rowno = meta.row;	 
				var HTML =	'<span><input type="text" id="DEGR_LONTYPE'+rowno+'" style="width:150px"  name="DEGR_LONTYPE'+rowno+'" disabled class="form-control DSVLBL form-control DEGRDBfields">';			 
				HTML = HTML + '</span>'; 
		 ...
		 { targets: 1, "render": function ( data, type, row, meta ) {                            
			 ...
			 var rowno = meta.row;	 
				var HTML =	'<span><input type="text" id="DEGR_AGREEMENTNO'+rowno+'" style="width:200px" data-field="DEGR_AGREEMENTNO'+rowno+'|Percentage" name="DEGR_AGREEMENTNO'+rowno+'" disabled data-item="Percentage" data-total="EGCD_FINYRTOT" maxlength="3" class="form-control DSVLBL NoSpecialChar IsNumberFields form-control DEGRDBfields">';			 
				HTML = HTML + '</span>'; 
				...
				if ($(htmldata).find('[name=DEGR_AGREEMENTNO'+rowno+']').hasClass("IsCURCommaFields"))
				 ...
				 { targets: 2, "render": function ( data, type, row, meta ) {                            
					 ...
					 var rowno = meta.row;	 
						var HTML =	'<span><input type="text" id="DEGR_LONAMT'+rowno+'" style="width:200px"  name="DEGR_LONAMT'+rowno+'" data-item="Amount" data-itemr="Amount" data-totalr="ITRVAL" disabled data-total="DEGR_LONAMT" maxlength="15" class="form-control DSVLBL NoSpecialChar IsCURCommaFields form-control DEGRDBfields">';			 
						HTML = HTML + '</span>'; 
						...
						if ($(htmldata).find('[name=DEGR_LONAMT'+rowno+']').hasClass("IsCURCommaFields"))
						 ...
						 { targets: 3, "render": function ( data, type, row, meta ) {                            
			 				...
			 				{
							 var rowno = meta.row;	 
								var HTML =	'<span><input type="text" id="DEGR_POS'+rowno+'" style="width:150px" name="DEGR_POS'+rowno+'" data-item="Amount" data-itemr="Amount" data-totalr="ITRVAL" maxlength="30" data-total="DEGR_POS" class="form-control POS IsCURCommaFields form-control DEGRDBfields">';			 
								HTML = HTML + '</span>'; 
                            ...
                            {
							 var rowno = meta.row;	 
								var HTML =	'<span><input type="text" id="DEGR_POS'+rowno+'" style="width:150px" name="DEGR_POS'+rowno+'" data-item="Amount" data-itemr="Amount" data-totalr="ITRVAL" maxlength="30" data-total="DEGR_POS" disabled class="form-control NoSpecialChar DSVLBL IsCURCommaFields form-control DEGRDBfields">';			 
								HTML = HTML + '</span>'; 
					 ...
					 { targets: 4, "render": function ( data, type, row, meta ) {                            
						 ...
						 var rowno = meta.row;	 
							var HTML =	'<span><input type="text" id="DEGR_MOB'+rowno+'" style="width:100px" name="DEGR_MOB'+rowno+'" data-item="Amount" disabled data-itemr="Amount" data-totalr="ITRVAL" data-total="DEGR_MOB" maxlength="15" class="form-control NoSpecialChar DSVLBL IsCURCommaFields form-control DEGRDBfields">';			 
							HTML = HTML + '</span>'; 
						 ...
						 { targets: 5, "render": function ( data, type, row, meta ) {                            
							 ...
							 var rowno = meta.row;	 
								var HTML =	'<span><input type="text" id="DEGR_NOOFBOUNCE'+rowno+'" style="width:100px" name="DEGR_NOOFBOUNCE'+rowno+'" data-item="Average" maxlength="15" disabled class="form-control NoSpecialChar DSVLBL form-control DEGRDBfields  ">';			 
								HTML = HTML + '</span>'; 
					 ...
					 { targets: 6, "render": function ( data, type, row, meta ) {                            
						 ...
						 var rowno = meta.row;	 
							var HTML =	'<span><input type="text" id="DEGR_CURRESTATUS'+rowno+'" style="width:100px" name="DEGR_CURRESTATUS'+rowno+'" data-item="Average" maxlength="15" disabled class="form-control NoSpecialChar DSVLBL form-control DEGRDBfields ">';			 
							HTML = HTML + '</span>'; 
