...
function GentrateDisbMemo()
{
	...
	//  if($("#VERTICAL").val()=="UCV")
	  //{
		var flname = IOP+LoadFrmXML("RT0120")+"&__format=pdf&param1="+PrcsId+"&param2="+UniqId+"&param3="+Year+"&param4="+Consolid+"&__filename=Disbursement_Memo_"+$(".FormPageMultiTab li.active").text()+".pdf";
	//  }
...
//	var flname = IOP+LoadFrmXML("RT087")+"&__format=pdf&@param1="+$("#DMY7").val().split("|")[7]+"&@param2=""&@param3=""&@param4=""&__filename=DM_"+$("#DMY7").val().split("|")[7]+".pdf";
		//var flname = IOP+LoadFrmXML("RT0120")+"&__format=pdf&param1="+$("#DMY7").val().split("|")[7]+"&__filename=Disbursement_Memo_"+$(".FormPageMultiTab li.active").text()+".pdf";
		var flname = IOP+LoadFrmXML("RT0120")+"&__format=pdf&param1="+PrcsId+"&param2="+UniqId+"&param3="+Year+"&param4="+Consolid+"&__filename=Applicform_"+$(".FormPageMultiTab li.active").text()+".pdf";
...
function HndlPEMI(HTML,i){
	...
	else
	{
	   ...
	   if(DISBAMT=="")
		...
		var TotalDET=parseInt(OTHRDEDUCTION)
