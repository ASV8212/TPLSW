        ...
        "aoColumnDefs": [{
...

            {
                ...
                "render": function(data, type, row, meta) {
                	...
                	else if(((activityname=="BranchOPS")&&(row[4] !="OTC" && row[4] !="PDD"))||((activityname=="BranchOPS")&&(row[4] =="OTC" || row[4] =="PDD")&&(row[9]=="Rejected")))
					{
						var rowno = TableID+meta.row;
						var HTML = '<span><input type="radio" class="custom-control-input FRSTDISB GridMndtry ODCLDBfields" value="Yes" id="FRSTDISBYes' + rowno + '" name="ODCL_FRSTDISB' + rowno + '"><label class="custom-control-label" for="FRSTDISBYes' + rowno + '">Yes</label>';
						if($("#DMY7").val().split("|")[8] != "ML01" && $("#VERTICAL").val()!="UCV Eco")
						{
						HTML = HTML + '<input type="radio" class="custom-control-input FRSTDISB GridMndtry ODCLDBfields" value="N/A" id="FRSTDISBNA' + rowno + '" name="ODCL_FRSTDISB' + rowno + '"><label class="custom-control-label" for="FRSTDISBNA' + rowno + '">N/A</label>';
						...
						else if($("#DMY7").val().split("|")[8] == "ML01" && $("#VERTICAL").val()!="UCV Eco"){
    ...
    popTableModPageGrid1 = $('#' + TableID).DataTable({
        ...
        "aoColumnDefs": [{
            ...
            },
            {
                targets: 7,
                "render": function(data, type, row, meta) {
					if(row[4] != "OTC" && row[4] != "PDD" && $("#hiddenactivity").val()=="OPSQD"){
                    var rowno = TableID+meta.row;
                    var HTML = '<span><input type="radio" class="custom-control-input GridMndtry ODCLDBfields" value="Yes" id="OTHRSTATSYes22' + rowno + '" name="ODCL_OTHRSTATS' + rowno + '"><label class="custom-control-label" for="OTHRSTATSYes22' + rowno + '">Yes</label>';
                    HTML = HTML + '<input type="radio" class="custom-control-input GridMndtry ODCLDBfields" value="No" id="OTHRSTATSNo22' + rowno + '" name="ODCL_OTHRSTATS' + rowno + '"><label class="custom-control-label" for="OTHRSTATSNo22' + rowno + '">No</label>';
                    HTML = HTML + '<input type="radio" class="custom-control-input GridMndtry ODCLDBfields" value="N/A" id="OTHRSTATSNA22' + rowno + '" name="ODCL_OTHRSTATS' + rowno + '"><label class="custom-control-label" for="OTHRSTATSNA22' + rowno + '">N/A</label></span>';
					...
					else if(row[4] != "OTC" && row[4] != "PDD" && $("#hiddenactivity").val()!="OPSQD"){
						var rowno = TableID+meta.row;
