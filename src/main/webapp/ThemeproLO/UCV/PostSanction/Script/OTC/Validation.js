        ...
        "aoColumnDefs": [{
            ...
            { targets: 3, "render": function ( data, type, row, meta ) {                            
      	 		 if((row[1] == "Approved" && row[3]=="" )||(row[1] == "Approved" && row[3]!="" && row[11]=="Rejected"))
      	 			 {
      	 			var rowno = meta.row;	
      	 			var HTML =	'<span><input type="radio" class="custom-control-input OOTDRADIOCHK OOTDDBfields" value="Collected" id="Collected'+rowno+'" name="OOTD_STUS'+rowno+'"><label class="custom-control-label" for="Collected'+rowno+'">Collected</label>';
      	 			HTML = HTML + '<input type="radio" class="custom-control-input OOTDRADIOCHK OOTDDBfields" value="Waiver" id="Waiver'+rowno+'" name="OOTD_STUS'+rowno+'"><label class="custom-control-label" for="Waiver'+rowno+'">Waiver</label>'
      	      		HTML = HTML + '<input type="radio" class="custom-control-input OOTDRADIOCHK OOTDDBfields" value="PDD" id="PDD'+rowno+'" name="OOTD_STUS'+rowno+'"><label class="custom-control-label" for="PDD'+rowno+'">PDD</label></span>';			  
      	      		var htmldata = $(HTML);
