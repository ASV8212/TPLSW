      		   ...
      		   },
      		 {
                   ...
                   "render": function(data, type, row, meta) {
                	   if(row[5]!="Approved" && row[8]=="Y"){
                   		var rowno = meta.row;
                           var HTML = '<span><div class="HyperControls "><i class="fa fa-check"></i><a  class="Btxt4 APCDSTATUS BTNHIDE" id="Approve'+ rowno +'" name="Approve'+ rowno +'" data-value="Approve" data-table="TableRR" href="#">Approve</a></div>';
                          
						  if (row[5] =="Rejected")
						  {
						HTML = HTML + '<div class="HyperControls"><i class="fa fa fa-times"></i><a  class="Btxt27 APCDSTATUS BTNHIDE" id="Reject'+ rowno +'" name="Reject'+ rowno +'"  data-table="TableRR" href="#">Reject</a></div>';
						  }
						  else
						  {
							   HTML = HTML + '<div class="HyperControls"><i class="fa fa fa-times"></i><a  class="Btxt4 APCDSTATUS BTNHIDE" id="Reject'+ rowno +'" name="Reject'+ rowno +'"  data-table="TableRR" href="#">Reject</a></div>';
						  }
