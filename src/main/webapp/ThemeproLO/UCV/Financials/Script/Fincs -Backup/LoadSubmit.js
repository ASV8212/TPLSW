		...
		var HARDSTP = UI_getdata($("#PrcsID").val(),"CAM","","","","LSW_SOVERALLSTAGVALDT ");
		 ...
		 var LoanAmt=$(".LoanAmt").val()	
			...
			var FormName=$(this).attr("data-form")
			  ...
			  if(FormName=="CAM")
				  {
				  var RTRCAMGRID = TxtGridsubmitdata_V1("Table2","FRCC_","RCCM_");
				    AssignGridXmltoField("RCCM_RTRCAMGRD", RTRCAMGRID)
				  var RCCM_COAPPLIST = TxtGridsubmitdata_V2("CAMChecklist","CACL_","RCCM_","CACLDBfields"); 
		             AssignGridXmltoField("RCCM_COAPPLIST", RCCM_COAPPLIST)
					 $("#CAM").val('Yes')
				  }
			  else if(FormName=="EXLON")
			    {
				  var RTREXISTGRID = TxtGridsubmitdata_V1("Table3","RXLD_","RXLM_");
				   AssignGridXmltoField("RXLM_RTREXISTGRD", RTREXISTGRID)
			    }
			  else if(FormName=="ELIGBL")
                {
					if($("#CAM").val() =="")
			        {
			        	$("#Save1").click();
					...
					if(($("#ISELGBLTYCHECKED").val() =="0")&&($('.FormPageMultiTab li.active').attr("id")=="S00006" || $('.FormPageMultiTab li.active').attr("id")=="S00001" || $('.FormPageMultiTab li.active').attr("id")=="S00005" || $('.FormPageMultiTab li.active').attr("id")=="S00008" || $('.FormPageMultiTab li.active').attr("id")=="S00004" || $('.FormPageMultiTab li.active').attr("id")=="S00009"))
					{
						alert("Click Eligibility Before Save.")
						return
					}
				  var Scheme=$("#RCCM_UNIQUID").val();
					...
					if(Scheme=="S00001" || Scheme=="S00008" || Scheme=="S00005" || Scheme=="S00006")
						{
						var FINCELIGBLE = TxtGridsubmitdata_V1("Table6","FIEG_","ICEG_");
						AssignGridXmltoField("ICEG_FINELGB", FINCELIGBLE)
						var ELIGBLECUSLIST = TxtGridsubmitdata_V2("LIP","EGCD_","ICEG_","EGCDDBfields"); 
				            AssignGridXmltoField("ICEG_CUSDETL", ELIGBLECUSLIST)
							
				               //Credit Policy Change STRT********
				            if(Scheme=="S00001")
							{
							var SEPINCMG = TxtGridsubmitdata_V3("SEPCALCPROFTable","SEPP_","ICEG_");
							AssignGridXmltoField("ICEG_SEPINCMG", SEPINCMG);
							var SEPGRINCMG = TxtGridsubmitdata_V3("SEPCALCGRPMPTable","SEPG_","ICEG_");
							AssignGridXmltoField("ICEG_SEPGRINCMG", SEPGRINCMG);
							}
							//Credit Policy Change END********
							
				            var INCMTable = TxtGridsubmitdata_V3("INCMTable","FPFI_","ICEG_");
							AssignGridXmltoField("ICEG_INCMG", INCMTable);    
							
							 var OTHINCMTable = TxtGridsubmitdata_V9("OTHINCMTable","FPOI_","ICEG_");
								AssignGridXmltoField("ICEG_OTHINCMG", OTHINCMTable);      
						}
						//MicroLAP Changes Start
						else if(Scheme=="S00009")
						{
						    var OTHINCMTable = TxtGridsubmitdata_V9("OTHINCMTable","FPOI_","ICEG_");
							AssignGridXmltoField("ICEG_OTHINCMG", OTHINCMTable);
								
							var IAPFRMTable = TxtGridsubmitdata_V3("IAPFRMTable","FRMI_","ICEG_");
							AssignGridXmltoField("ICEG_LAPFIRMONE", IAPFRMTable);  
								
							var IAPFRMTable1 = TxtGridsubmitdata_V3("IAPFRMTables1","FRII_","ICEG_");
							AssignGridXmltoField("ICEG_LAPFIRMTWO", IAPFRMTable1);  
							
							var IAPFRMTable2 = TxtGridsubmitdata_V3("IAPFRMTablez","FRMI_","ICEG_");
							AssignGridXmltoField("ICEG_LAPFIRMTHREE", IAPFRMTable2);  
								
							var IAPFRMTable3 = TxtGridsubmitdata_V3("IAPFRMTablesx","FRII_","ICEG_");
							AssignGridXmltoField("ICEG_LAPFIRMFOUR", IAPFRMTable3); 
							
							var ASSETCTable = TxtGridsubmitdata_V3("ASSETCTable","EGAC_","ICEG_");
							AssignGridXmltoField("ICEG_ELIGASSCLSF", ASSETCTable); 
					...
					else if(Scheme=="S00002")
						{
						  var RTRELIGBLE = TxtGridsubmitdata_V1("Table4","RTEG_","ICEG_");
							AssignGridXmltoField("ICEG_FRTRELIGBL", RTRELIGBLE)
							
						  var RTRNORMS = TxtGridsubmitdata_V1("Table5","FRTN_","ICEG_");
							AssignGridXmltoField("ICEG_FRTRNORMS", RTRNORMS)
						}
					else if(Scheme=="S00004")
					    {
						 
						 /* var RRELIGBLE = TxtGridsubmitdata_V1("TableRR","FRRE_","ICEG_");
						     AssignGridXmltoField("ICEG_RRELGB", RRELIGBLE)*/
							 
							 var RRELIGBLE = TxtGridsubmitdata_SV1("TableRR","FRRE_","ICEG_");
                    AssignGridXmltoField("ICEG_RRELGB", RRELIGBLE)
