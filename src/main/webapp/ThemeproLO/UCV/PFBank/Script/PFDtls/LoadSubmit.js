$(document).ready(function () {
	...
	{
		$(".PFDTDBfields").attr('disabled',true);
	}
 ...
 GetDmdAmt();
  ...
  OnlineTrans();
   ...
   if($("input[name='PFDT_MODE']:checked").val()=="Online" && $("#PFDT_ONLINEMOD").val()=="Paytm")
  {
...
//PAYTM PROCESSING CHECK END
	...
	//var FormXML =	submitdata("CBSIDBfields");
		...
		if($("#PFDT_PFNO").val() == "")
		{
		var CUSID = UI_getdata("PRF",$("#PrcsID").val(),"Yes","","","Sam_sGetSeqID");
