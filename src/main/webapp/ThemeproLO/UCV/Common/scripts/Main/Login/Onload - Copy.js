...
$(document).ready(function () {
	...
	var op= UI_getdata('','','','','','Sam_sGetNewsfeeds');
...
randomnum();
	...
	return
	  ...
	  var LgnAttmptChk =UI_getdata('Login',$("#TXTusername").val(),'Check','','',"Sam_SLoginAttempt"); 
...
document.getElementById("txt3").value = '';	
 ...
 UI_getdata('Login',$("#TXTusername").val(),'Success','','',"Sam_SLoginAttempt");
...
else
{
	...
	var LgnAttmpt =UI_getdata('Login',$("#TXTusername").val(),'Invalid','','',"Sam_SLoginAttempt");
 ...
 function GetLoginAllowChk()
{
	...
	var op= UI_getdata(userid,"","","","","sam_sGetLoginAllowChk");
...
{	
 ...
 var OPXML = UI_getdata(usrname,"","","","","SAM_SGetLoginPwd");
