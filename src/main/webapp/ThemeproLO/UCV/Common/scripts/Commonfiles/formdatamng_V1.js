...
function CheckKYCDetl(Event,Id,Verify,Type)
{
    if($("#"+Verify).val()!="Verified")
	{	
    var IdVal=$("#"+Id).val()
	...
	$.ajax({
        url: "/TPLSW/KarzaKyc",
        type: 'POST',
        data: {Karzavalue:IdVal,CoAPlt:CusID,SPNAME:"LSW_SKARZAAPICREATE",APIType:Type,PRCSID:$("#PrcsID").val(),Prvnt:$(window.parent.parent.document).find("#Prvnt").val()},
        async:false,
        //dataType: 'json',
       //contentType:'application/json',
        success: function(stm){        
