	...
	$(function() {
	    ...
	    $('[data-popup-open]').on('click', function(e)  {
	  	...
	  	$(document).on('click', '#ADD1', function (e){
	        ...
	        var targeted_popup_class = jQuery(this).attr('data-popup-open');
	        $('[data-popup="' + targeted_popup_class + '"]').fadeIn(350);
	 //$('.cke_wysiwyg_frame').contents().find("body").html($('#Remarks').val(""))
...
var InstVal='';
	var x= $('.cke_wysiwyg_frame').contents().find("body").html();//For Word Editor
	$("#Remarks").val($(x).text());//For Word Editor
if ($("#Remarks").val()=='')
{
...
//$('#tmelne section li').eq(-1).after(
		'<li class="CurrentUsr">'+
			...
			' <div class="timeline-body">'+ $('.cke_wysiwyg_frame').contents().find("body").html()+'<br /></div>'+//$('#Remarks').val()
...
//$('#tmelne section li').eq(-1).after(
		'<li class="CurrentUsr">'+
			 '<i class="roundsze bg-blue"></i><div class="timeline-item"><span class="time"><i class="fa fa-clock-o"></i></span>'+
			 '<h3 class="timeline-header">'+ $('#LoggedInUserFnmae').val()+'</h3>'+
			' <div class="timeline-body">'+ $('.cke_wysiwyg_frame').contents().find("body").html()+'<br /></div>'+
			'<div class="versionno" style="display:none">'+$('#Versionno').val()+'</div>'+
			 '<div class="timeline-footer">'+
...
InstVal=$('#LoggedInUser').val()+'|'+$('#Created_Date').val()+'|'+$('#Created_Date').val()+'|'+$('.cke_wysiwyg_frame').contents().find("body").html()+'|'+$('#Versionno').val();
...
InstVal=$('#LoggedInUser').val()+'|'+$('#Created_Date').val()+'|'+$('#Bsn_Date').val()+'|'+$('.cke_wysiwyg_frame').contents().find("body").html()+'|'+$('#Versionno').val();
...
$(document).on('click', '.GridRowEditBTN', function (e) {
	...
	//var tablest = "<table cellspacing=\"2\" cellpadding=\"2\" width=\"80%\">";
	 ...
	 var rowchk="0";
		...
		$('.cke_wysiwyg_frame').contents().find("body").html($(this).closest('li').find(".timeline-body")[0].innerHTML)//For Word Editor
	...
	$('#Remarks').attr('readonly','readonly');
	 ...
	 $('#GridBTNCn').show();
	   ...
	   liindx =$(this).closest('li').index();
		...
		$('.cke_wysiwyg_frame').contents().find("body").html($('#tmelne section').eq(secindx).find('li').eq(liindx).find(".timeline-body")[0].innerHTML)//For Word Editor
