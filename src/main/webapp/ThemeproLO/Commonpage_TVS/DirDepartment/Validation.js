...
function GridControlVERTICALMAP (popTableModPageGrid1,TableID,dtData,dtcolumn,hideClm)
{
...
function GetRoleMap()
{
  ...
  var Id=$("#BRCR_BRANCHID").val();
  if(Name=="" || Id=="")
	  {
	    alert('Enter the Branch ID and Name');
	    return false;
...
function GridControlBRVERTICAL (popTableModPageGrid1,TableID,dtData,dtcolumn,hideClm)
{
	 popTableModPageGrid1 = $('#'+TableID).DataTable({ 
