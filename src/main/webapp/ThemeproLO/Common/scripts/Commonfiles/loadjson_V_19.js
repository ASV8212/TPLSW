          ...
          if (typeof popTableModPageGrid1 === "undefined" || popTableModPageGrid1 === null) {
        	...
        	if (enablecontrol == "DocumentCheckList")
           ...
           else if (enablecontrol == "DocumentCheckListOthers")
             {
			     ...
			     else if (enablecontrol == "DocumentTEMPLATES")
           {
      		  GridControlDetailDocumentTEMPLATES (popTableModPageGrid1,TableID,dtData,dtcolumn,hideClm);
           }
           ...
           {
        	   GridControlDetailMonthRpt (popTableModPageGrid1,TableID,dtData,dtcolumn,hideClm);
           }
