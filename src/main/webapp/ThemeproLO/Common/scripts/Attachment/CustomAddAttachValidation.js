...
{	
	...
	var addtnlcount= rwchk();
		 ...
		 if(addtnlcount==0)
		{
			...
			var DRPDNVAL = '<select class="inputTXT" style="width:110px";onchange="DrpdwnChngeChk(this);getAttachChk(this);" id="DocType" name="DocType">'
			...
			addControl += '<td><input placeholder="DD-MM-YYYY" id="ExecDate" name="ExecDate" class="ISDatefield DateFields inputTXT" style="width:120px";" /></td>'
			addControl += '<td><input placeholder="DD-MM-YYYY" id="ExpDate" name="ExpDate" class="ISDatefield DateFields inputTXT" style="width:120px";" /></td>'
			
			addControl += '<td><input id="PlcExec" name="PlcExec" class="inputTXT" style="width:120px";" /></td>'
			addControl += '<td><input id="PlcCustdy" name="PlcCustdy" class="inputTXT" style="width:120px";" /></td>'
			addControl += '<td><input id="CustCode" name="CustCode" class="inputTXT" style="width:120px";" /></td>'
			addControl += '<td><input id="CustLoc" name="CustLoc" class="inputTXT" style="width:120px";" /></td>'
