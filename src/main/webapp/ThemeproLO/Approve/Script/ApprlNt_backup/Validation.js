        ...
        "aoColumnDefs": [{
            ...
            
            {
                ...
                "render": function(data, type, row, meta) {
                    ...
                    var rowno = meta.row;
                    var HTML = '<span><input type="text" style = "" id="APED_REMARK' + rowno + '"  name="APED_REMARK' + rowno + '" maxlength="30" disabled class="form-control DSVLBL form-control ">';
                    HTML = HTML + '</span>';
    ...
    popTableModPageGrid1 = $('#' + TableID).DataTable({
       ...
       "aoColumnDefs": [{
            ...
            },
            {
                ...
                "render": function(data, type, row, meta) {
                    var rowno = meta.row;
                    var HTML = '<span><input type="text" style = "width:200px" id="APED_REMARK' + rowno + '"  name="APED_REMARK' + rowno + '" maxlength="30" class="form-control form-control ">';
                    HTML = HTML + '</span>';
                    var htmldata = $(HTML);
                    if ($(htmldata).find('[name=APED_REMARK' + rowno + ']').hasClass("IsCURCommaFields")) {
                        data = CURCommaSep(data);
    ...
    popTableModPageGrid1 = $('#' + TableID).DataTable({
       ...
       "aoColumnDefs": [{
            ...
            
            {
                ...
                "render": function(data, type, row, meta) {
                    var rowno = meta.row;
                    var HTML = '<span><input type="text" style = "width:100px" id="APAG_ASSTTYP' + rowno + '"  name="APAG_ASSTTYP' + rowno + '" maxlength="10" class="form-control form-control ">';
                    HTML = HTML + '</span>';
                    var htmldata = $(HTML);
 	 ...
 	 return htmldata[0].outerHTML;
      		 ...
      		 },
            {
                ...
                "render": function(data, type, row, meta) {
                    var rowno = meta.row;
                    var HTML = '<span><input type="text" style = "width:100px" id="APAG_MRKTVAL' + rowno + '"  name="APAG_MRKTVAL' + rowno + '" maxlength="10" class="form-control form-control IsNumberFields IsCURCommaFields">';
                    HTML = HTML + '</span>';
                    var htmldata = $(HTML);
    ...
    popTableModPageGrid1 = $('#' + TableID).DataTable({
       ...
       "aoColumnDefs": [{
            ...
            { targets: 3, "render": function ( data, type, row, meta ) {                            
     		   ...
     		   var rowno = meta.row;		 
     	 		var HTML =	'<span><input type="radio" class="custom-control-input GCLR CBSIDBfields" value="Yes" id="OWNERYES'+rowno+'" name="LPDS_BRNIOWNER'+rowno+'"><label class="custom-control custom-control-label" for="OWNERYES'+rowno+'">Yes</label>';			 
     	 		HTML = HTML + '<input type="radio" class="custom-control-input GCLR CBSIDBfields" value="No" id="OWNERNO'+rowno+'" name="LPDS_BRNIOWNER'+rowno+'"><label class="custom-control custom-control-label" for="OWNERNO'+rowno+'">No</label></span>';			  
     		...
     		{ targets: 4, "render": function ( data, type, row, meta ) {                            
     				    ...
     				    var rowno = meta.row;		 
     			 		var HTML =	'<span><input type="radio" class="custom-control-input GCLR CBSIDBfields" value="Yes" id="LOANYES'+rowno+'" name="LPDS_LONSTRU'+rowno+'"><label class="custom-control custom-control-label" for="LOANYES'+rowno+'">Yes</label>';			 
     			 		    HTML = HTML + '<input type="radio" class="custom-control-input GCLR CBSIDBfields" value="No" id="LOANNO'+rowno+'" name="LPDS_LONSTRU'+rowno+'"><label class="custom-control custom-control-label" for="LOANNO'+rowno+'">No</label></span>';			  
    ...
    popTableModPageGrid1 = $('#' + TableID).DataTable({
       ...
       "aoColumnDefs": [{
            ...
            },
            {
                ...
                "render": function(data, type, row, meta) {
                    var rowno = meta.row;
                    var HTML = '<span><input type="text" style = "width:200px" id="AEUG_ENDUSE' + rowno + '" data-item="" name="AEUG_ENDUSE' + rowno + '" maxlength="15" class="form-control DSVLBL IsNumberFields IsCURCommaFields NoSpecialChar">';
                    HTML = HTML + '</span>';
                    var htmldata = $(HTML);
				...
				if ($(htmldata).find('[name=APFD_FINCYRONE'+rowno+']').hasClass("IsCURCommaFields"))
				 ...
				 { targets: 2, "render": function ( data, type, row, meta ) {                            
					 ...
					 { targets: 4, "render": function ( data, type, row, meta ) {                            
						 ...
						 var rowno = meta.row;	 
							var HTML =	'<span><input type="text" id="APFD_CUSID'+rowno+'" style="width:100px" name="APFD_CUSID'+rowno+'" data-item="Amount" data-itemr="Amount" data-totalr="ITRVAL" data-total="EGCD_FINYRTOT" maxlength="15" class="form-control NoSpecialChar DSVLBL IsCURCommaFields form-control FinYrIncm">';			 
							HTML = HTML + '</span>'; 
						 ...
						 { targets: 5, "render": function ( data, type, row, meta ) {                            
							 ...
							 var rowno = meta.row;	 
								var HTML =	'<span><input type="text" id="APFD_SCHMID'+rowno+'" style="width:100px" name="APFD_SCHMID'+rowno+'" data-item="Average" maxlength="15" class="form-control NoSpecialChar IsCURCommaFields form-control DSVLBL">';			 
								HTML = HTML + '</span>'; 
