...
<div class="modal fade" style="display:none" id="Table12GridPop"  tabindex="-1" role="dialog" aria-labelledby="Table12GridPop" aria-hidden="true">
 ...
 <!-- SCRIPTS -->
    ...
    <!-- JQuery -->
   <script type="text/javascript" src="ThemeproLO/RegisterInvoice/Script/RegisterInvoice/LoadSubmit/LoadSubmit.js${DMY13}"></script>
      <script type="text/javascript" src="ThemeproLO/RegisterInvoice/Script/RegisterInvoice/Validation/Validation.js${DMY13}"></script>
