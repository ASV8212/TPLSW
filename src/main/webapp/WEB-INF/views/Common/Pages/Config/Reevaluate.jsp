...
<script src="ThemeproLO/Common/scripts/Config/Reevaluate/onload.js${DMY13}" type="text/javascript"></script>
<script src="ThemeproLO/Common/scripts/Config/Reevaluate/Validation.js${DMY13}" type="text/javascript"></script>
...
<head id="Head1" runat="server">
    ...
    <title>Re-evaluate Page</title>
</head>
<body bgcolor="#FFF5EE">

<form id="ReevaluatePage" style="background-color:white; height:580px" name="Reevaluate Page"  action=""  method="POST">
    ...
    <input type="button" id ="GetFileHistData" name="GetFileHistData" style="display:none" onclick="FncallModPageGridLrgData(this,'Table2',{spname:'Sam_sGetHistQD',Param:$('#PrcsID').val(),brid:'',MnuId:'REVAT'},{0:$('#LAPP_BrID'),1:$('#LAPP_BrName')});" />
...
<input class="queueflddata" face="calibri" id="WFNameHist" disabled name="WFNameHist" value=""/>          
 ...
 <td style="display:none" class="ColumnHeading"><font face="calibri" size="2">Branch Name</font>
        </td>       
      
         <td style="display:none">  : 
<input class="queueflddata" face="calibri" id="BrNameREval" disabled name="BrNameREval" value=""/>          
	<input class="queueflddata" face="calibri" id="BrIDREval" disabled name="BrIDREval" type="hidden" value=""/>  	

 <img src="ThemeproLO/Common/Images/search1.png" id="Brnmlkup" class="find1" onclick="Fncallwebservice(this,'GetJsonBRID',{spname:'SAM_sBRMASTER',Param:'',brid:'',MnuId:'RHFL'},{0:$('#BrIDREval'),1:$('#BrNameREval')})">
