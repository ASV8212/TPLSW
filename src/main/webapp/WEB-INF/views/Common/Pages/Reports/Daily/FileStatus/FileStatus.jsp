...
<script src="ThemeproLO/Common/scripts/Reports/Daily/FileStatus/Onload.js${DMY13}" type="text/javascript"></script>
<script src="ThemeproLO/Common/scripts/Reports/Daily/FileStatus/Validation.js${DMY13}" type="text/javascript"></script>
 
<link href="ThemeproLO/Common/CSS/Report/AccordionTab.css${DMY13}" rel="stylesheet" type="text/css" />	  
...
<form id="FileStatus" style="background-color:white;" name="File Status"  action=""  method="POST">
    ...
    <input type="button" id ="GetFileHistData" name="GetFileHistData" style="display:none" onclick="FncallModPageGridLrgData(this,'Table2',{spname:'Sam_sGetHistQD',Param:$('#PrcsID').val(),brid:'',MnuId:''},{0:$('#LAPP_BrID'),1:$('#LAPP_BrName')});" />
           
       <div id="FileStatusPage">
...
<tr>
 <td class="ColumnHeading"><font face="calibri" size="2">Workflow Name</font>
         ...
         <td>  : 
<input class="queueflddata" face="calibri" id="wkfwname" disabled name="wkfwname" value=""/>          
	<input class="queueflddata" face="calibri" id="wkfwid" disabled name="wkfwid" type="hidden" value=""/>  	

 <img src="ThemeproLO/Common/Images/search1.png" id="wfnmlkup" class="find1" onclick="Fncallwebservice(this,'GetJsonBRID',{spname:'SAM_sWFNAME',Param:$('#LoggedInUser').val(),brid:'FS',MnuId:''},{0:$('#wkfwname'),1:$('#wkfwid')})">
