...
<script type="text/javascript" src="ThemeproLO/UCV/DocCheckList/FileCheck/Script/LoadSubmit/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/UCV/DocCheckList/FileCheck/Script/Validation/Validation.js${DMY13}"></script> 
