...
<div class="tab-content card pt-5" id="myTabContentMD">
 ...
 <!-- SCRIPTS -->
    ...
    <!-- JQuery -->
   <script type="text/javascript" src="ThemeproLO/UCV/Reports/Script/Reports/LoadSubmit/LoadSubmit.js${DMY13}"></script>
   <script type="text/javascript" src="ThemeproLO/UCV/Reports/Script/Reports/Validation/Validation.js${DMY13}"></script>
