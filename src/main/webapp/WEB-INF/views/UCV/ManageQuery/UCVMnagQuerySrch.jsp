...
<div class="col-md-12">  
  <div class="form-row ">               
                  <div class="col-md-4">
                 <div class="md-form">
                  <select class="mdb-select md-form colorful-select dropdown-primary CHKFLD"  onchange="DropDownChange('Region','Area','Branch')"   searchable="Search here.."  id="Zone" name="Zone">
                  	${ZONE}
				</select>
              ...
              <div class="col-md-4">
                 <div class="md-form">
                  <select class="mdb-select md-form colorful-select dropdown-primary CHKFLD" onchange="DropDownChange('Zone','Area','Branch')"  searchable="Search here.."  id="Region" name="Region">
                  	${REGION}
				</select>
                ...
                <div class="col-md-4">
                 <div class="md-form">
                  <select class="mdb-select md-form colorful-select dropdown-primary CHKFLD" onchange="DropDownChange('Zone','Region','Branch')"  searchable="Search here.."  id="Area" name="Area">
                  	${AREA}
				</select>
               ...
               <div class="form-row ">               
                  <div class="col-md-4">
                 <div class="md-form">
                  <select class="mdb-select md-form colorful-select dropdown-primary CHKFLD" onchange="DropDownChange('Zone','Region','Area')" searchable="Search here.."  id="Branch" name="Branch">
                  	${BRANCH}
				</select>
			  ...
			  <div class="col-md-4">
			    <div class="md-form">
	                <button type="button" id="Search" onclick="ReTgrGrd()" class="btn  btn-Syeloutline waves-effect waves-light">Search</button>
	            </div>
                </div>
                
                <div class="col-md-4" style="display:none">
				<div class="md-form">
                   <input type="text" id="From" name="From" maxlength="10" class="form-control form-control CEMIDBfields  NoSpecialChar  ISDatefield   ">
                    <label for="From" class="">From<span class="MndtryAstr"></span></label>
                    <img src="ThemeproLO/Common/Images/calendar.png" class="FieldIcon datepicker"/>
                  </div>
                  <div class="md-form">
                   <input type="text" id="To" name="To" maxlength="10" class="form-control form-control CEMIDBfields  NoSpecialChar INDM ISDatefield  CBSIDBfields ">
                    <label for="To" class="">To<span class="MndtryAstr"></span></label>
                    <img src="ThemeproLO/Common/Images/calendar.png" class="FieldIcon datepicker"/>
                  </div>
				 </div> 
              <div class="col-md-4" style="display:none">
                 <div class="md-form">
                  <select class="mdb-select md-form colorful-select dropdown-primary" id="BSM" name="BSM">
                  	<option value="">Select</option>
				</select>
				<label class="mdb-main-label BTxt9">BSM<span class="MndtryAstr"></span></label>
               </div>
              </div>
                <div class="col-md-4" style="display:none">
                 <div class="md-form">
                  <select class="mdb-select md-form colorful-select dropdown-primary " id="Existing" name="Existing">
                  	<option value="">Select</option>
				</select>
				<label class="mdb-main-label BTxt9">Existing<span class="MndtryAstr"></span></label>
               </div>
              </div>
             </div>   
              ...
              <div class="form-row " style="display:none">               
                 <div class="col-md-4">
                  <div class="md-form">
                    <input type="text" id="Existing" maxlength="25"  name="Existing" class="form-control IsAlphaFields IsUpprCse  ">
                    <label for="Existing" class="">Applicant<span class="MndtryAstr"></span></label>
                  </div>
                </div>
             </div>
         </div>   
 ...
 <div class="row">
  ...
  <div class="admin-panel">
                                ...
                                <div class="row m-b-0">
<div class="col-md-12">
  <input type="button" style="display:none" class="DashTrg" onclick="FncallFEPDashLrgDataWP(this,'Table3',{spname:'LSW_SMANGQRY',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#LogUsr').val(),brid:'',MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||');" id="BTNAcctRecv" name="BTNAcctRecv" />
...
<script type="text/javascript" src="ThemeproLO/Common/FEP/Calendar/js/monthly.js${DMY13}"></script>
 <script type="text/javascript" src="ThemeproLO/UCV/ManageQuery/Script/MnagQuerySrch/LoadSubmit.js${DMY13}"></script>
  <script type="text/javascript" src="ThemeproLO/UCV/ManageQuery/Script/MnagQuerySrch/Validation.js${DMY13}"></script> 
