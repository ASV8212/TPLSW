...
<div class="custom-control custom-radio custom-control-inline">
  ...
  <label class="custom-control-label" for="Relative2">Relative</label>
   ...
   <script type="text/javascript" src="ThemeproLO/UCV/LoanProperty/Script/RefDtls/LoadSubmit.js${DMY13}"></script>
    <script type="text/javascript" src="ThemeproLO/UCV/LoanProperty/Script/RefDtls/Validation.js${DMY13}"></script>
                                  <!--   </div>
                                </div>   -->                           