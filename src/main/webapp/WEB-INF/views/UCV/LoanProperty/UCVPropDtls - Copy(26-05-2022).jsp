		...
		<div class="vehicle PARENTCLASS" style="display:none">
		    <div class="form-row">
		 	...
		 	<div class="form-row">
							...
							<div class="col-md-6">
							<div class="md-form">
                    <select class="mdb-select md-form colorful-select dropdown-primary ADDPro LPDTDBfields VEMVAL  vehile" onchange="GetBodyTy()" id="LPDT_VEHILECLASS" name="LPDT_VEHILECLASS">
                  	<option value="">Select</option>	
	...
	<div class="col-md-6">
		...
		<div class="form-row">
			...
			<div class="col-md-6">
                  <!-- First name -->
                <div class="md-form">                   
                    <input type="text" id="LPDT_VFCVALIDITY" name="LPDT_VFCVALIDITY"  maxlength="10" class="form-control LPDTDBfields VEMVAL ADDPro IsNumberFields NoSpecialChar INDM ISDatefield  ISPastDateFields vehile ">
                    <label for="LPDT_VFCVALIDITY" class="ADDACTVEC">FC Validity<span class="MndtryAstr">*</span></label>
                    <img src="ThemeproLO/Common/Images/calendar.png" class="FieldIcon datepicker"/>
                </div>
            </div>
		    ...
		    <div class="form-row">
		     <!--  <div class="col-md-6">
			  ...
			  <div class="col-md-6">
                  <!-- First name -->
                  <div class="md-form"> 
                    <input type="text" id="LPDT_VTAXVALIDITY" name="LPDT_VTAXVALIDITY"  maxlength="10" class="form-control LPDTDBfields VEMVAL ADDPro IsNumberFields NoSpecialChar INDM ISDatefield  ISPastDateFields vehile ">
                    <label for="LPDT_VTAXVALIDITY" class="ADDACTVEC">Tax Validity<span class="MndtryAstr">*</span></label>
                    <img src="ThemeproLO/Common/Images/calendar.png" class="FieldIcon datepicker"/>
                  </div>
                </div>
		...
		<!---- -->		  
		 ...
		 <div class="form-row">
		    ...
		    <div class="form-row"> 
			   <div class="col-md-6">
				  <div class="md-form">
                  	<input type="text" id="LPDT_VIDV" name="LPDT_VIDV" maxlength="6" class="form-control IsGreaterzeroFld ADDPro VEMVAL LPDTDBfields vehile ">
