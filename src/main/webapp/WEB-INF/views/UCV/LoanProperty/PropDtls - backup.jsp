  ...
  <label class="custom-control-label" for="ADDPRONO">No</label>
        ...
        <div class="form-row">
            ...
            <div class="col">
                  ...
                  <div class="md-form">
                    <select class="mdb-select md-form colorful-select dropdown-primary ADDPro LPDTDBfields LPDTMndtry" id="LPDT_PROPUSAGE" onchange="GetPropType();" name="LPDT_PROPUSAGE">
  ...
  <label class="custom-control-label" for="Joint">Joint</label>
        ...
        <label class="mdb-main-label BTxt9">Property Ownership <span class="MndtryAstr">*</span></label>      
       	...
       	<div class="form-row">
                <div class="col-md-6">
                  <div class="md-form">
                    <select class="mdb-select md-form colorful-select dropdown-primary ADDPro LPDTDBfields" onchange="getCusNames();GetOwnerCusId();" multiple id="LPDT_PROPOWNER" name="LPDT_PROPOWNER">
...
<div class="custom-control custom-radio custom-control-inline RETIADD">
   ...
   <label class="custom-control-label" for="Office">Office</label>
        ...
        <div class="form-row">
            <div class="col">
                  <div class="md-form">
                  	<input type="text" id="LPDT_ADDTLINEI" name="LPDT_ADDTLINEI" disabled class="form-control ADDAC COLAD LPDTMndtry LPDTDBfields PERCHG">
                    <label for="LPDT_ADDTLINEI" class="ADDAL">Address Line 1 <span class="MndtryAstr">*</span></label>
             </div>
                </div>
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="LPDT_ADDRLINEII" name="LPDT_ADDRLINEII" disabled class="form-control ADDAC COLAD   LPDTDBfields PERCHG">
           ...
           <div class="form-row">
            ...
            <div class="col">
                  ...
                  <div class="md-form">
                  	<input type="text" id="LPDT_PINCODE" maxlength="6" disabled name="LPDT_PINCODE" onblur="fnOnFocusOut(this);Pindetls(this,'LPDT_STATE','LPDT_CITY')" class="form-control ADDAC IsNumberFields NoSpecialChar IsPinFielde COLAD LPDTMndtry PERCHG LPDTDBfields">
           ...
           <div class="form-row">
            <div class="col">
                <div class="md-form">
                  	<input type="text" id="LPDT_YERADDR" maxlength="2" disabled onblur="yearsCompare('LPDT_YEAATCITY','LPDT_YERADDR','Years at address value cannot be greater than Years at city')"  name="LPDT_YERADDR" class="form-control COLAD ADDAC  IsNumberFields NoSpecialChar PERCHG LPDTMndtry LPDTDBfields">
