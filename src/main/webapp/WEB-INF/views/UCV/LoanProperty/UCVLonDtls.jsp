               ...
               <form>
				...
				<div class="form-row">
                  ...
                  <div class="form-row">
                     ...
                     <div class="col-md-6 UCVECOHIDE ">
                        <div class="md-form">
                           <div id="PRO" class="select-radio ">
                              <div 
							  class="custom-control custom-radio custom-control-inline">
                                 <input type="radio" class="custom-control-input LODEDBfields SECUR" onchange="HandlePropDtl()" disabled value="Secured" id="PrePerRes" name="LODE_SECURED">
                                 <label class="custom-control-label" for="PrePerRes">Secured</label>
                              </div>
                              <div class="custom-control custom-radio custom-control-inline ">
                                 <input type="radio" class="custom-control-input LODEDBfields UNSECUR" onchange="HandlePropDtl()" disabled value="Unsecured" id="PreCurRes" name="LODE_SECURED">
				  ...
				  <div class="form-row">
					 ...
					 <!--onchange="getReqROI('LODE_SCHEME',''); GetScheme('LODE_SCHEME','LODE_LOANID','LODE_SCHEMEID');"  GetScheme('LODE_SCHEME','LODE_LOANID','LODE_SCHEMEID');-->
					 <div class="col-md-6 NEWPROD">
                        <div class="md-form">
                            <select class="md-form colorful-select dropdown-primary LODEDBfields LODEMndtry"  onchange="getReqROI('LODE_SCHEME',''); GetScheme('LODE_SCHEME','LODE_LOANID','LODE_SCHEMEID'); CheckAmount(); CheckTenor(); CheckRoi();"  id="LODE_SCHEME" name="LODE_SCHEME">
						    </select>
                           <label class="mdb-main-label BTxt9">Transaction Type <span class="MndtryAstr">*</span></label>
                         </div>
                     </div>
                  </div>
                  ...
                  <div class="form-row">
                     ...
                     <div class="col-md-6 ">
                        <div class="md-form">
                           <input type="text" id="LODE_Exist" maxlength="60" onchange="CheckExp();" class="form-control IsCURCommaFields LODEDBfields NoSpecialChar LODEMndtry DataNormal" name="LODE_Exist" title="">
				  ...
				  <div class="col-md-6">
                        <div class="md-form">
                           <input type="text" id="LODE_REQLONAMT"  maxlength="30"  onchange="CheckAmount(); CheckDemand();  Chkstepdwnamt(); ChkCam('LODE_REQLONAMT');  " class="form-control IsCURCommaFields LODEDBfields NoSpecialChar LODEMndtry" name="LODE_REQLONAMT">
                           <label for="LODE_REQLONAMT" class="">Requested Loan Amount (Rs.) <span class="MndtryAstr">*</span></label>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="md-form">
                           <input type="text" id="LODE_REQTENUR" name="LODE_REQTENUR" maxlength="2" onblur="RequestTenure('LODE_REQTENUR');   Chkstepdwnprd(); ChkCam('LODE_REQTENUR');  " onchange="CheckTenor()"  class="form-control NoSpecialChar IsNumberFields LODEDBfields LODEMndtry">
				 ...
				 <div class="form-row">
				  <div class="col-md-6">
                        <div class="md-form">
                           <input type="text" id="LODE_REGINTSRAT" maxlength="5" name="LODE_REGINTSRAT" onchange="CheckRoi(); ChkCam('LODE_REGINTSRAT');  " class="form-control NoSpecialChar IsPercentageSPL IsNumberFields LODEDBfields LODEMndtry">
				  ...
				  <div class="col-md-6">
                        <div class="md-form">
                           <select class="md-form colorful-select dropdown-primary LODEDBfields LODEMndtry DataToFld" onchange="CheckStepFld('LODE_REPAYMENT','LODE_STEPUPDWNPRD','LODE_SETPUPDWNAMT'); Chkmortum();" id="LODE_REPAYMENT" name="LODE_REPAYMENT">
                           </select>
				  ...
				  <div class="form-row STEPFLD"> 
				   <div class="col-md-6">
				      <div class="md-form">
				         <input type="text" id="LODE_STEPUPDWNPRD" maxlength="5" class="form-control IsNumberFields LODEDBfields NoSpecialChar" onchange="Chkstepdwnprd();" name="LODE_STEPUPDWNPRD" title="">
                         <label for="LODE_STEPUPDWNPRD" class="">Stepup or Step Down period<span class="MndtryAstr">*</span></label>
                      </div>
                   </div>
				   <div class="col-md-6">
                        <div class="md-form">
                           <input type="text" id="LODE_SETPUPDWNAMT" maxlength="15" class="form-control IsCURCommaFields LODEDBfields NoSpecialChar" onchange="Chkstepdwnamt();" name="LODE_SETPUPDWNAMT" title="">
                           <label class="" for="LODE_SETPUPDWNAMT">Stepup or Step Down Amount<span class="MndtryAstr">*</span></label>
                        </div>
                     </div>
				  </div>
				  <div class="form-row USAN">
					<div class="col-md-6">
				      <div class="md-form">
				         <input type="text" id="LODE_USANCEPRD" maxlength="15" class="form-control IsNumberFields LODEDBfields NoSpecialChar" name="LODE_STEPUPDWNPRD" title="">
                         <label for="LODE_USANCEPRD" class="">Usance period<span class="MndtryAstr"></span></label>
                      </div>
                   </div>
				   <div class="col-md-6">
				      <div class="md-form">
				...
				<div class="form-row USAN" style="display:none">
                  ...
                  <div class="form-row">
                     <div class="col-md-6">
                        <div class="md-form">
                           <input type="text" id="LODE_DEMANDamt" name="LODE_DEMANDamt" maxlength="30" onchange="AmountGst();" class="form-control IsCURCommaFields LODEDBfields NoSpecialChar LODEMndtry LODEDBfields ">
                           <label for="LODE_DEMANDamt" class="">Demand amount (rs) <span class="MndtryAstr">*</span></label>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="md-form">
                           <div id="COLLECTION TYPE" class="select-radio EMPI">
                              <div class="custom-control custom-radio custom-control-inline">
                                 <input type="radio" class="custom-control-input LODEDBfields" disabled onclick="chkupfrnt('LODE_LONTYPE','LODE_PRODUCT')" value="Upfront" id="up" name="LODE_COLLECTIONTYPE">
                              ...
                              <div class="custom-control custom-radio custom-control-inline LODEDBfields">
                                 <input type="radio" class="custom-control-input LODEDBfields" onclick="chkupfrnt('LODE_LONTYPE','LODE_PRODUCT')" value="Later" id="La" name="LODE_COLLECTIONTYPE">
                  ...
                  <!--  <label for="TEST_STATUS" class="mdb-main-label BTxt9"> Mode  <span class="MndtryAstr">*</span> </label> -->
                    <div class="form-row">
                       <div class="col-md-6 MODE">
                          <div class="md-form">
                           <div id="MODE" class="select-radio EMPI">
                              <div class="custom-control custom-radio custom-control-inline">
                                 <input type="radio" class="custom-control-input LODEDBfields" onchange="CHKCHANGE();" value="Cheque" id="che" name="LODE_Mode">
                                 <label class="custom-control-label" for="che">Cheque</label>
                              </div>
                              <div class="custom-control custom-radio custom-control-inline LODEDBfields">
                                 <input type="radio" class="custom-control-input LODEDBfields" onchange="CHKCHANGE();" value="Online" id="Onl" name="LODE_Mode">
                                 <label class="custom-control-label" for="Onl">Online</label>
                              </div>
                              <div class="custom-control custom-radio custom-control-inline LODEDBfields">
                                 <input type="radio" class="custom-control-input LODEDBfields" onchange="CHKCHANGE();" value="DD" id="D" name="LODE_Mode">
                     ...
                     <div class="col-md-6 ">
                        <div class="md-form">
                           <input type="text" id="LODE_AMT" maxlength="60" disabled class="form-control IsCURCommaFields LODEDBfields NoSpecialChar LODEMndtry DataNormal" name="LODE_AMT" title="">
				   ...
				   <div class="form-row CHANGE">
					 <div class="col-md-6 " >
                        <div class="md-form">
                           <input type="text" id="LODE_NUMB" maxlength="6" class="form-control  LODEDBfields NoSpecialChar IsNumberFields CHANGEFLD Chkinsnum DataNormal" name="LODE_NUMB" title="">
                           <label for="LODE_NUMB" class="CHANGEFLDL" >Instrument Number<span class="MndtryAstr"></span></label>
                        </div>
                     </div>
					 <div class="col-md-6">
						<div class="md-form">
                           <input type="text" id="LODE_INSTRUMNTDT" name="LODE_INSTRUMNTDT" maxlength="10" class="form-control LODEDBfields CHANGEFLD IsNumberFields NoSpecialChar ISDatefield">
				...
				<div class="form-row">
					<div class="col-md-6">
                        <div class="md-form">
                           <select class="md-form colorful-select dropdown-primary LODEDBfields LODEMndtry  DataToFld" onchange="ChkCrdt();"  id="LODE_CRDTSHELD" name="LODE_CRDTSHELD">
							  <option value="" selected>--Select--</option>
				...
				<div class="form-row UCVECOHIDE">
					<div class="col-md-4">
						<div class="md-form">
							<div class="custom-control custom-radio custom-control-inline ">
                                <input type="checkbox" class="custom-control-input LODEDBfields" onclick="CheckIncome();" id="LODE_INCCON" name="LODE_INCCON" title="">
                                <label class="custom-control-label" for="LODE_INCCON">Multiple Loan account<span class="MndtryAstr"></span></label>
                            </div>
						</div>
					</div>
					<div class="col-md-3 NOOFAC">
						<div class="md-form">
				        <input type="text" id="LODE_NOOFACCT" maxlength="10"  class="form-control IsNumberFields LODEDBfields NoSpecialChar" onchange="ChkNoAcc();" name="LODE_NOOFACCT" title="">
                        <label for="LODE_NOOFACCT" class="">No of account <span class="MndtryAstr"></span></label>
                      </div>
					</div>
					<div class="col-md-5 NOOFAC">
					  <div class="col d-flex justify-content-center">
                          <button type="button" id="INTMULTI" onclick="InitMultiLoan();" class="btn btn-Syeloutline waves-effect waves-light Save ">Multiple Loan</button>
					  </div>	
				   </div>
				</div>
					 						<!--<div class="md-form">
