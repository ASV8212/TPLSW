...
<button type="button" onclick="CheckKYCDetl(this,'CBSI_PAN','CBSI_PANVERIFY','PAN');FncallDocChkLst(this,'Table3',{spname:'LSW_SNONIGSTLIST',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:$('#CBSI_CUSID').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||3','PANKARZAGRD');" data-field="CBSI_CUSFISNAM|CBSI_CUSLSTNAM|CBSI_CUSTYPE|CBSI_CUSID|" data-Validatearia="CBSI_PANVERIFY" data-validate="pan" class="btn CBSI_PAN waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>
</div>
</div>  
</div> 
...
<div class="md-form">
<div class="CBSI_PANATTACHMENT" style="display:none"> <img src="ThemeproLO/Common/Images/UploadImg.png" class="rounded  ReUpld" title="UPLOAD" onclick="ReuploadFile(CBSI_PANATTACHMENT);" alt="Cinque Terre" width="20" height="20">  <img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW" onclick="GrdDocDwnld('CBSI_PANATTACHMENT')" class="rounded" alt="Cinque Terre" width="35" height="25"> 

<button type="button" onclick="CheckKYCUPLOADDOC(this,'CBSI_PANATTACHMENT','CBSI_PANUPLOADVERIFY','KYC OCR');" data-field="CBSI_CUSFISNAM|CBSI_CUSLSTNAM|CBSI_CUSTYPE|CBSI_CUSID|" data-Validatearia="CBSI_PANUPLOADVERIFY" data-validate="pan" class="btn CBSI_PAN waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Upload Verify</button>
...
<div class="col-md-8  Formcol-mdLR">
<div class="md-form">
<input type="text" id="CBSI_CKYC" maxlength="14" disabled data-link="CBSI_CKYC|CBSI_CKYCVERIFY" name="CBSI_CKYC" class="CBSIDBfields datalink NoSpecialChar IsNumberFields form-control validate">
...
<button type="button" data-Validatearia="CBSI_VOTERIDVEIRFY" onclick="CheckKYCDetl(this,'CBSI_VOTERID','CBSI_VOTERIDVEIRFY','VOTER ID');FncallDocChkLst(this,'Table2',{spname:'LSW_SKARZALIST',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:$('#CBSI_CUSID').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||7','KARZAGRD');" data-field="CBSI_CUSFISNAM|CBSI_CUSLSTNAM|CBSI_CUSTYPE|CBSI_CUSID|"  data-Validatearia="CBSI_VOTERIDVEIRFY" data-validate="voter" class="btn CBSI_VOTERID  waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>
...
<img src="ThemeproLO/Common/Images/delete.png"  title="Delete" onclick="KYCDELETE('CBSI_VOTERIDVEIRFY','CBSI_VOTERID','voter','CBSI_VOTERATTACHMENT','CBSI_CUSID','Upload Voters ID','CBSI_VOTERUPLOADVERIFY','Voter ID')"  class="rounded KYCDEL" alt="Cinque Terre" width="20" height="20">  
</div>
</div>  
</div>  
...
<div class="col-md-8  Formcol-mdLR">
<div class="md-form">
<input type="text" id="CBSI_AADHAR" maxlength="12" value="" disabled data-FetchValidateArea="AADHAR" data-FetchValidate="CBSI_AADHAR" data-link="CBSI_AADHAR|CBSI_AADHARVERIFY|AADHAR1|AADHARupload|AADHARview|CBSI_AADHARATTACHMENT"   name="CBSI_AADHAR" class="CBSIDBfields IsNumberFields IsAadharFields form-control validate">
...
<label for="CBSI_UTILITY" class="">Utility Bill *</label>
</div>    
</div>  
<div class="col-md-4 Formcol-mdLR TxtCenter">
<div class="md-form">
...
<div id="CBSI_UTILITYATTACHMENTUPLOAD"  class="file-field">
    ...
    <input type="text" id="CBSI_UTILITYATTACHMENT" data-val="Utility Bill Authentication" hidden="hidden" data-Validate="CBSI_UTILITYATTACHMENT"  name="CBSI_UTILITYATTACHMENT" class="form-control Utility File CBSIDBfields">
...
<div class="md-form">
<div class="CBSI_UTILITYATTACHMENT" style="display:none"> <img src="ThemeproLO/Common/Images/UploadImg.png"  title="UPLOAD" onclick="ReuploadFile(CBSI_UTILITYATTACHMENT);"  class="rounded ReUpld" alt="Cinque Terre" width="20" height="20">  <img src="ThemeproLO/Common/Images/Eyeview.png"  title="VIEW" onclick="GrdDocDwnld('CBSI_UTILITYATTACHMENT')" class="rounded " alt="Cinque Terre" width="35" height="25"> </div>
</div>
</div>  
</div> 
</div>        
