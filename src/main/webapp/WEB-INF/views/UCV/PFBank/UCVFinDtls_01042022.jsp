               ...
               <div class="col-md-6"> 
			 	...
			 	<div class="form-row TWEONE CHKITR">
							...
							<div id="FIMA_EXCELUPLOAD"  class="file-field">
								...
								<input type="file"  name="datafile" onchange="DocFldUpldHandler(FIMA_EXCEL,'FIMA_EXCEL','FinExclView','FinExclView')" class="">
								</a> 
							<input type="text" id="FIMA_EXCEL" data-val="Upload Statement" hidden="hidden" data-Validate="FIMA_EXCEL"  name="FIMA_EXCEL" class="form-control   File CHKITRM FIMADBfields">
							...
							<img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW"  class="rounded" onclick="GrdDocDwnld('FIMA_EXCEL')" alt="Cinque Terre" width="35" height="25"> </div>
							</div>
							</div>  
							...
							<img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW"  class="rounded" onclick="GrdDocDwnld('FIMA_UPLD')" alt="Cinque Terre" width="35" height="25"> </div>
							</div>
							</div>  
