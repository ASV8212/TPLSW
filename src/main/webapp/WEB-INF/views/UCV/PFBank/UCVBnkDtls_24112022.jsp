...
<div class="">
 ...
 <div class="HyperControls form-row FltRight" > 
         ...
         <div class="Formaccordion accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
            ...
            <div class="col">
                   ...
                   <div class="form-row">
                           <div class="col">
                              <div class="md-form">
                                 <select class="md-form colorful-select dropdown-primary BKDTMndtry BKDTDBfields" id="BKDT_ACCTTYPE" onchange="ODCC($(this).closest('.DYNROW')[0],this);" name="BKDT_ACCTTYPE">
      ...
      <!--class="MODE"-->           <option  value="Others">Others</option>
                        ...
                        <div class="form-row">
                           ...
                           <div class="col-md-6">
                              <div class="md-form">
								 ...
								 <input type="text" id="BKDT_IFSC"  maxlength="11"  data-link="BKDT_IFSC|BKDT_IFSCVERIFY|IFSC|Multi||BKDT_IFSCVERIFY||"  name="BKDT_IFSC" onblur="Ifscdetls(this,'BKDT_BNKNAME','BKDT_BNKBRCH','BKDT_CITY','BKDT_STATE')" class="form-control IsIFSCFields datalink OCRDSBL IsUpprCse NoSpecialChar BKDTMndtry BKDTDBfields">
						...
						<div class="form-row ODCC">
							<div class="col">
                              <div class="md-form">
                                 <input type="text" id="BKDT_SANCTIONLIM" maxlength="40" name="BKDT_SANCTIONLIM" class="form-control BKDTMndtry BKDTDBfields">
                                 <label for="BKDT_SANCTIONLIM" class="">Sanctioned Limit<span class="MndtryAstr">*</span></label>
                              </div>
							</div>
							<div class="col">
                              <div class="md-form">
						...
						<div class="col-md-6 ">
							...
							<input type="text" id="BKDT_STATEMENT" data-val="Upload Statement" hidden="hidden" data-Validate="BKDT_STATEMENT"  name="BKDT_STATEMENT" class="form-control   File  BKDTDBfields">
 ...
 <!-- <div id="EXCELUPLOAD"  class="file-field DDU FltRight ">
  ...
  <div id="BKDT_STATEMENTUPLOAD"  class="file-field">
		...
		<div class="form-row Auto" style="display:none">
			<div class="col-md-4">
				<div class="md-form">
					<button type="button" onclick="NetBankingInteg('Statement','BKDT_BNKNO'+$(this).closest('.DYNROW').attr('data-row'),'BKDT_STDATE'+$(this).closest('.DYNROW').attr('data-row'),'BKDT_ENDDATE'+$(this).closest('.DYNROW').attr('data-row'),$(this).closest('.DYNROW')[0])" class="btn btn-Syel waves-effect BTNHIDE waves-light">Upload</button> 
				</div>
			</div>
			<div class="col-md-4">
                <div class="md-form">
					<button type="button" onclick="NetBankingInteg('NetBanking','BKDT_BNKNO'+$(this).closest('.DYNROW').attr('data-row'),'BKDT_STDATE'+$(this).closest('.DYNROW').attr('data-row'),'BKDT_ENDDATE'+$(this).closest('.DYNROW').attr('data-row'),$(this).closest('.DYNROW')[0])" class="btn btn-Syel waves-effect BTNHIDE waves-light">Net Banking</button> 
				</div>
            </div>
			<div class="col-md-4">
                <div class="md-form">
		...
		<div class="form-row Rpt" style="display:none">
            ...
            <div class="col-md-4">
                <div class="md-form">
                  	<input type="text" id="BKDT_ENDDATE" name="BKDT_ENDDATE" onclick="DateValidate('BKDT_STDATE'+$(this).closest('.DYNROW').attr('data-row'),'BKDT_ENDDATE'+$(this).closest('.DYNROW').attr('data-row'));" onchange="DateValidate('BKDT_STDATE'+$(this).closest('.DYNROW').attr('data-row'),'BKDT_ENDDATE'+$(this).closest('.DYNROW').attr('data-row'));"  maxlength="10"  class="form-control   ISFutureDateFields IsNumberFields NoSpecialChar  BKDTDBfields ISDatefield">
			...
			<!--<div class="col-md-4 " >
                  <div class="md-form">
                  	<input type="text" id="BKDT_SANLIMIT" maxlength="15" name="BKDT_SANLIMIT" class="form-control  IsCURCommaFields IsNumberFields BKDTDBfields">
                    <label for="BKDT_SANLIMIT" class="">Sanction Limit<span class="MndtryAstr">*</span></label>
                 </div>
            </div>--> 
		</div>
		 <div class="form-row MODEMANUAL">
						  <div class="col-md-6">
                              <div class="md-form">
									<select class="md-form colorful-select dropdown-primary BKDTMndtry BKDTDBfields" onchange="BANKGRD($(this).closest('.DYNROW')[0]);" id="BKDT_MODE"  name="BKDT_MODE">
                                    <option value="">Select</option>
			...
			<div class="col-md-6">
			  <div class="md-form">
					<select class="md-form colorful-select dropdown-primary BKDTMndtry BKDTDBfields" searchable="Search here.." onchange="" id="BKDT_INSID"  name="BKDT_INSID">
					<option value="">Select</option>
					</select>
		   ...
		   <div class="col">
             ...
             <table cellpadding="0"  cellspacing="0" border="0" style="width: 80%" class="display BKDTDBfields DataGrid" name="BANKTable" id="BANKTable">
                    ...
                    <div class="col Btxt10">Supporting Documents</div>
					  <div class="form-row">
        <div data-for="MultiAttach" class="col MultiAttach"> 
        </div>
         </div>
		 <div class="DynamicPageGrid MULTILOADMULTI" data-val="PROPTXTHDR|" id="MultiAttach" data-multi-UniqNo="BKDT_BNKNO" data-multi-FieldClass="LIMADBfields" data-multi-SP="LSW_SGETBANKATTACHMENT" style="display:none">
        <div data-row="" class="card-body px-lg-5 pt-0 DYNROWOne">
        </br>
		<input type="text" id="LIMA_UNIQID" hidden="hidden" name="LIMA_UNIQID" value="" class="form-control LIMADBfields">
                           <input type="text" id="LIMA_PRCSID" hidden="hidden" name="LIMA_PRCSID" value="" class="form-control LIMADBfields">
                           <input type="text" id="LIMA_ACTIVITYID" hidden="hidden" name="LIMA_ACTIVITYID" class="form-control LIMADBfields">
                           <input type="text" id="LIMA_DTCREATED" hidden="hidden" name="LIMA_DTCREATED" class="form-control LIMADBfields">
                           <input type="text" id="LIMA_CREATEDBY" hidden="hidden" name="LIMA_CREATEDBY" class="form-control LIMADBfields">
                           <input type="text" id="LIMA_DTMODIFIED" hidden="hidden" name="LIMA_DTMODIFIED" class="form-control LIMADBfields">
                           <input type="text" id="LIMA_MODIFIEDBY" hidden="hidden" name="LIMA_MODIFIEDBY" class="form-control LIMADBfields">
                           <div class="form-row">
                                    ...
                                    <table>
                                       <tr>
                                          <td>
                                             ...
                                             <div id="LIMA_PDATTACHMNTUPLOAD"  class="file-field">
                                                <a class="">
                                                <i class="fa fa-plus imgAdd" aria-hidden=""></i>
                                                <input type="file"  name="datafile" onchange="DocFldUpldHndlr_MULTI(this,'LIMA_PDATTACHMNT'+$(this).closest('.DYNROWOne').attr('data-row'),'LIMA_PDATTACHMNT','PDDetails','PDDate','PD',$(this).closest('.DYNROWOne'))" class="LIMA_PDATTACHMNT"  >
                                                </a>
                                                <input type="text" id="LIMA_PDATTACHMNT" hidden="hidden" data-Validate="LIMA_PDATTACHMNT"  name="LIMA_PDATTACHMNT" class="form-control File LIMADBfields ">
                                                <span class="name">Upload Documents</span> 
                                             </div>
                                          </td>
                                          <div class="md-form">
                                             <div class="md-form Formcol-mdLR">
                                                <div class="LIMA_PDATTACHMNT" style="display:none"> 
                                                <img src="ThemeproLO/Common/Images/Delete_Img.png" style="height:25px;width:25px" data-tab="" class=" DELBTN DELETEDOCUMNETS"/>      
                                       
                                        <!--  <img src="ThemeproLO/Common/Images/UploadImg.png" class="rounded" title="UPLOAD" onclick="ReuploadFile($('#LIMA_PDATTACHMNT'+$(event.target).closest('.DYNROW').attr('data-row')));" 
                                                alt="Cinque Terre" width="20" height="20">   -->
                                                <img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW" 
                                                onclick="GrdDocDwnld('LIMA_PDATTACHMNT'+$(this).closest('.DYNROWOne').attr('data-row'))" class="rounded" 
		...
		<div class="HyperControls form-row" >
                        <a onclick="AddPageMultiData_v1('LIMA_UNIQID',$('#BKDT_PRCSID').val(),$('#BKDT_BNKNO'+$(this).closest('.DYNROW').attr('data-row')).val(),'BankDetail1|MultiAttach','LIMADBfields',$(this).closest('.DYNROW').attr('data-row'));" class="Btxt4 FltRight ADDBTN "  href="#">+ Add  Documents</a>
                        <!-- <a class="Btxt4" id="AuditTrail" href="#">Audit Trail</a> -->
                     </div>
		 </div>
		 </div>
