...
<div class="row">
  ...
  <div class="card CardNS">
    ...
    <!-- Card body -->
      <div class="card-body px-lg-5 pt-0">
        <form>
         <input type="text" id="FINT_PRCSID" hidden="hidden" name="FINT_PRCSID" class="form-control FINTDBfields">
          <input type="text" id="FINT_ACTIVITYID" hidden="hidden" name="FINT_ACTIVITYID" class="form-control FINTDBfields">
           <input type="text" id="FINT_DTCREATED" hidden="hidden" name="FINT_DTCREATED" class="form-control FINTDBfields"> 
           <input type="text" id="FINT_CREATEDBY" hidden="hidden" name="FINT_CREATEDBY" class="form-control FINTDBfields">
            <input type="text" id="FINT_MODIFIEDBY" hidden="hidden" name="FINT_MODIFIEDBY" class="form-control FINTDBfields">
             <input type="text" id="FINT_DTMODIFIED" hidden="hidden" name="FINT_DTMODIFIED" class="form-control FINTDBfields">
        	<!-- LSW_TRATIOCOMPDETAILS -->
        	  <input type="text" id="FINT_CUSID" hidden="hidden" name="FINT_CUSID"   class="form-control FINTDBfields">
			  <input type="text" id="FINT_CUSNAME" hidden="hidden" name="FINT_CUSNAME"   class="form-control FINTDBfields">
              <input type="text" id="FINT_FINRATIOS" hidden="hidden" name="FINT_FINRATIOS" class="form-control FINTDBfields">
			  <input type="text" id="FINT_BALASHEET" hidden="hidden" name="FINT_BALASHEET" class="form-control FINTDBfields">
        	</br>
  ...
  <img src="ThemeproLO/Common/Images/UploadImg.png" class="GridDocUpd" title="UPLOAD" attr-upd="" width="20" height="20">
               ...
               <div class="col-md-6"> 
                  <div class="md-form">
                    <select class="md-form colorful-select dropdown-primary RAIOYEAR  FINTDBfields" onchange="GrdLoadOnYrChng()" id="FINT_YEAR" name="FINT_YEAR">
		 ...
		 <div class="Btxt8" > </div>
		  <br>
		   <div class="form-row">
           <div class="col-md-12">
             <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'Table4',{spname:'LSW_SGETFINANCEGRID',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:$('#FINT_CUSID').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||4','FINANACESHEET');" id="BTNFINANACESHEET" name="BTNFINANACESHEET" />
	       ...
	       <div class="form-row">
             <div class="col d-flex justify-content-center">
                     <button type="button" id="Save1" data-aria="LSW_TFINANCE|FINT|FINT_CUSID" data-form="ExistingLoan" class="btn btn-Syeloutline waves-effect waves-light FormSave">Save</button>
                         
                     <button type="button" data-aria="LSW_TFINANCE|FINT|FINT_CUSID" next-form="TAB|" data-form="ExistingLoan" data-card="2" class="btn btn-Syel waves-effect waves-light FormSave">Save & Next</button>
