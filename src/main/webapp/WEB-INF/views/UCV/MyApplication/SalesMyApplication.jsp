     ...
     <div class="">
        ...
        <form>          
           ...
           <div class="form-row">
                ...
                <div class="col">
                <div class="md-form">
                        <select class="mdb-select md-form colorful-select dropdown-primary LBSIDBfields  LBSIMndtry" onchange="GetNaturProduct();" id="LBSI_LONTYPE" name="LBSI_LONTYPE">
                        </select>
...
<script type="text/javascript" src="ThemeproLO/Common/FEP/Calendar/js/monthly.js${DMY13}"></script>
 <script type="text/javascript" src="ThemeproLO/UCV/DashBoard/Script/MyApplication/LoadSubmit/LoadSubmit.js${DMY13}"></script>
  <script type="text/javascript" src="ThemeproLO/UCV/DashBoard/Script/MyApplication/Validation/Validation.js${DMY13}"></script> 
