     ...
     <div class="">
        ...
        <form>          
           ...
           <div class="form-row">
                <div class="col">
                  <div class="md-form">
                  <select class="mdb-select md-form colorful-select dropdown-primary LBSIDBfields LBSIMndtry DataToFld" onchange="CheckSource();" searchable="Search here.." data-change="LBSI_BRID"  id="LBSI_BRANCH" name="LBSI_BRANCH">
                        <!--  <option value="" selected>--Select--</option>
           ...
           <div class="form-row">
            <div class="col-md-6 SUBLON">
                 <div class="md-form">
                       <select class="mdb-select md-form colorful-select dropdown-primary LBSIDBfields  PROIIDROP" id="LBSI_SUBLONTYPE" name="LBSI_SUBLONTYPE">
                        <option value="" selected>--Select--</option>
                        </select>
