...
<div class="modal fade" id="CUSSELECTIONModal" tabindex="-1" role="dialog" aria-labelledby="CUSSELECTIONModalLabel"
  ...
  <div class="form-row">
    ...
    <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/DirDepartmentMST/LoadSubmit.js${DMY13}"></script>
 <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/DirDepartmentMST/Validation.js${DMY13}"></script> 
