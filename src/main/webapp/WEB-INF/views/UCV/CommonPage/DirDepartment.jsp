		   ...
		   <div class="col-md-4">
                     <div class="md-form">
						<label for="BRCR_REMARK" class="active">Remarks<span class="MndtryAstr"></span></label>
						 <br>
                          <textarea class="form-control BRCRDBfields" maxlength="255" id="BRCR_REMARK" name="BRCR_REMARK" style="height: 100px;width:380px;"></textarea>					
                     </div>
                  </div>
			 </div>
...
<th>UPFD_DTMODIFIED</th>-->
    ...
    <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/DirDepartment/LoadSubmit.js${DMY13}"></script>
 <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/DirDepartment/Validation.js${DMY13}"></script> 
