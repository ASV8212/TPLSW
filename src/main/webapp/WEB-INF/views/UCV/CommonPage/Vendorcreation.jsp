...
<div class="modal fade" id="VendorBrModal" tabindex="-1" role="dialog" aria-labelledby="VendorBrModalLabel"
  ...
  <div class="modal-dialog" style="max-width:1000px" role="document">
    ...
    <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/VendorCreation/LoadSubmit.js${DMY13}"></script>
 <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/VendorCreation/Validation.js${DMY13}"></script>
