...
<script type="text/javascript" src="ThemeproLO/Forms/Script/Tabs.js${DMY13}"></script>
    ...
    <script>$(function(){ document.body.style.zoom = "91.5%"});</script>
	 <!--<script>history.pushState('', '', window.location.pathname)</script>-->
</head>
 
<body class="hidden-sn white-skin FormBG">
    ...
    <div style="display:none" id="customizer" class="z-depth-1">
        ...
        <div class="inner">
          ...
          <div style="display:none">
			...
			<input id="PrcsID" name="PrcsID" type="hidden" value="${PrcsID}"/>
			<input id="ActvID" name="ActvID" type="hidden" value="${ActvID}"/>
...
<!--  	<div class="col-md-12 ">
        ...
        <div class="container-fluid">
			...
			<tiles:insertAttribute name="ApplHdr" />
...
<div class="container-fluid FormContent">
			...
			<!-- 	<div class="row">
<div class="col-md-12">	 -->
			<tiles:insertAttribute name="ApplTitle" />
			<!--  </div>
				</div> -->	
...
<div class="row">
<div class="col-md-4 ApplInfo"><tiles:insertAttribute name="ApplInfo" /></div>

<div class="col-md-8 ApplBody">
<tiles:insertAttribute name="ApplTabs" />
