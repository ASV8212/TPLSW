...
<div class="custom-control custom-radio custom-control-inline">
  ...
  <!-- card -->
    ...
    <script type="text/javascript" src="ThemeproLO/UCV/ViewRpt/Script/FIResidenceInfo/LoadSubmit.js${DMY13}"></script>
    <script type="text/javascript" src="ThemeproLO/UCV/ViewRpt/Script/FIResidenceInfo/Validation.js${DMY13}"></script>      -    
