                 ...
                 <div class="col-md-1 CREDIT">
				  ...
				  <div class="form-row">
							...
							<img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW"  class="rounded" onclick="GrdDocDwnld('RPRD_PROPERTYDOC1')" alt="Cinque Terre" width="35" height="25"> </div>
							 ...
							 <div class="col-md-6">
                                 <div class="md-form">
                                    <select class="mdb-select md-form colorful-select dropdown-primary  RPRDDBfields"  id="RPRD_RCUSTATUS" name="RPRD_RCUSTATUS" >
                                       <option value="">Select</option>
                  ...
                  <div class="card-body px-lg-5 pt-0  BSbrd DYNROW">
                     ...
                     <form>
                        ...
                        <div class="form-row">
                           <div class="col-md-6">
                              <div class="md-form">
                                 <select class="md-form colorful-select dropdown-primary IRCMMndtry RCBKDBfields" disabled onchange="UpdtDefrFlg(this,'RCBK_DEFRSTUS')" id="RCBK_FINANCCOLLCT" name="RCBK_FINANCCOLLCT">
                                    <option value="">Select</option>
                    ...
                    <input type="hidden" id="RCBK_REMRK"  name="RCBK_REMRK" disabled class="form-control DSVLBL form-control    RCBKDBfields ">
                        ...
                        <div class="form-row ">
                        	<div class="col-md-6">
							 ...
							 <div class="col-md-6">
                              <div class="md-form">
                                 <select class="md-form colorful-select dropdown-primary  RCBKDBfields"  id="RCBK_RCUSTATUS" name="RCBK_RCUSTATUS">
                                    <option value="">Select</option>
                                  <option value="Query">Query</option>
                                    <option value="Not Screened">Not Screened</option>
									<option  value="Screened" >Screened</option>
      ...
      <div class="form-row">
         <div class="col d-flex justify-content-center">
            ...
            <button type="button" style="display:none;" id="SendBack" data-aria="LSW_TIRCUDOCUMENT|IRCM|IRCM_CUSID" data-card="0" class="btn btn-Syel waves-effect BTNDOCMVL waves-light FormSave">Send Back</button>
			 ...
			 <button type="button" id="Forward" data-aria="LSW_TIRCUDOCUMENT|IRCM|IRCM_CUSID" id="Forward" onclick="PopFldToDrpDwn(this)"  class="InitBTN btn btn-Syeloutline waves-effect waves-light FormSave">Initiated</button>  
			 
			 <button type="button" id="Forward" data-aria="LSW_TIRCUDOCUMENT|IRCM|IRCM_CUSID" id="SUBMIT"   class=" btn btn-Syeloutline waves-effect waves-light FormSave">Submit</button> 
...
<script type="text/javascript" src="ThemeproLO/UCV/ViewRpt/Script/VdrRCU/LoadSubmit/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/UCV/ViewRpt/Script/VdrRCU/Validation/Validation.js${DMY13}"></script> 
