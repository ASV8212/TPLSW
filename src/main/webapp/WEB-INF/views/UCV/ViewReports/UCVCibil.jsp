...
<th>UPFD_DTMODIFIED</th>-->
   ...
   <script type="text/javascript" src="ThemeproLO/UCV/ViewRpt/Script/Cibil/LoadSubmit.js${DMY13}"></script>
    <script type="text/javascript" src="ThemeproLO/UCV/ViewRpt/Script/Cibil/Validation.js${DMY13}"></script>
     ...
     <div class="">
         <form >
           ...
           <div class="form-row">
           		...
           		<div class="col-md-6">
           		   <div class="md-form">
                      <input type="text" id="FIEG_CIBILSCOREI" name="FIEG_CIBILSCOREI" maxlength="3" class="form-control IsNumberFields CCLR FIEGDBfields">
