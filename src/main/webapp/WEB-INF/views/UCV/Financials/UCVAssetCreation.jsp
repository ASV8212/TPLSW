...
<!--Accordion wrapper-->
  ...
  <!-- Accordion card -->
  <!-- Accordion card -->
  <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/AssetCreation/LoadSubmit.js${DMY13}"></script>
  <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/AssetCreation/Validation.js${DMY13}"></script>
