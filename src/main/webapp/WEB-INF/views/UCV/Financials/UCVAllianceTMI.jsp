...
<script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/AllianceTMI/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/AllianceTMI/Validation.js${DMY13}"></script>                            
