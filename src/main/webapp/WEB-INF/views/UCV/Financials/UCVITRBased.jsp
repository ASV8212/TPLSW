...
<th>PVCS_CUSID</th>
  ...
  <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/ITRBased/LoadSubmit.js${DMY13}"></script>
  <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/ITRBased/Validation.js${DMY13}"></script>
