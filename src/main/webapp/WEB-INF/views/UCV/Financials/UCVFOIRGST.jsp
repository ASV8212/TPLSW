<!-- Accordion card -->
  ...
  <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/FOIRGST/LoadSubmit.js${DMY13}"></script>
  <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/FOIRGST/Validation.js${DMY13}"></script>
