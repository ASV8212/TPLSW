...
<th>PVCS_CUSID</th>
  ...
  <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/GSTBased/LoadSubmit.js${DMY13}"></script>
  <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/GSTBased/Validation.js${DMY13}"></script>
