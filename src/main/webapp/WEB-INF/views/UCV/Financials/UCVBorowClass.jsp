...
<script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/BorowClass/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/BorowClass/Validation.js${DMY13}"></script>                            
