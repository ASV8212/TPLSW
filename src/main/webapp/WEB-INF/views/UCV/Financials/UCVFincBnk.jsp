...
<!--			  <div class="col-md-6 Btxt10 BnkNotes"> 
       ...
       <div class="form-row">
          <div class="col">
              <input type="button" data-button="GridButton" data-value="BALANCETable|LSW_SGETUCVBNTBALANCEGRID|PrcsID|FCBD_ACCTNUM|FCBD_BNKNO|3,5,6,11,12,13|BALANCEGRID"
...
<script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/FincBnk/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/FincBnk/Validation.js${DMY13}"></script>  
