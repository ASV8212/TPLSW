    ...
    ${SUBPAGETABDATA}
     ...
     <a> <div class="nav-link" href="#">+ Add</div>  </a>
	  ...
	  <div class="HiddenBTN">
         <input type="button" style="display:none" class="DashTrg"  id="BTNASSSET" name="BTNBALANCESHEET" /><!-- Employment Details -->
      </div>
	  
	  <div class="HiddenBTN">
         <input type="button" style="display:none" class="DashTrg"  id="BTNFNSUM" name="BTNFNSUM" /><!-- Employment Details -->
      </div>
	  ...
	  <div class="HiddenBTN">
         <input type="button" style="display:none" class="DashTrg"  id="BTNFNBSHT" name="BTNFNBSHT" /><!-- Employment Details -->
      </div>
	    <div class="HiddenBTN">
         <input type="button" style="display:none" class="DashTrg"  id="BTNFNCASHFLOW" name="BTNFNCASHFLOW" /><!-- Employment Details -->
      </div>
          ...
          <input type="text" id="RACD_ACTIVITYID" hidden="hidden" name="RACD_ACTIVITYID" class="form-control RACDDBfields">
           ...
           <input type="text" id="RACD_CREATEDBY" hidden="hidden" name="RACD_CREATEDBY" class="form-control RACDDBfields">
        	...
        	<!-- LSW_TRATIOCOMPDETAILS -->
			 ...
			 <input type="text" id="RACD_ASSETSGRID" hidden="hidden" name="RACD_ASSETSGRID" class="form-control RACDDBfields">
			  <input type="text" id="RACD_SUMBALSHTGRID" hidden="hidden" name="RACD_SUMBALSHTGRID" class="form-control RACDDBfields">
			   <input type="text" id="RACD_SUMCASHFLOW" hidden="hidden" name="RACD_SUMCASHFLOW" class="form-control RACDDBfields">
        	</br>
        	<!-- profitlose(); -->
               ...
               <div class="col-md-4" style="display:none">
                  <div class="md-form">
                    <div class="select-radio AddFirm"> 
                       <div class="custom-control custom-radio custom-control-inline">
                          <input type="radio" class="custom-control-input RACDDBfields" disabled value="Ratio Sheet" onclick="profitlose('Change');" id="Ratio" name="RACD_PROFIT">
                          <label class="custom-control-label" for="Ratio">Ratio Sheet</label>
                       </div>
                       <div class="custom-control custom-radio custom-control-inline">
                           <input type="radio" class="custom-control-input RACDDBfields" disabled value="Financial Summary"  onclick="profitlose('Change');" id="Financial" name="RACD_PROFIT">
           ...
           <div class="form-row">
               ...
               <div class="col-md-4 UPDOC AddFirm">
                  <div class="md-form">
                  <div class="" ></div>
				 ...
				 <div id="EXCELUPLOAD"  class="file-field DDU FltRight ">
				  ...
				  <span class="name Btxt4  FltRight ">Click Here to Excel Upload
           ...
           <div class="form-row">
				<div class="col-md-4">
					<div class="md-form">
						<input type="text" id="RACD_PERFIOSTEMPLATE" hidden="hidden" data-Validate="RACD_PERFIOSTEMPLATE"  name="RACD_PERFIOSTEMPLATE" class="form-control File RACDDBfields">
						<span class="name1">Download Perfios FSA Template</span>
						<img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW" onclick="GrdDocDwnld('RACD_PERFIOSTEMPLATE');" class="rounded" alt="Cinque Terre" width="35" height="25"> 
					</div>
				</div>
				<div class="col-md-4">
					<div class="md-form">
						<table>
						 <tr>
						 <td>
						  <div id="RACD_PERFIOSATTACHUPLOAD"  class="file-field">
							<a class="">
							  <i class="fa fa-plus imgAdd" aria-hidden="" ></i>
							  <input type="file"  name="datafile"  onchange="FSAUploadFile(RACD_PERFIOSATTACH,'RACD_PERFIOSATTACH','RACD_PERFIOSATTACHVIEW')" class="RACD_PERFIOSATTACH">
							</a>
							<input type="text" id="RACD_PERFIOSATTACH" data-val="PAN ID" hidden="hidden" data-Validate="RACD_PERFIOSATTACH"  name="RACD_PERFIOSATTACH" class="form-control RACDDBfields">
							<span class="name1">Upload Updated FSA File</span>
						  </div> 
						</td> 
						</tr>
						</table>
				...
				<div class="col-md-4 RACD_PERFIOSATTACHVIEW" >
					<div class="md-form Formcol-mdLR TxtCenter">
					<div class="md-form">
					<div class="RACD_PERFIOSATTACH" style="display:none">  
					<img src="ThemeproLO/Common/Images/Delete_Img.png" style="height:25px;width:25px" data-tab="" class=" DELBTN DELETEDOCUMNETS">
					<img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW" onclick="GrdDocDwnldDB('RACD_PERFIOSATTACH');" class="rounded" alt="Cinque Terre" width="35" height="25"> 
					</div>
					</div>
					</div>
					</div>
 ...
 <div class="card" >
    ...
    <!-- Card header -->
    <div class="card-header Btxt8" role="tab" id="headingTwo11">
  
        <a class="collapsed Btxt7 AFormaccordion" data-aria="" data-load="" data-multidata="BTNASSSET" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo11"
        aria-expanded="false" aria-controls="collapseTwo11">
          Assets<i class="fa fa-plus-circle rotate-icon"></i>
      </a> 
      
      
    </div>
    <!-- Card body -->
    <div id="collapseTwo11" class="collapse" role="tabpanel" aria-labelledby="headingTwo11" data-parent="#accordionEx">
     <div class="card-body px-lg-5 pt-0 BSbrd DYNROW"> 
       </br>
        <form>
          ...
          <div class="form-row">
           <div class="col">
             <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'Table6',{spname:'LSW_SGETRATIOASSETS',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:'ASSETS|'+$('#RACD_CUSID').val()+'|'+$('#RACD_UNIQID').val()+'|'+GetRadioBtnVal(),MnuId:GetLatestFincYr()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||4,5,6','RATIOASSETS');" id="BTNRATIOASSETS" name="BTNRATIOASSETS" />
 ...
 <div class="card" >
    ...
    <!-- Card header -->
    <div class="card-header Btxt8" role="tab" id="headingTwo12">
  
        <a class="collapsed Btxt7 AFormaccordion" data-aria="" data-load="" data-multidata="BTNFNSUM" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo12"
        aria-expanded="false" aria-controls="collapseTwo12">
         P&L Account<i class="fa fa-plus-circle rotate-icon"></i>
      </a> 
      
      
    </div>
    <!-- Card body -->
    <div id="collapseTwo12" class="collapse" role="tabpanel" aria-labelledby="headingTwo12" data-parent="#accordionEx">
     <div class="card-body px-lg-5 pt-0 BSbrd DYNROW"> 
       </br>
        <form>
 ...
 <div class="card" >
    ...
    <!-- Card header -->
    <div class="card-header Btxt8" role="tab" id="headingTwo13">
  
        <a class="collapsed Btxt7 AFormaccordion" data-aria="" data-load="" data-multidata="BTNFNBSHT" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo13"
    ...
    <!-- Card body -->
    <div id="collapseTwo13" class="collapse" role="tabpanel" aria-labelledby="headingTwo13" data-parent="#accordionEx">
     <div class="card-body px-lg-5 pt-0 BSbrd DYNROW"> 
       </br>
        <form>
           ...
           <div class="form-row">
           <div class="col">
             <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'Table7',{spname:'LSW_SGETRATSUMBLSHEET',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:'SUMBALANCESHT|'+$('#RACD_CUSID').val()+'|'+$('#RACD_UNIQID').val(),MnuId:$('#RACD_FINSUMYEAR').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||4,5,6','RATIOSUMBALSHT');" id="BTNFNBALSHT" name="BTNFNBALSHT" />
 ...
 <div class="card" >
    ...
    <!-- Card header -->
    <div class="card-header Btxt8" role="tab" id="headingTwo14">
  
        <a class="collapsed Btxt7 AFormaccordion" data-aria="" data-load="" data-multidata="BTNFNCASHFLOW" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo14"
        aria-expanded="false" aria-controls="collapseTwo14">
         Cash Flow<i class="fa fa-plus-circle rotate-icon"></i>
      </a> 
    ...
    <div id="collapseTwo14" class="collapse" role="tabpanel" aria-labelledby="headingTwo14" data-parent="#accordionEx">
     <div class="card-body px-lg-5 pt-0 BSbrd DYNROW"> 
        ...
        <form>
           ...
           <div class="form-row">
           <div class="col">
             <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'Table8',{spname:'LSW_SGETRATSUMCASHFLOW',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:'SUMCASHFLOW|'+$('#RACD_CUSID').val()+'|'+$('#RACD_UNIQID').val(),MnuId:$('#RACD_FINYEAR').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||4,5,6','RATIOSUMCASHFLOW');" id="BTNFNCASHFLOW1" name="BTNFNCASHFLOW1" />
 ...
 <div class="RADIO">
   <div class="card CardNS">
    <!-- Card body -->
     ...
     <div class=" col-md-4">
      <div class="md-form">
       <input type="text" id="PRORATI" disabled name="PRORATI" value="-" class="form-control Btxt17 DSVLBL   ">
        </div>
         </div>
          ...
          <div class=" col-md-2">
          <div class="md-form">
                 <input type="text" id="STANDAERD" disabled name="STANDAERD" value="" class="form-control Btxt17 DSVLBL   ">
                 </div>
         </div>
            ...
            <div class=" col-md-2 ">
              ...
              <div class=" col-md-2 ">
					 <div class="md-form">
               <input type="text" id="RAPR_REMARKS" disabled name="RAPR_REMARKS" value="2017-2018" class=" form-control  Btxt17 DSVLBL   RACDDBfields  ">
              </div>
              </div>
     
      </div>
      <div class="form-row">
     <div class="Btxt10" >PROFITABILITY RATIOS</div>
      </div>
    ...
    <!--  Short Term Liquidity   -->
          <div class="form-row">
     <div class="Btxt10" >LIQUIDITY RATIOS</div>
      </div>
     ...
     <div class="Btxt10" >OTHER RATIO</div>
      ...
      <div class="DynamicPageGrid" data-val="PROPTXTHDR|" id="OTHERRATIO" style="display:none">
       <div data-row="" class=" DYNROW">
		...
		<!-- CASH FLOW START -->
        <div class="form-row">
     <div class="Btxt10" >BUSINESS GROWTH</div>
      </div>
