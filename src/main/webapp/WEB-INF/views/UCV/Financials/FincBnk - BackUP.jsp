...
<div class="custom-control custom-radio custom-control-inline">
<input type="radio" class="custom-control-input FCBDDBfields" disabled onclick="ManualAvailable($(this).closest('.DYNROW')[0],this.id);" value="Auto" id="Auto" name="FCBD_RPTGENR">
         ...
         <div class="form-row">
             <div class="col-md-6"> 
			  ...
			  <div class="col-md-6 Btxt10 BnkNotes"> 
			    Note: For Banking Surrogate, if Loan Amount is Greater Than 100Lakhs then the ABB computation will happen based on Total Daily Balance; apart from that, the ABB computation will happen based on Amount on 5th, 15th and 25th.
			  </div>
         </div>
      <div class="form-row">
          <div class="col">
             <input type="button" data-button="GridButton" data-value="BALANCETable|LSW_SGETBNTBALANCEGRID|PrcsID|FCBD_ACCTNUM|FCBD_BNKNO|8,9,10|BALANCEGRID" style="display:none" class="DashTrg FCBDDBfields BalancGrdTrg  MultiGridTrg" id="BTNBALANCEGRD" name="BTNBALANCEGRD" />
