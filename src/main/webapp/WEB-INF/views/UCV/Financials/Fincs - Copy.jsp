               ...
               <!--  <div class="row FormRows"> 
                      ...
                      <div class="col-md-12"> -->
                        ...
                        <div class="">
                            ...
                            <div class="row">
	<div class="col-lg-12">
		  <ul title="Scheme" data-popup="Yes" class="nav FormPageMultiTab">     
    ${SUBPAGETABDATA}
    ...
    <div id="collapseOne1" class="collapse show accordiontab" data-form="CAM" role="tabpanel" aria-labelledby="headingOne1"
      ...
      <div class="card-body px-lg-5 pt-0">
		...
		<div class="form-row loadfincscreen">
			<jsp:include page="//FOIRGST"></jsp:include>
...
<!-- Credit Analytics End -->
   ...
   <div class="card GENCAM" style="display:none">
   </br>
...
<!-- END -->
 ...
 <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/Fincs/Validation.js${DMY13}"></script> 
 <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/Fincs/LoadSubmit.js${DMY13}"></script>
