 <!-- card -->
      <div class="card">
         <div class="card-body px-lg-5 pt-0" >
            ...
            <div class="col-md-4">
                  <div class="md-form">
                  	  <input type="text" id="ABBL_LOANAMT"  maxlength="30"  name="ABBL_LOANAMT" class="form-control ABBLMndtry IsNumberFields   ABBLDBfields">
            ...
            <div class="col-md-4">
			 ...
			 <div class="form-row">
			  <div class="col-md-4">
                  <div class="md-form">
                  	  <input type="text" id="ABBL_NOOFDEBMON"  maxlength="30"  name="ABBL_NOOFDEBMON" 
					      class="form-control  IsNumberFields   ABBLMndtry  ABBLDBfields">
            ...
            <div class="col-md-4">
                  <div class="md-form">
                  	  <input type="text" id="ABBL_LOANDISBURSE"   maxlength="30"  name="ABBL_LOANDISBURSE" class="form-control ABBLMndtry IsNumberFields  ABBLDBfields">
		...
		<div class="form-row"> 
		 <div class="col-md-4">
                  <div class="md-form">
                  	  <input type="text" id="ABBL_TOTAVG"  maxlength="30"  name="ABBL_TOTAVG" class="form-control ABBLMndtry IsNumberFields  ABBLDBfields">
                      <label for="ABBL_TOTAVG" class="">Adjusted total of Averages<span class="MndtryAstr">*</span></label>
                  </div>
                </div>
            <div class="col-md-4">
                  <div class="md-form">
                  	  <input type="text" id="ABBL_MONTHABB"  maxlength="30"  name="ABBL_MONTHABB" class="form-control ABBLMndtry  IsNumberFields ABBLDBfields">
            ...
            <div class="col-md-4">
                  <div class="md-form">
                  	  <input type="text" id="ABBL_MONTHEMI"  maxlength="30"  name="ABBL_MONTHEMI" class="form-control ABBLMndtry IsNumberFields ABBLDBfields">
			...
			<div class="col-md-4">
                  <div class="md-form">
                  	  <input type="text" id="ABBL_TCRESUMBNKAC"  maxlength="30"  name="ABBL_TCRESUMBNKAC" class="form-control ABBLMndtry  IsNumberFields  ABBLDBfields">
				...
				<div class="col-md-4">
                  ...
                  <div class="form-row">
                     <div class="col d-flex justify-content-center">
                        <button type="button" id="Save" data-aria="LSW_TABBUBLSCREEN|ABBL" class="btn btn-Syeloutline waves-effect waves-light Save FormSave">Save</button>   
                        <button type="button" data-aria="LSW_TABBUBLSCREEN|ABBL" data-card="0" class="btn btn-Syel waves-effect waves-light FormSave">Save & Next</button> 
                     </div>
                  </div>
...
<script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/ABBUBL/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/ABBUBL/Validation.js${DMY13}"></script>                            
