...
<th>PVCS_CUSID</th>
  ...
  <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/LowLTV/LoadSubmit.js${DMY13}"></script>
  <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/LowLTV/Validation.js${DMY13}"></script>
