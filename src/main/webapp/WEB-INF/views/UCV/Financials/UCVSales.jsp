...
<!-- END -->
 ...
 <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/Sales/Validation.js${DMY13}"></script> 
 <script type="text/javascript" src="ThemeproLO/UCV/Financials/Script/Sales/LoadSubmit.js${DMY13}"></script>
