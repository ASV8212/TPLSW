      ...
      <div class="card-body px-lg-5 pt-0">
           ...
           <img src="ThemeproLO/Common/Images/Delete_Img.png" style="height:25px;width:25px" data-tab="ABFD_PRCSID|ABFD_FIRMCONT|Business Details" class="DELBTN DELETETAP">
                        ...
                        <div class="form-row PARTNERFARM" style="display:none">
                         ...
                         <div class="form-row PARTNERFARM" style="display:none">						
                            <div class="col">
                               <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'LPDSTable',{spname:'LSW_SLPDSGRDDETL',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:$('#ABFD_FIRMCONT').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||6,7','LPDSGRID');" id="BTNLPDSGRD" name="BTNLPDSGRD" />
...
initSample("ABFD_TEBUSNESSPROG");
    ...
    <script type="text/javascript" src="ThemeproLO/UCV/Approve/Script/BusinessDetl/LoadSubmit.js${DMY13}"></script>
    <script type="text/javascript" src="ThemeproLO/UCV/Approve/Script/BusinessDetl/Validation.js${DMY13}"></script> 
