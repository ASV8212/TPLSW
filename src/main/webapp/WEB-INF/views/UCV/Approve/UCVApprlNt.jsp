       ...
       <!--  <input type="text" id="EGCD_CUSNAME" name="EGCD_CUSNAME" hidden="hidden" class="form-control EGCDDBfields">  -->
         ...
         <div class="card">
			...
			<div class="grid-width-100">
				...
				<textarea style="" id="AAPR_LOANSUMM"	placeholder="Type the content here!"  class="Edtr Text TEXTEDITDSBL" name="AAPR_LOANSUMM" data-maxlen="10000" maxlength="10000">
				 <%= editData.getTxt4() %>  
                </textarea>
         ...
         <div class="card">
            <!-- Card header -->
            <div class="card-header Btxt7" role="tab" id="heading13">
               <a class="collapsed Btxt7 AFormaccordion" data-toggle="collapse" data-load="" data-multidata="" data-aria="LSW_TAPPRCIBIL|APCB" data-parent="#accordionEx" href="#collapse13"
                  aria-expanded="false" aria-controls="collapse13">
               CIBIL Justification<i class="fa fa-plus-circle rotate-icon"></i>
               </a>
            </div>
            <div id="collapse13" class="collapse" role="tabpanel" aria-labelledby="heading13"
               ...
               <div class="card-body px-lg-5 pt-0">
                  ...
                  <form>
                     <input type="text" id="APCB_PRCSID" hidden="hidden" name="APCB_PRCSID" class="form-control APCBDBfields">
                     <input type="text" id="APCB_ACTIVITYID" hidden="hidden" name="APCB_ACTIVITYID" class="form-control APCBDBfields">
                     <input type="text" id="APCB_DTCREATED" hidden="hidden" name="APCB_DTCREATED" class="form-control APCBDBfields">
                     <input type="text" id="APCB_CREATEDBY" hidden="hidden" name="APCB_CREATEDBY" class="form-control APCBDBfields">
                     <input type="text" id="APCB_DTMODIFIED" hidden="hidden" name="APCB_DTMODIFIED" class="form-control APCBDBfields">
                     <input type="text" id="APCB_MODIFIEDBY" hidden="hidden"  name="APCB_MODIFIEDBY" class="form-control APCBDBfields">
                     <div class="form-row" style="display:none">
                        <div class="col">
                           <div class="md-form">
                              <textarea id="APCB_CIBILJUSTI" name="APCB_CIBILJUSTI" class="form-control APCBDBfields btxt24" maxlength="4000"  style="height: 130px;width:1150px;"></textarea>
                           </div>
                        </div>
                     </div>
					 <div class="adjoined-bottom">
			...
			<div class="grid-width-100">
				...
				<div class="invalid-tooltip"></div>
                     ...
                     <div class="form-row">
                        <div class="col d-flex justify-content-center">
                           <button type="button" id="Save8" data-aria="LSW_TAPPRCIBIL|APCB" data-form="CIBILJust" class="btn btn-Syeloutline waves-effect waves-light FormSave">Save</button>   
                           <button type="button" data-aria="LSW_TAPPRCIBIL|APCB" data-form="CIBILJust" data-card="6" class="btn btn-Syel waves-effect waves-light FormSave">Save & Next</button> 
                        </div>
                     </div>
                  </form>
               </div>
         ...
         <div class="card">
			...
			<div class="grid-width-100">
				...
				<textarea style="" id="AAPR_COLLATERAL"	placeholder="Type the content here!"  class="Edtr Text TEXTEDITDSBL" name="AAPR_COLLATERAL" data-maxlen="10000" maxlength="10000">
				 <%= editData.getTxt5() %>  
                </textarea>
         ...
         <div class="card">
			...
			<div class="grid-width-100">
				...
				<textarea style="" id="AAPR_ENDUSESUMMARY"	placeholder="Type the content here!"  class="Edtr Text TEXTEDITDSBL" name="AAPR_ENDUSESUMMARY" data-maxlen="10000" maxlength="10000">
				 <%= editData.getTxt6() %>  
                </textarea>
         ...
         <div class="card">
			...
			<div class="grid-width-100">
				...
				<textarea style="" id="AAPR_STRANGTHSUMMA"	placeholder="Type the content here!"  class="Edtr Text TEXTEDITDSBL" name="AAPR_STRANGTHSUMMA" data-maxlen="10000" maxlength="10000">
				 <%= editData.getTxt7() %>  
                </textarea>
         ...
         <div class="card">
			...
			<div class="grid-width-100">
				...
				<textarea style="" id="AAPR_REFCHECKSUMM"	placeholder="Type the content here!"  class="Edtr Text TEXTEDITDSBL" name="AAPR_REFCHECKSUMM" data-maxlen="10000" maxlength="10000">
				 <%= editData.getTxt8() %>  
                </textarea>
		 ...
		 <div class="form-row GenApprNote" style="display:none">
            ...
            <!-- Card header -->
                      <div class="form-row">
                        ...
                        <div class="col d-flex justify-content-center">
						<button type="button" id="SendBack" data-aria="LSW_TAPPLNAPPROV|AAPR" style="display:none;" onclick=""  class="btn btn-Syeloutline waves-effect waves-light BTNHIDE APIBUTHIDE FormSave StageReversal">Send Back</button> 
                        <button type="button" id="Reject" data-aria="LSW_TAPPLNAPPROV|AAPR"   data-form="FamilyBackground" class="BTNSTA btn btn-Syeloutline APIBUTHIDE waves-effect waves-light">Reject</button>  
						<button type="button" id="Save12" onclick="" data-aria="LSW_TAPPLNAPPROV|AAPR" data-form="FamilyBackground" class="btn btn-Syel APIBUTHIDE waves-effect waves-light FormSave">Generate Approval Note</button>   
                        <button type="button" id="Save12" data-aria="LSW_TAPPLNAPPROV|AAPR"   data-form="FamilyBackground" class="BTNSTA btn btn-Syel APIBUTHIDE waves-effect waves-light FormSave">Send for Approval</button>  
							 
							 
							 <button type="button" id="APIBUTTON" style="display:none" onclick="SUBMITABIFILE();" class="BTNSTA btn btn-Syel waves-effect waves-light APIBUT">Processed With API</button> 
							 
							 <button type="button" id="APIREJECT" style="display:none" onclick="" class="BTNSTA btn btn-Syel waves-effect waves-light APIBUT">Reject</button> 
						</div>
                     </div>
         </div>
  ...
  <div class="modal-dialog" style="max-width:1000px" role="document">
    ...
    <!--Main layout-->
      ...
      <div class="modal-footer align-middle">
          ...
          <button type="button" id="Confirm" onclick="" class="btn btn-yel Btxt2 Confirm SaveAppr">Confirm</button>
      </div>
    </div>
  </div>
  </div>
...
initSample("AAPR_LOANSUMM");
initSample("AAPR_COLLATERAL");
