 ...
 <a type="button" class="Btxt4 FltLeft  ALIHDBfields"  onclick="generatePDF('AMPI_INSURERNAME'+$(this).closest('.DYNROW').attr('data-row'),'AMPI_LOCATN'+$(this).closest('.DYNROW').attr('data-row'),'PolicyProperty',$(this).closest('.DYNROW')[0])">Property Policy Insured.pdf</a>
                        ...
                        <div class="form-row">
                           ...
                           <div class=" col-md-4 Btxt17">
                              <div class="md-form">
                                 <input type="text" id="AMPI_SUMINSRD" name="AMPI_SUMINSRD" disabled value="" class="form-control IsCURCommaFields DSVLBL IsNumberFields AMPIDBfields  ">
                              </div>
                           </div>
                        </div>
                        <div class="form-row">
                           ...
                           <div class=" col-md-4">
                              <div class="md-form">
                                 <input type="text" id="AMPI_PRMINCLDGST" name="AMPI_PRMINCLDGST" value="" disabled class="form-control RMCD IsCURCommaFields IsNumberFields AMPIDBfields  ">
                              </div>
                           </div>
                        </div>
						<div class="form-row">
 ...
 <a type="button" class="Btxt4 FltLeft  ALIHDBfields"  onclick="generatePDF('ACHP_CUSID'+$(this).closest('.DYNROW').attr('data-row'),'','HealthPac',$(this).closest('.DYNROW')[0],'Pac')">Pac Policy Insured.pdf</a>
            ...
            <div class="form-row">
               <div class="col-md-4" style="display:none">
                  <div class="md-form">
                     <input type="text" id="ACHP_SUMINSRD" maxlength="30"  name="ACHP_SUMINSRD" disabled class="form-control ACHPDBfields IsNumberFields IsLandlneFields ">
...
<script type="text/javascript" src="ThemeproLO/UCV/Approve/Script/CrsSelProp/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/UCV/Approve/Script/CrsSelProp/Validation.js${DMY13}"></script>
