               ...
               <div class="form-row">
        		<div class="col Btxt3">System Empowerment</div>
                  ...
                  <form>
					 ...
					 <div class="form-row">
                        <div class="col">
                           <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'Table5',{spname:'LSW_SMANUEMPRMNTDTL',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:'',MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||4','MNUEMPOWERMNT');" id="BTNMANUEMPOWERMNT" name="BTNMANUEMPOWERMNT" />
         ...
         <!-- <a class="Btxt4" id="AuditTrail" href="#">Audit Trail</a>-->
                     ...
                     <div class="form-row">
                        <div class="col d-flex justify-content-center">
							...
							<button type="button" id="SaveE11" data-aria="LSW_TAPPREMPR|APEM" data-form="FamilyBackground" class="btn btn-Syel waves-effect waves-light FormSave">Generate Empowerments</button>
...
<script type="text/javascript" src="ThemeproLO/Approve/Script/Empwr/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/Approve/Script/Empwr/Validation.js${DMY13}"></script>      
