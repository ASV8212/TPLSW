...
<div class="md-form">
<input type="text" id="username" name="username" class="GridMndtry gridClrfields form-control validate">
...
<select  id="roles" name="roles"  class="mdb-select md-form gridClrfields " >
<option value="" disabled selected>Role(s)</option>
<option value="ROLE_ADMIN">Admin</option>
<option value="ROLE_USER" selected="selected">User</option>
</select>
<label for="roles" data-error="wrong" data-success="right" class="">Role(s)</label>
</div>                                               
 </div>
 ...
 <div class="md-form">
 <!--<input type="text" id="POIG_CorpCode" name="POIG_CorpCode" class="GridMndtry gridClrfields form-control validate">-->
<select  id="active" name="active"  class="mdb-select md-form gridClrfields " >
<option value="" disabled selected>Status</option>
<option value="0">Inactive</option>
<option value="1" selected="selected">Active</option>
</select>
<label for="active" data-error="wrong" data-success="right" class="">Status</label>
</div>                                               
 </div>
   </div>
...
<label for="employeeRole" data-error="wrong" data-success="right" class="">Job Title</label>
 ...
 <div class="md-form">
 <!--<input type="text" id="POIG_CorpCode" name="POIG_CorpCode" class="GridMndtry gridClrfields form-control validate">-->
<select  id="employeeOrganization" name="employeeOrganization"  class="mdb-select md-form gridClrfields " >
...
<label for="employeeOrganization" data-error="wrong" data-success="right" class="">Organization</label>
 ...
 <div class="md-form">
 <!--<input type="text" id="POIG_CorpCode" name="POIG_CorpCode" class="GridMndtry gridClrfields form-control validate">-->
<select  id="employeeDepartment" name="employeeDepartment"  class="mdb-select md-form gridClrfields " >
 <option value=""> </option>
...
<div class="col-md-6">                                             
<div class="md-form">
<input placeholder="Selected date" type="text" id="employeeStartDate"  name="employeeStartDate" class="GridMndtry gridClrfields form-control datepicker picker__input" readonly="" >
<label for="employeeStartDate" class="active">Start Date</label>                                                   
</div>                                               
</div>

<div class="col-md-6">                                             
<div class="md-form">
<input placeholder="Selected date" type="text" id="employeeEndDate"  name="employeeEndDate" class="GridMndtry gridClrfields form-control datepicker picker__input" readonly="" >
<label for="employeeEndDate" class="active">End Date</label>                                                   
</div>                                               
</div>
</div>
    ...
    <script type="text/javascript">
        ...
        function validateField(){
			...
			var op= UI_getdata($( '#username' ).val(),"CHK",$("#employeeCode").val(),"","","SAM_SFEPADMNGRPINS")
            if($("[name=password]").val() == "" || $("[name=confirmPassword]").val() == ""){
                if(alertString != ""){
                    alertString += '\n';
                }
                alertString += 'New Password and Confirm Password are required';
                valid = false;
            }else if($("[name=password]").val() != $("[name=confirmPassword]").val()){
                if(alertString != ""){
                    alertString += '\n';
                }
                alertString += 'New Password and Confirm Password do not match';
                valid = false;
            }
			
			else if($(op).find('Result').text()=='No')
			{
				if(alertString != ""){
                    alertString += '\n';
                }
			alertString += 'User ID Already Exists!!';
			valid = false;
			}
			
			else if($(op).find('Result').text()=='MOB')
			{
				if(alertString != ""){
                    alertString += '\n';
                }
			alertString += 'Mobile No Already Exists!!';
			valid = false;
			}
		...
		data = new FormData();
			...
			data.append( '_roles', $( '#_roles' ).val() );
			data.append( 'timeZone', "" );
			data.append( 'active', $( '#active' ).val() );
			data.append( 'employeeCode', $( '#employeeCode' ).val() );
			data.append( 'employeeRole', $( '#employeeRole' ).val() );
			data.append( 'employeeOrganization', $( '#employeeOrganization' ).val() );
			data.append( 'employeeDepartment', $( '#employeeDepartment' ).val() );
			data.append( 'employeeDepartmentHod', $( '#employeeDepartmentHod' ).val() );
			data.append( 'employeeStartDate', $( '#employeeStartDate' ).val() );
			data.append( 'employeeEndDate', $( '#employeeEndDate' ).val() );
			...
			$.ajax({
				...
				if( $( '#roles' ).val() =='ROLE_ADMIN')
				{
				UI_getdata($( '#username' ).val(),"INS","","","","SAM_SFEPADMNGRPINS")
				}
				}
				});
            }else{
