...
<div class="col-md-12">
 <input type="button" style="display:none" class="DashTrg" onclick="FncallMyApplDshBrd(this,'Table6',{spname:'LSW_SBSMREPORTEEDASHBRD',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#LogUsr').val(),brid:'',MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||','DSHBRDWTHHREF');" id="BTNreportee" name="BTNreportee" />
   ...
   <a href="#"><img id="BRPOPCLOSE" class="close" data-dismiss="modal" aria-label="Close" src="ThemeproLO/Common/FEP/images/Close1.png" alt="DashSearch"></img></a>      
    ...
    <!-- Card body -->
     <div class=""> 
        ...
        <div class="modal-header">
       <div class="Btxt10"><input type="text" id="BRANCHNAME"  name="BRANCHNAME" class="form-control DSVLBL Btxt10"> </div>
       </div>
	   <div class="form-row">
	            <div class="col-md-8">
				</div>
     ...
     <div class=""> 
        ...
        <div class="modal-header">
             ...
             <div class="form-row">
           		 <div class="col">
           			<div class="md-form">
                <button type="button" style="display:none" id="DataViewPerfRptII" onclick="FncallMyApplDshBrd(this,'Table9',{spname:'LSW_SBSMREPORTEEDASHBRD3',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:'P732',brid:'',MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||','DSHBRDWTHHREF');"  ></button>
					  <!--  <table cellpadding="0" cellspacing="0" border="0" style="width: 80%" class="display" id="CBRTable">
                     </table>-->
				<!--	 <button type="button" style="display:none" id="BRViewRpt" onclick="FncallMyApplDshBrd(this,'Table4',{spname:'LSW_SSALESDASHGRIDPOUP',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#LogUsr').val(),brid:BRID,MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||3','DSHBRD');" ></button>
