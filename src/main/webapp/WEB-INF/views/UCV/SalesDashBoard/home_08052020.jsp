...
${DASHBRD2}    
    	...
    	<div class="col-md-8 DashPrp1row" style="">
    		
    		<div class="row">
    		
         		<div class="col-md-12 NoPadLeft" style="margin-top:16px;">     
   ...
   <div class="row DashPrp2row">
      ...
      <div class="row DashPrp3row ">
      
      <div class="col-md-12 d-flex justify-content-center">
      <ul class="nav URoundTabs ">
      
     
      <li class="nav-item RoundTabs active ">
       <a> <div class="nav-link active" href="#"  id="Branches" onClick="BSMRPTCHNG(this.id);">Branches</div></a>
      </li>
      
      
      <li class="nav-item RoundTabs ">
     <a> <div class="nav-link" href="#" id="Reportee" onClick="BSMRPTCHNG(this.id);">Reportee</div>  </a>
      </li>
...
<div class="col-md-12">
 <input type="button" style="display:none" class="DashTrg" onclick="FncallMyApplDshBrd(this,'Table3',{spname:'LSW_SSALESDASHGRID',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#LogUsr').val(),brid:'Loan',MnuId:$('#GridBranch').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||','GENERAL');" id="BTNAcctRecv" name="BTNAcctRecv" />
     ...
     <div class=""> 
	   ...
	   <div class="form-row">
                ...
                <div class="col-md-4">
                  ...
                  <select class="mdb-select md-form colorful-select dropdown-primary" onchange="SalesBSMDashbrdTrig();" id="CATEGORY" name="CATEGORY">
                         <option value="" selected>--Select--</option>
                              ...
                              <option value="DSA">DSA</option>
                              <option value="DST">DST</option>
							  <option value="Connecter">Connector</option>
							  <option value="Direct">Direct</option>
                        </select>
             ...
             <div class="form-row">
           		 <div class="col">
           			<div class="md-form">
                <button type="button" style="display:none" id="BRViewRpt" onclick="FncallMyApplDshBrd(this,'Table4',{spname:'LSW_SSALESDASHGRIDPOUP',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#LogUsr').val(),brid:$('#BRANCHID').val(),MnuId:$('#CATEGORY').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||','DSHBRD');"  ></button>
