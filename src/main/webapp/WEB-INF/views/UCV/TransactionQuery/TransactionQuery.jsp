...
<input type="button" style="display:none" onclick="FncallFEPQueueLrgData(this,'Table1',{spname:'SCF_sGetBtchWsTrnsList',DBSrc:'INTR1',Mode:'',Param:$('#RMLH_PrgmID').val(),brid:$('#RMLH_BtchNo').val(),MnuId:$('#PrcsID').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')});" id="BTNTranQr" name="BTNTranQr" />
 ...
 <!-- SCRIPTS -->
    ...
    <!-- JQuery -->
   <script type="text/javascript" src="ThemeproLO/UCV/TransactionQuery/Script/TransactionQuery/LoadSubmit/LoadSubmit.js${DMY13}"></script>
      <script type="text/javascript" src="ThemeproLO/UCV/TransactionQuery/Script/TransactionQuery/Validation/Validation.js${DMY13}"></script>
