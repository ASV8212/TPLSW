         ...
         <div id="collapseOne1" class="collapse " role="tabpanel" aria-labelledby="headingOne1"
            ...
            <div class="card-body px-lg-5 pt-0  ">
               ...
               <form>
                  ...
                  <div class="form-row ML01">
                     <div class="col  BluShd">
                        <label class="Btxt10 SANHEAD">Post sanction Documents</label>
                     </div>
                  </div>
                  <div class="form-row ML01">
                     <div class="col">
                  ...
                  <div class="form-row ML01">
                     <div class="col  BluShd">
                        <label class="Btxt10 SANHEAD">Reports</label>
                     </div>
                  </div>
                  <div class="form-row ML01">
                     <div class="col">
                  ...
                  <div class="form-row">
                     <div class="col  BluShd">
                        <label class="Btxt10 SANHEAD">Repayment Instruments</label>
                     </div>
                  </div>
                  <div class="form-row">
                     <div class="col">
