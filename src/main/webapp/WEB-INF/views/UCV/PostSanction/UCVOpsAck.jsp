   ...
   <div class="card-body px-lg-5 pt-0 BSbrdlight">
	...
	<div class="col-lg-12">
       ...
       <li id="DisbursementChecklist" value="UCVDisbrsmnt" title="Disbursement Checklist" class="nav-item ">
            ...
            <li id="OpsAcknowledgement" value="UCVOpsAck" title="Ops Acknowledgement" class="nav-item active">
               <a>
...
<script type="text/javascript" src="ThemeproLO/UCV/PostSanction/Script/OpsAck/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/UCV/PostSanction/Script/OpsAck/Validation.js${DMY13}"></script>                            
