 ...
 <div class="card CardNS">
    ...
    <script type="text/javascript" src="ThemeproLO/UCV/PostSanction/Script/InsurUpld/LoadSubmit.js${DMY13}"></script>
	  <script type="text/javascript" src="ThemeproLO/UCV/PostSanction/Script/InsurUpld/Validation.js${DMY13}"></script>
