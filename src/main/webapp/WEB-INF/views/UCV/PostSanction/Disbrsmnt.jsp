               ...
               <form>
                  ...
                  <div class="form-row ML01">
                     <div class="col  BluShd">
                        <label class="Btxt10"> Pre Sanction Documents </label>
                     </div>
                  </div>
                  <div class="form-row ML01">
                     <div class="col">
                  ...
                  <div class="form-row ML01">
                     <div class="col  BluShd">
                        <label class="Btxt10"> Repayment Instruments </label>
                     </div>
                  </div>
                  <div class="form-row ML01">
                     <div class="col">
                  ...
                  <div class="form-row ML01">
                     <div class="col  BluShd">
                        <label class="Btxt10">Sanction Conditions</label>
                     </div>
                  </div>
                  <div class="form-row ML01">
                     <div class="col">
                  ...
                  <div class="form-row ML01">
                     <div class="col  BluShd">
                        <label class="Btxt10">Additional Documents</label>
                     </div>
                  </div>
                  <div class="form-row ML01">
                     <div class="col">
...
<script type="text/javascript" src="ThemeproLO/PostSanction/Script/Disbrsmnt/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/PostSanction/Script/Disbrsmnt/Validation.js${DMY13}"></script>
