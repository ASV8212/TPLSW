	...
	<div class="col-lg-12">
     ...
     <div class="form-row">
       ...
       <div class="form-row">
           ...
           <div class="col-md-3">
             <div class="md-form">
               <input type="text" maxlength="30"  class="Btxt14 IsNumberFields NoSpecialChar DBMMDBfields DBMMMndtry IsCURCommaFields form-control" onchange="ChkLoanAmt();GetRemainAmtChange();" id="DBMM_ACTUDISBAMT" name="DBMM_ACTUDISBAMT">
      ...
      <div data-row="" class="DYNROW">
        ...
        <input type="text" id="DISB_TRANCHNAME" hidden="hidden" name="DISB_TRANCHNAME" class="form-control DISBDBfields">
           ...
           <div class="col-md-3">
             <div class="md-form">
               <input type="text" maxlength="30"  class="Btxt14 IsNumberFields NoSpecialChar DISBDBfields  IsCURCommaFields form-control" onchange="ChkLoanAmt();GetRemainAmtChange();" id="DISB_ACTUDISBAMT" name="DISB_ACTUDISBAMT">
          ...
          <div class="col-md-3">
               <div class="md-form">
                 <input type="text" id="DBMM_PEMIAMT" maxlength="30" name="DBMM_PEMIAMT" disabled class="PEMIDED Btxt14 DSVLBL IsNumberFields NoSpecialChar DISBDBfields IsCURCommaFields form-control">
                  <label for="DBMM_PEMIAMT"  class="Btxt9 ">PEMI Amount &#x20b9;</label>
              </div>
           </div> 
      </div> 
      <div class="form-row">
           <div class="col-md-2">
                <div class="md-form">
                 <input type="text" id="DISB_OTHRDUC" maxlength="15" name="DISB_OTHRDUC" value="0" disabled class=" Btxt14 DSVLBL IsNumberFields NoSpecialChar DISBDBfields IsCURCommaFields form-control">
           ...
           <div class="col-md-3">
               <div class="md-form">
                  <input type="text" id="DISB_TOTDEDUC" name="DISB_TOTDEDUC" maxlength="30" disabled class="PEMIDED DSVLBL Btxt14 IsNumberFields NoSpecialChar DISBDBfields IsCURCommaFields form-control">
                  <label for="DISB_TOTDEDUC"  class="Btxt9 ">Total Deduction &#x20b9;</label>
              </div>
           </div> 
           <div class="col-md-2">
               <div class="md-form">
                  <input type="text" id="DISB_DISBAMT" maxlength="30" name="DISB_DISBAMT" disabled class="Btxt14 DSVLBL IsNumberFields NoSpecialChar  DISBDBfields IsCURCommaFields form-control">
