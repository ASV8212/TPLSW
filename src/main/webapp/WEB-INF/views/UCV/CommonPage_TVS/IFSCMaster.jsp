 ...
 <div class="card CardNS">
      ...
      <div class="card-body px-lg-5 pt-0">
        ...
        <input type="text" id="DATEMODIFY"  name="DATEMODIFY" hidden="hidden"  class="form-control DBfields" value="">
          ...
          <div class="form-row">
           ...
           <div class="col-md-4">
                  <div class="md-form">
                    <input type="text" id="MICRNO"  maxlength="9" class="form-control IFSCD DBfields   Mndtry NoSpecialChar" name="MICRNO">
    ...
    <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/IFSCMaster/LoadSubmit.js${DMY13}"></script>
    <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/IFSCMaster/Validation.js${DMY13}"></script>
