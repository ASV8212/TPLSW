...
<div class="modal fade" id="CUSSELECTIONModal" tabindex="-1" role="dialog" aria-labelledby="CUSSELECTIONModalLabel"
  ...
  <div class="modal-dialog" style="max-width:800px" role="document">
   ...
   <div class="">
    ...
    <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/VendorMST/LoadSubmit.js${DMY13}"></script>
 <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/VendorMST/Validation.js${DMY13}"></script> 
