...
<div class="modal fade" id="CUSSELECTIONModal" tabindex="-1" role="dialog" aria-labelledby="CUSSELECTIONModalLabel"
 ...
 <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/DirUserMST/LoadSubmit.js${DMY13}"></script>
 <script type="text/javascript" src="ThemeproLO/UCV/Commonpage/DirUserMST/Validation.js${DMY13}"></script> 
