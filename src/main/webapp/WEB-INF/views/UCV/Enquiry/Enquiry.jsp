              ...
              <div class="form-row" style="">
               <div class="col-md-4" style="display:none">
				...
				<div class="col-md-4">
                  <!-- Last name -->
                  <div class="md-form">
                    <input type="text" id="ApplNo" name="ApplNo"  class="form-control IsNumberFields NoSpecialChar ClearField">
...
<script type="text/javascript" src="ThemeproLO/Common/FEP/js/Grid/dataTables.cellEdit.js${DMY13}"></script> 
 ...
 <!-- SCRIPTS -->
    ...
    <!-- JQuery -->
   <script type="text/javascript" src="ThemeproLO/UCV/Enquiry/Script/LoadSubmit.js${DMY13}"></script>
   <script type="text/javascript" src="ThemeproLO/UCV/Enquiry/Script/Validation.js${DMY13}"></script>
