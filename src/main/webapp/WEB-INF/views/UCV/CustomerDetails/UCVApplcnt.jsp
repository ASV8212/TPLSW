    ...
    <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
      ...
      <div class="card-body px-lg-5 pt-0">
       ...
       <input type="text" id="CBSI_APPLCNTDATE"  name="CBSI_APPLCNTDATE" hidden="hidden"  class="form-control CBSIDBfields" value="">
		...
		<input type="text" id="CBSI_NPROFILE"  name="CBSI_NPROFILE" hidden="hidden"  class="form-control CBSIDBfields" value="">
		...
		<!--   
		   ...
		   <div class="form-row GSTF" style="display:none">	
               <div class="col-md-6 " >
                    ...
                    <!-- <button type="button" data-Validatearia="CBSI_GSTVERIFY" onclick="CheckValidPanKyc('CBSI_GSTNUM','CBSI_GSTVERIFY','CBSI_CUSFISNAM','CBSI_CUSTYPE','gstdetailed','CBSI_CUSID','CADI_ORGADDRLINI','CADI_ORGADDRLINII','','','','CEMI_ADDRLINEI','CEMI_ADDRLINEII','CBSI_CONSTITUTION','CBSI_NATURBUS');SavePersInfo();" data-validate="gstin"  class="btn btn-Verify CBSI_GSTNUM waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>-->
						<input type="text" id="CBSI_GSTNUM" maxlength="15" disabled name="CBSI_GSTNUM" class="form-control GST IsGstValid NoSpecialChar CBSIDBfields">
           ...
           <div class="form-row">
                <div class="col-md-6">
                  <div class="md-form">
                    ...
                    <input type="text" id="CBSI_CUSFISNAM" maxlength="75"  name="CBSI_CUSFISNAM" class="form-control IsUpprCse IsAlphaFields NoSpecialChar CBSIDBfields CBSIMndtry">
           ...
           <div class="form-row INDU">
            <div class="col">
                  <div class="md-form">
                    ...
                    <input type="text" id="CBSI_FATHRNAM"  name="CBSI_FATHRNAM" class="form-control IsAlphaFields IsUpprCse INDM CBSIDBfields CBSIMndtry">
           ...
           <div class="form-row INDU">
            ...
            <div class="form-row">
                ...
                <div class="PROFILE col-md-6 ">
                  	<div class="md-form">
                     <select class="mdb-select md-form colorful-select dropdown-primary   PROFILEVAL CBSIDBfields CBSIMndtry" onchange="DataToProfFld(this); CheckProfile('Change');" data-change="CBSI_NPROFILE" id="CBSI_PROFILE" name="CBSI_PROFILE">
						 <option value="">Select</option>
        ...
        <div class="form-row">
             <div class="col-md-6 VERIFYBTNPOSITION">   
               <div class="md-form">
                  ...
                  <!-- <button type="button" data-Validatearia="CADI_EMAILVERIFY" onclick="VerfyMail(this,$('#CADI_EMAILID').val(),$('#CBSI_CUSID').val());SaveContDetl();" data-validate="email"  class="btn btn-Verify CADI_EMAILID waves-effect btn-yelInplain btn-sm BTNVerify VERIFYBTNPOSITIONRIGHT ">Verify</button>-->
                   ...
                   <input type="text" id="CADI_EMAILID" maxlength="100"  data-link="CADI_EMAILID|CADI_EMAILVERIFY" name="CADI_EMAILID" class="form-control datalink CADIDBfields IsEmailFields ">
        ...
        <div class="form-row">
            <div class="col-md-6 VERIFYBTNPOSITION">   
                  <div class="md-form">
                    ...
                    <input type="text" id="CADI_MOBNOII" data-link="CADI_MOBNOII|CADI_MOBIIVERIFY" maxlength="10" onchange="CheckDupMobNo('CADI_MOBNOII','CADI_MOBNOI','Mobile Number');DupMOBval('CADI_PRCSID','CADI_MOBNOII','CADI_CUSID');" name="CADI_MOBNOII" class="form-control  CADIDBfields datalink NoSpecialChar IsNumberFields IsMobileFields">
...
<img src="ThemeproLO/Common/Images/Eyeview.png" title="Address Proof Two View"  class="rounded" onclick="GrdDocDwnld('CADI_ADDRPROOF2')" alt="Cinque Terre" width="35" height="25">Address Proof 2</div>
</div>
</div> 
<div class="col-md-5">
</div>
     ...
     <div class="NINDU">  
		...
		<div class="col-md-1">
                ...
                <div class="col-md-5">
                  <div class="md-form">
                      <input type="text" id="CADI_ORGLNDLINENO" maxlength="10"  name="CADI_ORGLNDLINENO" class="form-control CADIDBfields IsNumberFields IsLandlneFields CADIMndtry">
                        ...
                        <div class="DynamicPageGrid" data-val="PROPTXTHDR|Employment" id="BankDetail1" style="display:none">
                              ...
                              <form>
					        	...
					        	<div class="col Btxt10">	 DETAILS</div>
                                 ...
                                 <div class="form-row">
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_ORGANINAME" maxlength="75" name="CEMI_ORGANINAME" class="form-control CEMIDBfields CEMIMndtry NoSpecialChar">
                                 ...
                                 <div class="form-row">
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_ADDRLINEI" maxlength="60" name="CEMI_ADDRLINEI" class="form-control CEMIDBfields OFFADDR CEMIMndtry AddrNoSpecialChar CEMIMndtry">
                                 ...
                                 <div class="form-row">
                                    ...
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_CITY" disabled name="CEMI_CITY" class="form-control CEMIDBfields CEMIMndtry">
                                 ...
                                 <div class="form-row">
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_STATE"  disabled name="CEMI_STATE" class="form-control  CEMIDBfields CEMIMndtry">
                                          <label for="CEMI_STATE" class="OADDR">State<span class="MndtryAstr">*</span></label>
                                       </div>
                                    </div>
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_LNDMARK" maxlength="40" name="CEMI_LNDMARK" onchange="ChkLanMark(this,'CEMI_LNDMARK'+$(this).closest('.DYNROW').attr('data-row'));" class="form-control OFFADDR  CEMIDBfields CEMIMndtry">
                                 ...
                                 <div class="form-row">
                                    <div class="col-md-1 SEP">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_STDC" maxlength="4" style="width:75px" disabled name="CEMI_STDC" class="form-control OFFADDR CEMIDBfields IsNumberFields"> 
                                          <label for="CEMI_STDC" class="OADDR">STD</label>
                                       </div>
                                    </div>
                                    <div class="col-md-5 SEP">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_LNDLINENO" maxlength="10"  name="CEMI_LNDLINENO" class="form-control OFFADDR CEMIDBfields IsNumberFields IsLandlneFields">
                                 ...
                                 <div class="form-row">
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_DATOFESTABLIS" maxlength="10" onblur="CompareJointoDOB(this,CBSI_DOB,CEMI_NOOFYERBUSINESS,'CBSI_PROFILE');ExpYearvalid(this,CEMI_NOOFYERBUSINESS);" name="CEMI_DATOFESTABLIS" class="form-control NoSpecialChar ISFutureDateFields JOINDATE CEMIDBfields CEMIMndtry IsNumberFields  ISDatefield">
                                 ...
                                 <div class="form-row OEMPONE">
                                    ...
                                    <div class="col-md-6">
                                       <div class="md-form"><!--SEPM EMPI OEMPM-->
                                	...
                                	<!--<div class="form-row YESEMP " >
										<div class="col-md-6" >
											<div class="md-form">
												<input type="text" id="CEMI_EUAMNO" maxlength="19"  name="CEMI_EUAMNO" class="form-control IsUpprCse IsUAMFields Udayamfield URNFld CEMIDBfields">
								...
								<div class="form-row">
								<div class="col SEP PRECOMM OEMPONE">
                                       <div class="md-form">
                          ...
                          <!--  <div class="form-row">
                                <div class="col">
                                    <div class="md-form">
										<div class="custom-control custom-radio custom-control-inline ">
                                             <input type="checkbox" class="custom-control-input CEMIMndtry CEMIDBfields"  id="CEMI_INCCONSID" name="CEMI_INCCONSID">
  ...
  <div class="card NINDU ORG">
      ...
      <div class="card-body px-lg-5 pt-0">
         ...
         <input type="text" id="CDOG_CUSID" hidden="hidden"  name="CDOG_CUSID" class="form-control CDOGDBfields">
            ...
            <div class="form-row">
               ...
               <div class="col">
				...
				<!--<div class="form-row YESSHOW ">

				<div class="col-md-6 ">
                 <div class="md-form">
                       <div class="custom-control custom-radio custom-control-inline ">
                               <input type="checkbox" class="custom-control-input CDHA CDOGDBfields" onchange="Chkbox();" id="CDOG_CUAMNO" name="CDOG_CUAMNO">
				...
				<div class="col-md-6">
					<div class="md-form">
					<input type="text" id="CDOG_UDYAMVERI" hidden="hidden" maxlength="30" name="CDOG_UDYAMVERI" class="form-control GST CBSIDBfields">
                      <button type="button" data-Validatearia="CDOG_UDYAMVERI" onclick="CheckKYCDetl(this,'CDOG_UDYAMVERI','CDOG_UAMNO','GST');" data-validate="gstin"  class="btn btn-Verify CDOG_UAMNO waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>
						<input type="text" id="CDOG_UAMNO" maxlength="19"  name="CDOG_UAMNO" class="form-control IsUpprCse IsUAMFields Udayamfield  CDOGDBfields">
		...
		<div class="form-row   ">
				<!--<div class="col-md-6 ">
					...
					<div class="md-form">
					<div class="CDOG_UPDUAMNO" style="display:none"> <img src="ThemeproLO/Common/Images/UploadImg.png" onclick="ReuploadFile(CDOG_UPDUAMNO);" title="UPLOAD"  class="rounded ReUpld" alt="Cinque Terre" width="20" height="20">  
					<img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW"  class="rounded" onclick="GrdDocDwnld('CDOG_UPDUAMNO')" alt="Cinque Terre" width="35" height="25"> </div>
					</div>
					</div>  
					</div>
					</div> 	-->			
                    ...
                    <label for="CDOG_KYCCATEGORY" class="">KYC Category<span class="MndtryAstr"></span></label>
							...
							<!-- <div class="form-row">
                                <div class="col">
                                    <div class="md-form">
										<div class="custom-control custom-radio custom-control-inline ">
                                             <input type="checkbox" class="custom-control-input CDOGDBfields" id="CDOG_INCCONSID" name="CDOG_INCCONSID">
   ...
   <div class="card OLYUC">
    <!-- Card header -->
    <div class="card-header Btxt7" role="tab" id="headingFour5">
      <a class="collapsed Btxt7 AFormaccordion  " data-toggle="collapse" data-multidata="" data-form="Customer Segmentation " data-aria="LSW_TCUSSEGDTL|CSAP|CSAP_CUSID|CBSI_CUSID" data-load="" data-parent="#accordionEx" href="#collapseFour5"
        aria-expanded="false" aria-controls="collapseFour5">
          Customer Segmentation  <i class="fa fa-plus-circle rotate-icon"></i>
      </a>
    </div>
    <!-- Card body -->
    <div id="collapseFour5" class="collapse" role="tabpanel" aria-labelledby="headingFour5"
      ...
      <div class="card-body px-lg-5 pt-0">
      	<form>
      	 <input type="text" id="CSAP_PRCSID" hidden="hidden" name="CSAP_PRCSID" class="form-control CSAPDBfields">
         <input type="text" id="CSAP_ACTIVITYID" hidden="hidden" name="CSAP_ACTIVITYID" class="form-control CSAPDBfields">
         <input type="text" id="CSAP_CREATEDBY" hidden="hidden" name="CSAP_CREATEDBY" class="form-control CSAPDBfields">
         <input type="text" id="CSAP_DTCREATED" hidden="hidden" name="CSAP_DTCREATED" class="form-control CSAPDBfields">
         <input type="text" id="CSAP_MODIFIEDBY" hidden="hidden" name="CSAP_MODIFIEDBY" class="form-control CSAPDBfields">
         <input type="text" id="CSAP_DTMODIFIED" hidden="hidden"  name="CSAP_DTMODIFIED" class="form-control CSAPDBfields">
         <input type="text" id="CSAP_CUSID" hidden="hidden"  name="CSAP_CUSID" class="form-control CSAPDBfields">
      	    <div class="form-row">
      			<!-- <div class="col" id="CDOG_GSTNUM" name="CDOG_GSTNUM" >GST Number <b>2635276</b>, Tamil Nadu</div> -->
      		</div>
      		</br>
		     ...
		     <div class="form-row ">	 
						<div class="col-md-6">
                        <div class="md-form">
                           <div id="SEGMET" class="select-radio CSAPMndtry">
                              <div class="custom-control custom-radio custom-control-inline  ">
                                 <input type="radio" class="custom-control-input CSAPDBfields"  value="Goods" id="CSAP_GOODS" name="CSAP_SEGMENT">
                                 <label class="custom-control-label" for="CSAP_GOODS">Goods</label>
                              </div>
                              <div class="custom-control custom-radio custom-control-inline CSAPDBfields  ">
                                 <input type="radio" class="custom-control-input CSAPDBfields"  value="Passenger" id="CSAP_PASSEN" name="CSAP_SEGMENT">
                                 <label class="custom-control-label" for="CSAP_PASSEN">Passenger</label>
                              </div>
                           </div>
					 ...
					 <div class="col-md-6">
                        <div class="md-form ">
                           <div id="CapitivUsage" class="select-radio CSAPMndtry">
                              <div class="custom-control custom-radio custom-control-inline ">
                                 <input type="radio" class="custom-control-input CSAPDBfields"  value="Capitive" id="CSAP_CAPT" name="CSAP_CAPTIVEUSE">
                                 <label class="custom-control-label" for="CSAP_CAPT">Capitive</label>
                              </div>
                              <div class="custom-control custom-radio custom-control-inline CSAPDBfields ">
                                 <input type="radio" class="custom-control-input CSAPDBfields"  value="NonCapitive" id="CSAP_NONCAPT" name="CSAP_CAPTIVEUSE">
                                 <label class="custom-control-label" for="CSAP_NONCAPT">Non Capitive</label>
                              </div>
                           </div>
                           <label class="mdb-main-label BTxt9">Capitive Usage<span class="MndtryAstr">*</span></label>      
                        </div>
                     </div>			 
						</div>		 
			...
			<div class="form-row">				
				<div class="col-md-6">
					<div class="md-form">
						<select class="mdb-select md-form colorful-select dropdown-primary CSAPMndtry CSAPDBfields "  id="CSAP_PROFILE" name="CSAP_PROFILE">
							<option value="" selected >--Select--</option>
							<option value="" > FTU CATA</option>					
						</select>				
							<label class="">Profile<span class="MndtryAstr">*</span></label>
					</div>
				</div>
				...
				<div class="col-md-6">
						<div class="md-form">
							<input type="text" id="CSAP_TOTELFLET" maxlength="19"  name="CSAP_TOTELFLET" class="form-control CSAPMndtry IsNumberFields CSAPDBfields">
							<label for="CSAP_TOTELFLET" class="">Total Fleet<span class="MndtryAstr">*</span></label>
						</div>
				</div>				 
			</div>		
            ...
            <div class="form-row ">				 
				<div class="col-md-6">
						<div class="md-form">
							<input type="text" id="CSAP_FREEFRMFIN" maxlength="19"  name="CSAP_FREEFRMFIN" class="form-control CSAPMndtry IsNumberFields CSAPDBfields">
							<label for="CSAP_FREEFRMFIN" class="">Free From Finance<span class="MndtryAstr">*</span></label>
						</div>
				</div>				 
																	 
				<div class="col-md-6">
						<div class="md-form">
							<input type="text" id="CSAP_PREFUNDFFR" maxlength="19"  name="CSAP_PREFUNDFFR" class="form-control CSAPMndtry IsNumberFields CSAPDBfields">
							<label for="CSAP_PREFUNDFFR" class="">Pre Funding FFR<span class="MndtryAstr">*</span></label>
						</div>
				</div>				 
			</div>		
      	 ...
      	 <div class="form-row">
                 <div class="col d-flex justify-content-center">
                     <button type="button" id="Save5" data-aria="LSW_TCUSSEGDTL|CSAP" data-form="CustomerSegmentation" class="btn btn-Syeloutline waves-effect waves-light FormSave">Save</button>   
                     <button type="button" data-aria="LSW_TCUSSEGDTL|CSAP" data-form="CustomerSegmentation" data-card="4" data-for="SAVENEXT"  class="btn btn-Syel waves-effect waves-light FormSave">Save & Next</button> 
                </div>
            </div>
       	</form>
      </div>
...
<!-- END -->
 ...
 <script type="text/javascript" src="ThemeproLO/UCV/CustomerDetails/Script/Applcnt/LoadSubmit.js${DMY13}"></script>
 <script type="text/javascript" src="ThemeproLO/UCV/CustomerDetails/Script/Applcnt/Validation.js${DMY13}"></script> 
...
<div class="modal fade" id="EBMobModal" tabindex="-1" role="dialog" aria-labelledby="EBMobModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width:350px" role="document">
    ...
    <!--Main layout-->
      ...
      <div class="modal-footer align-middle">
      <!--  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>-->
        <button type="button" id="Mobotp" data-field="CBSI_UTILITYVERIFY|EBRequestId|CBSI_CUSTYPE|CBSI_CUSID|"  onclick="CheckKYCDetl(this,'EBMobOTP','CBSI_UTILITYVERIFY','MOBILE STATUS','');" class="btn btn-yel Btxt2">Confirm</button>
      </div>
    </div>
  </div>
  </div>
