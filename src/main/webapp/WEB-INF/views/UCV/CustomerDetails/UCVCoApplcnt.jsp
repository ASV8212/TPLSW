  ...
  <div class="card active">
    ...
    <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
      ...
      <div class="card-body px-lg-5 pt-0">
        ...
        <input type="text" id="COBI_NPROFILE" hidden="hidden" name="COBI_NPROFILE" class="form-control COBIDBfields">
		...
		<input type="text" id="COBI_IMGSCORE" hidden="hidden" name="COBI_IMGSCORE" class="form-control COBIDBfields">
               ...
               <div class="col-md-6 " >
                   ...
                   <!--  <input type="text" id="COBI_GSTVERIFY"  hidden="hidden" name="COBI_GSTVERIFY" class="form-control GST COBIDBfields">
                     <button type="button" data-Validatearia="COBI_GSTVERIFY" onclick="CheckValidPanKyc('COBI_GSTNUM','COBI_GSTVERIFY','COBI_CUSFISNAM','COBI_CUSTYPE','gstdetailed','COBI_CUSID','COAI_ORGADDRLINI','COAI_ORGADDRLINII','','','','COEI_ADDRLINEI','COEI_ADDRLINEII','COBI_CONSTITUTION','COBI_NATURBUS');SavePersInfo();" data-validate="gstin"  class="btn btn-Verify COBI_GSTNUM waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>-->
						<input type="text" id="COBI_GSTNUM" maxlength="15" disabled name="COBI_GSTNUM" class="form-control IsGstValid datalink NoSpecialChar GST COBIDBfields NoSpecialChar">
           ...
           <div class="form-row">
                <div class="col-md-6">
                  <div class="md-form">
                    ...
                    <input type="text" id="COBI_CUSFISNAM" maxlength="75" name="COBI_CUSFISNAM" class="form-control IsAlphaFields NoSpecialChar IsUpprCse COBIDBfields COBIMndtry">
           ...
           <div class="form-row INDU">
            ...
            <div class="col">
                  ...
                  <div class="md-form">
                    ...
                    <input type="text" id="COBI_FATHRNAM"    name="COBI_FATHRNAM" class="form-control IsUpprCse COBIDBfields IsAlphaFields">
           ...
           <div class="form-row INDU">
            ...
            <div class="col-md-6 INDU">
             ...
             <div class="col-md-6 PROFILE">
               <div class="md-form">
                <select class="mdb-select md-form colorful-select dropdown-primary PROFILEVAL COBIDBfields COBIMndtry" onchange="DataToProfFld(this);CheckProfile('Change');DELEMPDETAILS();" data-change="COBI_NPROFILE" id="COBI_PROFILE" name="COBI_PROFILE">
						<option value="" selected>--Select--</option>
      ...
      <div class="card-body px-lg-5 pt-0">
        ...
        <div class="form-row">
               ...
               <div class="col-md-6 VERIFYBTNPOSITION">  
                  <div class="md-form">
                   <input type="text" id="COAI_EMAILVERIFY"  hidden="hidden" name="COAI_EMAILVERIFY"  maxlength="60"  class="form-control IsEmailFields COAIDBfields">
				  <!--<button type="button" data-Validatearia="COAI_EMAILVERIFY" onclick="VerfyMail(this,$('#COAI_EMAILID').val(),$('#CBSI_CUSID').val());SaveContDetl();" data-validate="email"  class="btn btn-Verify COAI_EMAILID waves-effect btn-yelInplain btn-sm BTNVerify VERIFYBTNPOSITIONRIGHT ">Verify</button>-->
				   ...
				   <input type="text" id="COAI_EMAILID" maxlength="100"  data-link="COAI_EMAILID|COAI_EMAILVERIFY" name="COAI_EMAILID" class="form-control datalink COAIDBfields IsEmailFields ">
         ...
         <div class="form-row">
                  <div class="col-md-6 VERIFYBTNPOSITION">  
                  <div class="md-form">
				  <input type="text" id="COAI_MOBIIVERIFY"  hidden="hidden" name="COAI_MOBIIVERIFY"  maxlength="60"  class="form-control   COAIDBfields">
                ...
                <div class="form-row">
                               ...
                               <!--  <div class="form-row" style="display:none">
                                 ...
                                 <div class="form-row SEP OEMPONE">
                                    <div class="col">
                                       <div class="md-form">
                                          <select class="md-form colorful-select dropdown-primary SEPM COEIDBfields COEIMndtry EMPI"  id="COEI_NEGATLIST" name="COEI_NEGATLIST">
                                            <option value="">--Select--</option>
                                          </select>
                                    ...
                                    <div class="col">
                                       <div class="md-form">
                                         <select class="md-form colorful-select dropdown-primary SEPM COEIDBfields COEIMndtry EMPI"  id="COEI_CAUTLIST" name="COEI_CAUTLIST">
                                          <option value="">--Select--</option>
                                         </select>
                                 ...
                                 <div class="form-row OEMPONE">
									...
									<div class="col-md-6 SEP OEMPONE">
                                       <div class="md-form">
                                           <select class="md-form colorful-select dropdown-primary SEPM COEIMndtry COEIDBfields EMPI" id="COEI_PAR" name="COEI_PAR">
                                            <option value="">--Select--</option>
                                          </select>
  ...
  <div class="card NINDU ORG">
    ...
    <div id="collapseFour4" class="collapse" role="tabpanel" aria-labelledby="headingFour4"
      ...
      <div class="card-body px-lg-5 pt-0">
		...
		<!--<div class="form-row COUD">
					<div class="col-md-6">
						<div class="md-form">
							<input type="text" id="COOA_UAMNO" maxlength="19"  name="COOA_UAMNO" class="form-control IsUpprCse IsUAMFields Udayamfield COUDHA COOADBfields">
				...
				<div class="col-md-6 ">
                 <div class="md-form">
                       <div class="custom-control custom-radio custom-control-inline ">
                               <input type="checkbox" class="custom-control-input  COOADBfields" onchange="Chkudyam();" id="COOA_CUAMNO" name="COOA_CUAMNO">
							...
							<div class="col-md-8  Formcol-mdLR UAMNupload">
								<div class="md-form">
									...
									<span class="name1">Upload</span>
    		                         ...
    		                         <div class="col-md-2 Formcol-mdLR TxtCenter Udyam">
										<div class="md-form">
										<div class="COOA_UPDUAMNO" style="display:none"> <img src="ThemeproLO/Common/Images/UploadImg.png" onclick="ReuploadFile(COOA_UPDUAMNO);" title="UPLOAD"  class="rounded ReUpld" alt="Cinque Terre" width="20" height="20">  
										<img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW"  class="rounded" onclick="GrdDocDwnld('COOA_UPDUAMNO')" alt="Cinque Terre" width="35" height="25"> </div>
										</div>
    		                         </div>  
						</div>
    		    </div>-->
...
<!-- END -->
 ...
 <script type="text/javascript" src="ThemeproLO/UCV/CustomerDetails/Script/CoApplcnt/LoadSubmit.js${DMY13}"></script>
 <script type="text/javascript" src="ThemeproLO/UCV/CustomerDetails/Script/CoApplcnt/Validation.js${DMY13}"></script> 
