<button type="button" data-Validatearia="Dedupe" data-validatedata="COBI_DEDUPEVERIFY" onclick="PosdxChk('COBI_CUSID','COBI_DEDUPEVERIFY','Co-Applicant','','COBI_CUSFISNAM');"   data-validate="COBI|DEDUPE" class="btn  COBI_DEDUPEVERIFY waves-effect btn-yelInplain btn-sm BTNDedupe liSubpageTabIcons"><i class="fa fa-check"></i>Dedupe Check</button>
         <!--Main row-->
    ...
    <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
      ...
      <div class="card-body px-lg-5 pt-0">
        ...
        <div class="form-row">
            <div class="col">
                  <div class="md-form">
                    <input type="text" id="COAI_ADDRLINI" name="COAI_ADDRLINI"  maxlength="40" class="form-control APADDR RESSTAT  AddrNoSpecialChar COAIDBfields CAOIMndtry">
                    <label for="COAI_ADDRLINI" class="APDR">Address Line 1<span class="MndtryAstr">*</span></label>
                  </div>
                </div>
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="COAI_ADDRLINII"  maxlength="40" name="COAI_ADDRLINII" class="form-control AddrNoSpecialChar APADDR RESSTAT COAIDBfields">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="COAI_LNDMARK"  maxlength="40" name="COAI_LNDMARK" class="form-control APADDR  RESSTAT COAIDBfields COAIMndtry">
        ...
        <div class="form-row">
            <div class="col">
                  <div class="md-form">
                    <input type="text" id="COAI_PREMADDRLINI"  maxlength="40" name="COAI_PREMADDRLINI" class="form-control PRADDR AddrNoSpecialChar COAIDBfields COAIMndtry">
                    <label for="COAI_PREMADDRLINI" class="ADDR">Address Line 1<span class="MndtryAstr">*</span></label>
                  </div>
                </div>
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="COAI_PERMADDRLINII"  maxlength="40" name="COAI_PERMADDRLINII" class="form-control AddrNoSpecialChar PRADDR COAIDBfields">
        ...
        <div class="form-row">
                ...
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="COAI_PERMLNDMARK"  maxlength="40" name="COAI_PERMLNDMARK" class="form-control PRADDR  COAIDBfields COAIMndtry">
        ...
        <div class="form-row">
            ...
            <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="COAI_ORGADDRLINI"  maxlength="40" name="COAI_ORGADDRLINI" class="form-control AddrNoSpecialChar ORGADD COAIDBfields COAIMndtry">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="COAI_ORGADDRLINII"  maxlength="40" name="COAI_ORGADDRLINII" class="form-control ORGADD AddrNoSpecialChar COAIDBfields">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="COAI_ORGLNDMARK" maxlength="40"  name="COAI_ORGLNDMARK" class="form-control ORGADD  COAIDBfields COAIMndtry">
        ...
        <div class="form-row INDU">
            ...
            <div class="form-row">
                 <div class="col d-flex justify-content-center">
                     ...
                     <button type="button" data-aria="LSW_TCOCUSADDRINFO|COAI|COAI_CUSID" data-card="1" class="btn btn-Syel waves-effect waves-light FormSave">Save & Next</button> 
                </div>
            </div>
        </form>
           ...
           <img src="ThemeproLO/Common/Images/Delete_Img.png" style="height:25px;width:25px" data-tab="COEI_PRCSID|COEI_EMPID|COAPPEMPDETAILS" class="DELBTN  DELETECOAPPEMP"/>
                ...
                <div class="form-row">
                                 ...
                                 <div class="form-row">
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="COEI_ADDRLINEI" maxlength="40" name="COEI_ADDRLINEI" class="form-control OFFADDR AddrNoSpecialChar COEIDBfields COEIMndtry PROCHGS">
                                          <label for="COEI_ADDRLINEI" class="OADDR PROCHGAC">Address Line 1<span class="MndtryAstr">*</span></label>
                                       </div>
                                    </div>
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="COEI_ADDRLINEII" maxlength="40" name="COEI_ADDRLINEII" class="form-control OFFADDR AddrNoSpecialChar COEIDBfields PROCHGS">
                                 ...
                                 <div class="form-row">
                                    ...
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="COEI_LNDMARK" maxlength="40" name="COEI_LNDMARK" class="form-control  OFFADDR COEIDBfields COEIMndtry PROCHGS">
                                 ...
                                 <div class="form-row">
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="COEI_DATOFESTABLIS" maxlength="10" onblur="CompareJointoDOB(this,COBI_DOB,COEI_NOOFYERBUSINESS,'COBI_PROFILE');ExpYearvalid(this,COEI_NOOFYERBUSINESS);" name="COEI_DATOFESTABLIS" class="form-control NoSpecialChar ISFutureDateFields JOINDATE COEIDBfields IsNumberFields  ISDatefield PROCHGS">
                                 ...
                                 <div class="form-row SEP OEMPONE">
                                    <div class="col">
                                       <div class="md-form">
                                          <select class="md-form colorful-select dropdown-primary SEPM COEIDBfields EMPI" disabled id="COEI_NEGATLIST" name="COEI_NEGATLIST">
                                            <option value="">--Select--</option>
                                          </select>
                                    ...
                                    <div class="col">
                                       <div class="md-form">
                                         <select class="md-form colorful-select dropdown-primary SEPM COEIDBfields EMPI" disabled id="COEI_CAUTLIST" name="COEI_CAUTLIST">
                                          <option value="">--Select--</option>
                                         </select>
