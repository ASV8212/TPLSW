...
<img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW"  class="rounded" onclick="GrdDocDwnld('CBSI_UPDUAMNO')" alt="Cinque Terre" width="35" height="25"> </div>
           ...
           <div class="form-row INDU">
            ...
            <div class="form-row">
                ...
                <div class="PROFILE col-md-6 ">
                  	<div class="md-form">
                     <select class="mdb-select md-form colorful-select dropdown-primary NINDM PROFILEVAL CBSIDBfields CBSIMndtry" onchange="DataToProfFld(this);CheckProfile('Change');" data-change="CBSI_PROFILE" id="CBSI_NPROFILE" name="CBSI_NPROFILE">
                  	 <option value="">Select</option>
        ...
        <div class="form-row">
            <div class="col">   
               <div class="md-form">
                   ...
                   <input type="text" id="CADI_EMAILID" maxlength="60"  data-link="CADI_EMAILID|CADI_EMAILVERIFY" name="CADI_EMAILID" class="form-control datalink CADIDBfields IsEmailFields CADIMndtry">
  ...
  <div class="INDU">
        ...
        <div class="form-row">
            <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_ADDRLINI" maxlength="40" name="CADI_ADDRLINI" class="form-control RSADDR AddrNoSpecialChar RESSTAT CADIDBfields CADIMndtry">
                    <label for="CADI_ADDRLINI" class="">Address Line 1<span class="MndtryAstr">*</span></label>
                  </div>
                </div>
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_ADDRLINII" maxlength="40" name="CADI_ADDRLINII" class="form-control AddrNoSpecialChar RESSTAT RSADDR CADIDBfields">
        ...
        <div class="form-row">
            ...
            <div class="col">
                ...
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_CITY" disabled name="CADI_CITY" class="form-control ALLDIS RESSTAT RSADDR CADIDBfields CADIMndtry">
        ...
        <div class="form-row">
            ...
            <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="CADI_STATE" disabled name="CADI_STATE" class="form-control ALLDIS RESSTAT RSADDR CADIDBfields CADIMndtry">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="CADI_LNDMARK" maxlength="40" name="CADI_LNDMARK" class="form-control RESSTAT  RSADDR CADIDBfields CADIMndtry">
...
<div class="col-md-5">
        ...
        <div class="form-row">
            <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_PREMADDRLINI" maxlength="40" name="CADI_PREMADDRLINI" class="form-control AddrNoSpecialChar PRADDR CADIDBfields CADIMndtry">
                    <label for="CADI_PREMADDRLINI" class="ADDR">Address Line 1<span class="MndtryAstr">*</span></label>
                  </div>
                </div>
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_PERMADDRLINII" maxlength="40" name="CADI_PERMADDRLINII" class="form-control AddrNoSpecialChar PRADDR CADIDBfields">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_PERMCITY" disabled name="CADI_PERMCITY" class="form-control ALLDIS PRADDR CADIDBfields IsAlphaFields CADIMndtry">
        ...
        <div class="form-row">
            <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_PERMSTATE" disabled name="CADI_PERMSTATE" class="form-control ALLDIS PRADDR CADIDBfields IsAlphaFields CADIMndtry">
                    <label for="CADI_PERMSTATE" class="ADDR PERP">State<span class="MndtryAstr">*</span></label>
                  </div>
                </div>
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_PERMLNDMARK" maxlength="40" name="CADI_PERMLNDMARK" class="form-control  PRADDR CADIDBfields CADIMndtry">
     ...
     <div class="NINDU">  
        ...
        <div class="form-row">
              <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="CADI_ORGADDRLINI" maxlength="40"  name="CADI_ORGADDRLINI" class="form-control  ORGADD AddrNoSpecialChar CADIDBfields CADIMndtry">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="CADI_ORGADDRLINII" maxlength="40"  name="CADI_ORGADDRLINII" class="form-control ORGADD AddrNoSpecialChar CADIDBfields">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_ORGLNDMARK" maxlength="40" name="CADI_ORGLNDMARK" class="form-control  ORGADD CADIDBfields CADIMndtry">
                              ...
                              <form>
					        	...
					        	<div class="col Btxt10">ORGANISATION DETAILS</div>
                                 ...
                                 <div class="form-row">
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_ADDRLINEI" maxlength="40" name="CEMI_ADDRLINEI" class="form-control CEMIDBfields OFFADDR CEMIMndtry AddrNoSpecialChar CEMIMndtry">
                                          <label for="CEMI_ADDRLINEI" class="OADDR">Address Line 1<span class="MndtryAstr">*</span></label>
                                       </div>
                                    </div>
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_ADDRLINEII" maxlength="40" name="CEMI_ADDRLINEII" class="form-control CEMIDBfields OFFADDR AddrNoSpecialChar">
                                 ...
                                 <div class="form-row">
                                    ...
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_LNDMARK" maxlength="40" name="CEMI_LNDMARK" class="form-control OFFADDR  CEMIDBfields CEMIMndtry">
                                 ...
                                 <div class="form-row SEP OEMPONE">
                                    <div class="col-md-6">
                                       <div class="md-form">
                                           <select class="md-form colorful-select dropdown-primary SEPM CEMIDBfields EMPI" disabled id="CEMI_NEGATLIST" name="CEMI_NEGATLIST">
                                            <option value="">--Select--</option>
                                          </select>
                                    ...
                                    <div class="col-md-6">
                                       <div class="md-form">
                                         <select class="md-form colorful-select dropdown-primary SEPM CEMIDBfields EMPI"disabled id="CEMI_CAUTLIST" name="CEMI_CAUTLIST">
                                         <option value="">--Select--</option>
                                          </select>
                                 ...
                                 <div class="form-row OEMPONE">
                                    ...
                                    <div class="col-md-6">
                                       <div class="md-form">
                                          <select class="md-form colorful-select dropdown-primary CEMIDBfields OEMPM " id="CEMI_KYCCATEGORY" name="CEMI_KYCCATEGORY">
                                             <option value="">Select</option>
