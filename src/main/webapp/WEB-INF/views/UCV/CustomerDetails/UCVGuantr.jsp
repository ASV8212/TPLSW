...
<!--	   <div class="form-row GUNON">
		   ...
		   <div class="form-row GSTF" style="display:none">
                   ...
                   <div class="md-form">
                     ...
                     <input type="text" id="GRBI_GSTNUM" maxlength="15" disabled name="GRBI_GSTNUM" class="form-control IsGstValid NoSpecialChar GST GRBIDBfields">
                    ...
                    <div data-row="" class="card-body px-lg-5 pt-0 DYNROW">
                           ...
                           <div class="form-row CHKBOX">
							  ...
							  <div class="md-form ">
												...
												<div class="md-form ">
													<div class="custom-control custom-radio custom-control-inline">
														<input type="checkbox" class="custom-control-input GGSTDBfields" id="GGST_GSTCHK" onclick="ChkGstPrimary('GGST_GSTNUM'+$(this).closest('.DYNROW').attr('data-row'),'GGST_GSTCHK'+$(this).closest('.DYNROW').attr('data-row'))" name="GGST_GSTCHK">
           ...
           <div class="form-row INDU">
            <div class="col">
                  <div class="md-form">
                    <input type="text" id="GRBI_FATHRNAM"   name="GRBI_FATHRNAM" class="form-control GRBIDBfields IsUpprCse GRBIMndtry IsAlphaFields">
    ...
    <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
      ...
      <div class="card-body px-lg-5 pt-0">
        ...
        <div class="form-row">
             <div class="col-md-6 VERIFYBTNPOSITION">  
                  <div class="md-form">
                   ...
                   <input type="text" id="GRAI_EMAILID" maxlength="100"  data-link="GRAI_EMAILID|GRAI_EMAILVERIFY" name="GRAI_EMAILID" class="form-control datalink GRAIDBfields IsEmailFields ">
          ...
          <div class="form-row">
				  ...
				  <input type="text" id="GRAI_MOBIIVERIFY" hidden="hidden" name="GRAI_MOBIIVERIFY" class="form-control GRAIDBfields">
                   <!-- <input type="text" id="GRAI_MOBNOII" maxlength="10" onchange="CheckDupMobNo('GRAI_MOBNOII','GRAI_MOBNOI','Mobile Number');" name="GRAI_MOBNOII" class="form-control GRAIDBfields NoSpecialChar IsNumberFields IsMobileFields">-->
                    ...
                    <input type="text" id="GRAI_MOBNOII" data-link="GRAI_MOBNOII|COAI_MOBIIVERIFY" maxlength="10" onchange="CheckDupMobNo('GRAI_MOBNOII','GRAI_MOBNOI','Mobile Number');DupMOBval('GRAI_PRCSID','GRAI_MOBNOII','GRAI_CUSID');" name="GRAI_MOBNOII" class="form-control  GRAIDBfields datalink NoSpecialChar IsNumberFields IsMobileFields">
       ...
       <div class="INDU">  
		...
		<div class="col-md-5">
                  <div class="md-form">
				<input type="text" id="GRAI_RESISTABI" maxlength="5"  name="GRAI_RESISTABI" class="form-control GRAIDBfields NoSpecialChar IsNumberFields">
                    <label for="GRAI_RESISTABI" class="">Residence Stability in Current City(In Months)<span class="MndtryAstr"></span></label>
                  </div>
                </div>
		</div>
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <div class="col">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_ORGADDRLINII" maxlength="60"  name="GRAI_ORGADDRLINII" class="form-control AddrNoSpecialChar ORGADD GRAIDBfields GRAIMndtry">
		...
		<!--<div class="form-row GUNON">
				...
				<div class="col-md-6 " >
                    <div class="md-form">
                       ...
                       <button type="button" data-Validatearia="GUOA_UDYAMVERI" onclick="CheckKYCDetl(this,'GUOA_GUAMNO','GUOA_UDYAMVERI','UDYAM');" data-field="GUOA_UDYAMVERI|GUOA_UPDUAMNO|GRBI_CUSTYPE|GRBI_CUSID|" data-validate="gstin"  class="btn btn-Verify GUOA_UDYAMVERI waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>
