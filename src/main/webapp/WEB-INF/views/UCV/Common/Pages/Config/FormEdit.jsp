...
<script src="ThemeproLO/Common/scripts/Config/FormEdit/onload.js${DMY13}" type="text/javascript"></script>
<script src="ThemeproLO/Common/scripts/Config/FormEdit/Validation.js${DMY13}" type="text/javascript"></script>
...
<form id="FormEdit" style="background-color:white; height:580px" name="Form Edit"  action=""  method="POST">
    ...
    <input type="button" id ="GetFormEditData" name="GetFormEditData" style="display:none" onclick="FncallModPageGrid(this,'Table2',{spname:'Sam_sGetFormEditList',Param:$('#WFIDHist').val(),brid:'',MnuId:''},{});" /> <!--0:$('#LAPP_BrID'),1:$('#LAPP_BrName')-->
...
<input class="queueflddata" face="calibri" id="BrNameHist" disabled name="BrNameHist" value=""/>          
	<input class="queueflddata" face="calibri" id="BrIDHist" disabled name="BrIDHist" type="hidden" value=""/>  	

 <img src="ThemeproLO/Common/Images/search1.png" id="Brnmlkup" class="find1" onclick="Fncallwebservice(this,'GetJsonBRID',{spname:'SAM_sBRMASTER',Param:'',brid:'',MnuId:'RHFL'},{0:$('#BrIDHist'),1:$('#BrNameHist')})">
