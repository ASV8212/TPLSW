...
<script type="text/javascript" src="ThemeproLO/Common/scripts/DateControl/jquery.placeholder.min.js${DMY13}"></script> 
   ...
   <script type="text/javascript" src="ThemeproLO/Common/scripts/Attachment/AddAttach.js${DMY13}"></script>  
    <script type="text/javascript" src="ThemeproLO/Common/scripts/Attachment/AddAttachValidation.js${DMY13}"></script>  
...
<form id="AdditionalAttach" name="Additional Attach"  class="" action=""  method="POST">
 <table class="xdTable" cellspacing="2" cellpadding="2" width="100%" border="0">
    	 <tbody>
    	 <tr>
  <td class="ColumnHeading"><font face="Verdana" size="2">Workflow Name</font></td>
                    <td><input class="DBfields  Mndtry  inputTXT" disabled onchange="this.setAttribute('value', this.value);" onkeyup="this.setAttribute('value', this.value);" onblur="fnOnFocusOut(this)" onfocus="fnOnFocus(this)" maxlength="100" id="WrkflwName" name="WrkflwName" value="" />&nbsp;<img src="ThemeproLO/Common/Images/search1.png" class="find1" onclick="FncallwebserviceLrgData(this,'GetJsonBRID',{spname:'Sam_sAddtnlAttch',Param:'',brid:'packageid',MnuId:''},{0:$('#WrkflwName')});$('#FormId').val('');$('#CusIdPropNo').val('');" /><span id="span_imgdateapp" style="COLOR: red">*</span>&nbsp;</td>
  <td class="ColumnHeading"><font face="Verdana" size="2">Form Name</font></td>
                    <td><input class="DBfields Mndtry inputTXT" disabled onchange="this.setAttribute('value', this.value);" onkeyup="this.setAttribute('value', this.value);" onblur="fnOnFocusOut(this)" onfocus="fnOnFocus(this)" maxlength="100" id="FormId" name="FormId" value="" />&nbsp;<img src="ThemeproLO/Common/Images/search1.png" class="find1" onclick="FncallwebserviceLrgData(this,'GetJsonBRID',{spname:'Sam_sAddtnlAttch',Param:$('#WrkflwName').val(),brid:'formid',MnuId:''},{0:$('#FormId')});$('#CusIdPropNo').val('');" /><span id="span_imgdateapp" style="COLOR: red">*</span>&nbsp;</td>
  </tr>
  <tr>
  <td class="ColumnHeading"><font face="Verdana" size="2">Id</font></td>
  <td><input class="DBfields Mndtry inputTXT" disabled onchange="this.setAttribute('value', this.value);" onkeyup="this.setAttribute('value', this.value);" onblur="fnOnFocusOut(this)" onfocus="fnOnFocus(this)" maxlength="100" id="CusIdPropNo" name="CusIdPropNo" value="" />&nbsp;<img src="ThemeproLO/Common/Images/search1.png" class="find1" onclick="FncallwebserviceLrgData(this,'GetJsonBRID',{spname:'Sam_sAddtnlAttch',Param:$('#WrkflwName').val(),brid:$('#FormId').val(),MnuId:GetCurrentUser()},{1:$('#CusIdPropNo'),3:$('#PropPrcsID')});" /><span id="span_imgdateapp" style="COLOR: red">*</span>&nbsp;</td>
 </tr>
 </tbody>
 </table>
<input class="DBfields inputTXT" type="hidden" onchange="this.setAttribute('value', this.value);" onkeyup="this.setAttribute('value', this.value);" onblur="fnOnFocusOut(this)" onfocus="fnOnFocus(this)" maxlength="100" id="BrchID" name="BrchID" value="" />
<input class="DBfields inputTXT" type="hidden" onchange="this.setAttribute('value', this.value);" onkeyup="this.setAttribute('value', this.value);" onblur="fnOnFocusOut(this)" onfocus="fnOnFocus(this)" maxlength="100" id="PropPrcsID" name="PropPrcsID" value="" />  
...
<input id="mainhdnfieldval" name="mainhdnfieldval" type="hidden" value=""/>
  ...
  <!--  <form id="uploadform"  action="UploadServlet" method="post" enctype="multipart/form-data" class=" form-container form-signin">-->
             ...
             <div class="form-section-title" style="margin-top: 2px;"><span class="formsplit" style="width:48%; float:left; text-align:center">Document Attachment</span><span style="width:43%; float:right; text-align:center">Attachment List</span></div> 
		...
		<div align="center; height:auto;">
			...
			<thead>
			 				<tr>
			 					...
			 					<th style="height:30px; text-align:center">Add more files &nbsp;&nbsp;<img id="addupload" name="addupload" style="width:10%" src="ThemeproLO/Common/Images/add-new.png" onclick="AddtnlTr('0');" alt="Smiley face"> </th>
			               </tr>
			 			</thead> 
			 			<tbody>	 		
        					<tr class="">						
					 			<td style="height:30px; width:40px;"></td>
								<td><select class= "inputTXT" style="width:130px"; onchange="DrpdwnChngeChk(this);getAttachChk(this);" id="type" name="type" >
								<option value="Additional1">Additional-I</option>
								</select></td>											
								<td><textarea onkeyup="this.setAttribute('value', this.value);"  value="" style="width:130px;height:50px"  class="inputTXT" id="comments" name="comments"  maxlength="100" ></textarea></td>
      ...
      <div align="center"> 
 		<table class="" style="width: 67%">
 			<tr>
				<td style="width:10%"><input type="button" class="uploadfile" value="Upload" name="upload" id="upload"></td>
				<td style="width:10%"><input type="button" class="viewattach" value="View" name="View" id="View" onclick="viewfile()"></td>
				<td style="width:10%"><input type="button" class="deleteattach" value="Delete" name="Delete" id="Delete" onclick="viewrowdelete()"></td>
				<td style="width:10%"><input type="button" class="downloadattach" value="Download" name="Download" id="Download" onclick="downloadfile()"></td>
				<td style="width:10%"><input type="button" class="detailattach" value="Details" name="Details" id="Details" onclick="viewfldtls()"></td>
