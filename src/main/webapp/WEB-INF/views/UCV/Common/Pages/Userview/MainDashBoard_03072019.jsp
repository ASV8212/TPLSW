...
<div style="display:none" id="MenuTimeLine">
...
<div class="info-box bg-white">
 ...
 <div id="popup" class="SearchList">
   ...
   <form id="DealerDashboardAgent" name="DealerDashboardAgent" class="form-container "  action=""  method="POST">
...
<div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Sanction Limit</span>
              <span class="info-box-number"><small>&#8377;</small>12,00,00,000<small></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Operative Limit</span>
              <span class="info-box-number"><small>&#8377;</small>10,00,00,000<small></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Utilised Limit</span>
             <span class="info-box-number"><small>&#8377;</small>4,00,00,000<small></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Available Limit</span>
             <span class="info-box-number"><small>&#8377;</small>6,00,00,000</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
<div class="box box-warning">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  <tr>
                    <td><small>&#8377;</small>4,00,00,000</td>
					<td><small>&#8377;</small>2,00,00,000</td>
                    <td><span class="description-percentage text-red"><i class="fa fa-caret-down"></i> 67%</span>
					<span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 33%</span></td>    
                  </tr>
            ...
            <div class="box-footer clearfix">
              <!--<a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">Place New Order</a>-->
              <a href="javascript:void(0)" onclick="FncallwebserviceDashB(this, 'GetJsonBRID', { spname: 'SCF_sGetAllPayments', Param:'dealer1', brid: 'Payments', MnuId: '' }, {  0: $('#EditPrgmID'),2: $('#OldPrcsID'), 3: $('#OldAccID')});" class="btn btn-sm btn-info btn-flat pull-right">View All Payments</a>
            </div>
            <!-- /.box-footer -->
          </div>	  
	  </div>
...
<div class="box box-danger">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  <tr>
                    <td><small>&#8377;</small>0 <span class="description-percentage text-yellow"><i class="fa fa-caret-left"></i></span></td>
					  <td><small>&#8377;</small>60,00,000 <span class="description-percentage text-red"><i class="fa fa-caret-down"></i></span></td>
                  </tr>
            ...
            <div class="box-footer clearfix">
              <!--<a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">Place New Order</a>-->
              <a href="javascript:void(0)" onclick="FncallwebserviceDashB(this, 'GetJsonBRID', { spname: 'SCF_sGetDueDetails', Param:'dealer1', brid: 'DueDetails', MnuId: '' }, {  0: $('#EditPrgmID'),2: $('#OldPrcsID'), 3: $('#OldAccID')});" class="btn btn-sm btn-info btn-flat pull-right">View Due Details</a>
            </div>
            <!-- /.box-footer -->
          </div>	  
	  </div>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  <tr>
                     <td><small>&#8377;</small>6,00,00,000</td>
                     <td><small>&#8377;</small>2,00,00,000</td>
					  <td><small>&#8377;</small>4,00,00,000
					  <span class="description-percentage text-red"><i class="fa fa-caret-down"></i> 67%</span>
					<span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 33%</span></td>
			...
			<!--<th>Popularity</th>-->
                  ...
                  <tr>
                    ...
                    <td>09-04-2020</td>
                      ...
                      <tr>
				    <td><a class="LoadPrgm" href="#">PRG000033</a></td>
                    <td>CTR</td>
                    <td>15-07-2021</td>				                   
                 </tr>
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    ...
                    <li>
                      ...
                      <a class="users-list-name" href="#">CTR</a>
                      <span class="users-list-date">Anchor</span>
                    </li>
                          <li>
...
<div class="info-box bg-green">
            ...
            <div class="info-box-content">
             ...
             <span class="info-box-Text">Total PO Created: 50</span>
...
<div class="info-box bg-yellow" >
            ...
            <div class="info-box-content">
              <span class="info-box-number">Accept Invoice</span>
			
			<div class="progress">
                <div class="progress-bar" style="width: 30%"></div>
              </div>
              <span class="progress-description">
                    70% Pending Invoice to be Accepted
                  </span>
...
<div class="info-box bg-red">
            ...
            <div class="info-box-content">
              <span class="info-box-number">Repayment</span>
              
              <div class="progress">
                <div class="progress-bar" style="width: 40%"></div>
              </div>
              <span class="progress-description">
                    60% Finance To be Repaid
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div></a>		  
...
<div class="info-box bg-white">
 ...
 <div id="popup" class="SearchList">
       ...
       <form id="BuyerDashboardAgent" name="BuyerDashboardAgent" class="form-container "  action=""  method="POST">
...
<div class="row">
 ...
 <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Sanction Limit</span>
              <span class="info-box-number"><small>&#8377;</small>20,00,00,000<small></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Utilised Limit</span>
             <span class="info-box-number"><small>&#8377;</small>5,00,00,000<small></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Available Limit</span>
             <span class="info-box-number"><small>&#8377;</small>10,00,00,000</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
<div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Counter Party Limit</h3>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  <tr>
				   <td><a class="LoadLimit" href="#">C19000251</a></td>
                    <td>MRF</td>
					<td>Tata Motors</td>
                    <td><small>&#8377;</small>15,00,00,000</td>
					<td><small>&#8377;</small>14,00,00,000</td> 
					<td><small>&#8377;</small>9,00,00,000</td>
					<td><small>&#8377;</small>5,00,00,000</td> 					
                  </tr>
				   <tr>
				   <td><a class="LoadLimit" href="#">C19000060</a></td>
                    <td>DLR</td>
					<td>Tata Motors S</td>
                    <td><small>&#8377;</small>12,00,00,000</td>
					<td><small>&#8377;</small>10,00,00,000</td> 
					<td><small>&#8377;</small>4,00,00,000</td>
					<td><small>&#8377;</small>6,00,00,000</td> 					
                  </tr>
...
<div class="box box-warning">
              ...
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tr>
                    <td><small>&#8377;</small>5,00,00,000</td>
					<td><small>&#8377;</small>5,00,00,000</td>
                    <td><span class="description-percentage text-red"><i class="fa fa-caret-down"></i> 50%</span>
					<span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 50%</span></td>    
                  </tr>
            ...
            <div class="box-footer clearfix">
              <!--<a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">Place New Order</a>-->
              <a href="javascript:void(0)" onclick="FncallwebserviceDashB(this, 'GetJsonBRID', { spname: 'SCF_sGetAllPayments', Param:'buyer1', brid: 'Payments', MnuId: '' }, {  0: $('#EditPrgmID'),2: $('#OldPrcsID'), 3: $('#OldAccID')});" class="btn btn-sm btn-info btn-flat pull-right">View All Payments</a>
            </div>
            <!-- /.box-footer -->
          </div>	  
	  </div>
...
<div class="box box-danger">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  <tr>
                    <td><small>&#8377;</small>5,00,00,000 <span class="description-percentage text-red"><i class="fa fa-caret-down"></i></span></td>
					  <td><small>&#8377;</small>81,00,000 <span class="description-percentage text-green"><i class="fa fa-caret-up"></i></span></td>
                  </tr>
            ...
            <div class="box-footer clearfix">
              <!--<a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">Place New Order</a>-->
              <a href="javascript:void(0)" onclick="FncallwebserviceDashB(this, 'GetJsonBRID', { spname: 'SCF_sGetDueDetails', Param:'buyer1', brid: 'DueDetails', MnuId: '' }, {  0: $('#EditPrgmID'),2: $('#OldPrcsID'), 3: $('#OldAccID')});" class="btn btn-sm btn-info btn-flat pull-right">View Due Details</a>
            </div>
            <!-- /.box-footer -->
          </div>	  
	  </div>
              ...
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tr>
                     <td><small>&#8377;</small>10,00,00,000</td>
                     <td><small>&#8377;</small>5,00,00,000</td>
					  <td><small>&#8377;</small>5,00,00,000
					  <span class="description-percentage text-red"><i class="fa fa-caret-down"></i> 50%</span>
					<span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 50%</span></td>
			...
			<!--<th>Popularity</th>-->
                  ...
                  <tr>
                    ...
                    <td>09-04-2020</td>
                      ...
                      <tr>
				    <td><a class="LoadPrgm" href="#">PRG000113</a></td>
                    <td>Tata Motors S</td>
                    <td>25-07-2021</td>			                   
                 </tr>
...
<div class="box">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>                     
                      <a class="users-list-name" href="#">MRF</a>
                      <span class="users-list-date">Counter Party</span>
                    </li>
                    <li>
                    
                      <a class="users-list-name" href="#">DLR</a>
                      <span class="users-list-date">Counter Party</span>
                    </li>
...
<div class="info-box bg-yellow" >
            ...
            <div class="info-box-content">
              <span class="info-box-number">Create Invoice</span>
			  <span class="info-box-Text">Total Invoice Created: 200</span>
...
<div class="info-box bg-green">
            ...
            <div class="info-box-content">
              <span class="info-box-number">Create PO</span>
             <span class="info-box-Text">Total PO Created: 110</span>
...
<script type="text/javascript" src="ThemeproLO/Common/scripts/Grid/prettify.js${DMY13}"></script> 
	...
	<!--  <script type="text/javascript" src="ThemeproLO/Common/scripts/Grid/loadjson_V_19.js${DMY13}"></script> -->
	    ...
	    <script src="ThemeproLO/Common/scripts/Main/MainDashBoard/Onload_Audit.js${DMY13}" type="text/javascript"></script>
