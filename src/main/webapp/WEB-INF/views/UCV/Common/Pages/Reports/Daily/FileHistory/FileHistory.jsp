...
<script src="ThemeproLO/Common/scripts/Reports/Daily/FileHistory/onload.js${DMY13}" type="text/javascript"></script>
<script src="ThemeproLO/Common/scripts/Reports/Daily/FileHistory/Validation.js${DMY13}" type="text/javascript"></script>
...
<form id="FileHistory" style="background-color:white; height:580px" name="File History"  action=""  method="POST">
    ...
    <input type="button" id ="GetFileHistData" name="GetFileHistData" style="display:none" onclick="FncallModPageGridLrgData_HistView(this,'Table2',{spname:'Sam_sGetHistQD',Param:$('#PrcsID').val(),brid:'',MnuId:'Hist'},{0:$('#LAPP_BrID'),1:$('#LAPP_BrName')});" />
