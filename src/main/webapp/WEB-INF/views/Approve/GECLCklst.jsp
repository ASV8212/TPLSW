...
<script type="text/javascript" src="ThemeproLO/Approve/Script/GECLCklst/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/Approve/Script/GECLCklst/Validation.js${DMY13}"></script>                            
