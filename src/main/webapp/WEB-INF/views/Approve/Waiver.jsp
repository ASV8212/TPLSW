...
<script type="text/javascript" src="ThemeproLO/Approve/Script/Waiver/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/Approve/Script/Waiver/Validation.js${DMY13}"></script>                            
