...
<script type="text/javascript" src="ThemeproLO/Approve/Script/PdDt/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/Approve/Script/PdDt/Validation.js${DMY13}"></script>                            
<script>
