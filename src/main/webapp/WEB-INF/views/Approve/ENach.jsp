      ...
      <div class="card CardNS">
	   ...
	   <div class="form-row">
           <div class="col-md-4">
			...
			<div class="col-md-4">
               <div class="md-form">
	                <input type="text" id="AEND_LOANSANC" disabled name="AEND_LOANSANC" class="form-control IsCURCommaFields  AENDDBfields"> 
					<label for="AEND_LOANSANC"  class="Btxt9 ">Loan Amount Sanction</label>
	           </div>
			</div>
			<div class="col-md-4">
               <div class="md-form">
					...
					<div class="row  " >
                     ...
                     <div class="form-row">
                           <div class="col d-flex justify-content-center">
                              ...
                              <button type="button" data-aria="LSW_TENACHDTL|AEND|AEND_LOANID" data-card="2" class="btn btn-Syel waves-effect waves-light FormSave">Save & Next</button> 
                          </div>
                    </div>
               </form>
         </div>
