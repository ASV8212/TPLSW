...
<script type="text/javascript" src="ThemeproLO/Commonpage/Doctemplates/LoadSubmit/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/Commonpage/Doctemplates/Validation/Validation.js${DMY13}"></script> 
