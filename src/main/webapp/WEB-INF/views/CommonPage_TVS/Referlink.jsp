  ...
  <!--  card -->
   ...
   <div class="card cardNS">
     ...
     <div data-for="RFERLINK" class="RFERLINK"> 
       ...
       <div class="DynamicPageGrid" data-val="PROPTXTHDR|" id="RFERLINK" >
       ...
       <div class="form-row">
               <div class=" col-md-6">
                 <div class="md-form">
                   <input type="text" id=ENGNAME maxlength="25" name="ENGNAME" class="form-control  OWNADBfields  RELINK">
               ...
               <div class=" col-md-6">
                 <div class="md-form">
                   <input type="text" id="URL" maxlength="25" name="URL" class="form-control  OWNADBfields  RELINK">
