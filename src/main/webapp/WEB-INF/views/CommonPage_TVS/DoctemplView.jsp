...
<script type="text/javascript" src="ThemeproLO/Commonpage/DoctemplView/LoadSubmit/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/Commonpage/DoctemplView/Validation/Validation.js${DMY13}"></script> 
