            ...
            <div class="card active">
               ...
               <div id="collapse1" class="collapse show" role="tabpanel" aria-labelledby="heading1" data-parent="#accordionEx">
                  ...
                  <div class="DynamicPageGrid" data-val="PROPTXTHDR|Account" id="BankDetail1" style="display:none">
                              ...
                              <div class="md-form">
                                 <div class="select-radio BKDTMndtry">
                                    <div class="custom-control custom-radio custom-control-inline">
                                       <input type="radio" class="custom-control-input PrimAcct BKDTDBfields" onclick="CheckPrimAcct($(this).closest('.DYNROW')[0],this.id);" value="Yes" id="PriYes" name="BKDT_PRIMARYACCT">
                                       <label class="custom-control-label" for="PriYes">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                       <input type="radio" class="custom-control-input PrimAcct BKDTDBfields" onclick="CheckPrimAcct($(this).closest('.DYNROW')[0],this.id);" value="No" id="PriNo" name="BKDT_PRIMARYACCT">
             		...
             		<div class="col">
            	<div class="md-form">
                  	<button type="button" id="GETOCR" onclick="GetFullOCRDetls('BKDT_COLLATTACHMENT','CHEQUE','BKDT_BNKNAME,BKDT_IFSC,BKDT_BNKBRCH,BKDT_CITY,BKDT_STATE,BKDT_ACCTNO',this);" class="btn btn-yel Btxt2 BTNHIDE">Get Cheque Details</button>
             </div>
            </div>
            <div class="col">
            </div>
                   ...
                   <div class="form-row">
                           <div class="col">
                              <div class="md-form">
                                 <select class="md-form colorful-select dropdown-primary BKDTMndtry BKDTDBfields" id="BKDT_ACCTTYPE" name="BKDT_ACCTTYPE">
                                    ...
                                    <option  class="MODE" disabled  value="Over Draft Account">Over Draft Account</option>
                                    <option  class="MODE" disabled value="Cash Credit">Cash Credit</option>
                                    <option class="MODE"  disabled value="Others">Others</option>
                                 </select>
                           ...
                           <div class="col">
                              <div class="md-form">
                                 <input type="text" id="BKDT_ACCTHOLDRNAME" maxlength="25" name="BKDT_ACCTHOLDRNAME" class="form-control BKDTMndtry BKDTDBfields">
                        ...
                        <div class="form-row">
                           <div class="col">
                              <div class="md-form">
                                 <input type="text" id="BKDT_IFSC"  maxlength="11"  name="BKDT_IFSC" onblur="Ifscdetls(this,'BKDT_BNKNAME','BKDT_BNKBRCH','BKDT_CITY','BKDT_STATE')" class="form-control IsIFSCFields OCRDSBL NoSpecialChar BKDTMndtry BKDTDBfields">
                                 <label for="BKDT_IFSC" class="">IFSC <span class="MndtryAstr">*</span></label>
                              </div>
                           </div>
                           <div class="col">
                              <div class="md-form">
                                 <input type="text" maxlength="20" id="BKDT_ACCTNO" name="BKDT_ACCTNO"  onblur="ACCNOValida('BKDT_ACCTNO'+$(this).closest('.DYNROW').attr('data-row'))"   class="form-control OCRDSBL NoSpecialChar ACCNO IsNumberFields BKDTMndtry BKDTDBfields">
                        ...
                        <div class="form-row">
                           <div class="col d-flex justify-content-center">
                              <button type="button" id="Save" data-aria="LSW_TLONBANKDTLS|BKDT|BKDT_BNKNO"  class="btn btn-Syeloutline waves-effect waves-lig Save FormSave">Save</button>   
