          ...
          <input type="text" id="PFDT_PFCOLLECT" hidden="hidden" name="PFDT_PFCOLLECT" class="form-control PFDTDBfields">
           ...
           <div class="form-row">
				...
				<label class="mdb-main-label BTxt9">Online Mode <span class="MndtryAstr">*</span></label>
           		 ...
           		 <div class="col">
                     <div class="md-form">
                         <button type="button" id="Collected" onclick="ChkPayAmt();CollectionINTR('PFDT_ONLINEMOD','PFDT_AMOUNT')" class="btn btn-yel BTNHIDE Btxt2">Click To Pay</button>
                     </div>
           		</div>
...
<div class="modal fade" id="MobIModal" tabindex="-1" role="dialog" aria-labelledby="MobIModalLabel"
 ...
 <i class="fa fa-plus"></i></a>
  ...
  <div class="modal-dialog" style="max-width:1200px" role="document">
   ...
   <script type="text/javascript" src="ThemeproLO/PFBank/Script/PFDtls/LoadSubmit.js${DMY13}"></script>
   <script type="text/javascript" src="ThemeproLO/PFBank/Script/PFDtls/Validation.js${DMY13}"></script>                            
