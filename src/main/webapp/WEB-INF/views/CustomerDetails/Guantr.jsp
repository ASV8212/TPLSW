<button type="button" data-Validatearia="Dedupe" data-Validatedata="GRBI_DEDUPEVERIFY" onclick="PosdxChk('GRBI_CUSID','GRBI_DEDUPEVERIFY','Guarantor','','GRBI_CUSFISNAM');"  data-validate="CGBI|DEDUPE" class="btn  waves-effect btn-yelInplain btn-sm BTNDedupe liSubpageTabIcons"><i class="fa fa-check"></i>Dedupe Check</button>
...
<img src="ThemeproLO/Common/Images/Eyeview.png" title="VIEW"  class="rounded" onclick="GrdDocDwnld('GRBI_UPDUAMNO')" alt="Cinque Terre" width="35" height="25"> </div>
		   ...
		   <div class="form-row GSTF" style="display:none">
              <div class="col-md-6 " >
                   <div class="md-form">
                     ...
                     <button type="button" data-Validatearia="GRBI_GSTVERIFY" onclick="CheckValidPanKyc('GRBI_GSTNUM','GRBI_GSTVERIFY','GRBI_CUSFISNAM','GRBI_CUSTYPE','gstdetailed','GRBI_CUSID','GRAI_ADDRLINI','GRAI_ADDRLINII','','','','GREI_ADDRLINEI','GREI_ADDRLINEI','GRBI_NATURBUS');" data-validate="gstin"  class="btn btn-Verify GRBI_GSTNUM waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>
           ...
           <div class="form-row">
               <div class="col-md-6">
                  <div class="md-form">
                    <input type="text" id="GRBI_CUSFISNAM" maxlength="25" name="GRBI_CUSFISNAM" class="form-control GRBIDBfields IsUpprCse IsAlphaFields GRBIMndtry">
                ...
                <div class="col-md-6 NINDU">
                  <div class="md-form">
                    <input type="text" id="GRBI_CONSTITUTION"  maxlength="25" disabled name="GRBI_CONSTITUTION" class="form-control GRBIDBfields IsAlphaFields">
           ...
           <div class="col-md-6  PROFILE">
              <div class="md-form">
                  <select class="mdb-select md-form colorful-select dropdown-primary PROFILEVAL GRBIDBfields GRBIMndtry"  data-change="GRBI_PROFILE"  onchange="DataToProfFld(this);CheckProfile();" id="GRBI_NPROFILE" name="GRBI_NPROFILE">
                  	<option value="" selected>--Select--</option>
  ...
  <div class="card">
    ...
    <div class="card-header Btxt7" role="tab" id="headingTwo2">
      <a class="collapsed Btxt7 AFormaccordion ACCRDISB  CONLOAD DedupeSmt" data-toggle="collapse" data-form="Contact Details" data-multidata="" data-aria="LSW_TGURCUSADDRINFO|GRAI|GRAI_CUSID|GRBI_CUSID" data-parent="#accordionEx" href="#collapseTwo2"
       ...
       <div class="INDU">  
        ...
        <div class="form-row">
            ...
            <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_ADDRLINI" maxlength="30" name="GRAI_ADDRLINI" class="form-control AddrNoSpecialChar RSADDR GRAIDBfields GRAIMndtry">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_ADDRLINII" maxlength="30" name="GRAI_ADDRLINII" class="form-control AddrNoSpecialChar RSADDR GRAIDBfields">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_CITY" disabled name="GRAI_CITY" class="form-control RSADDR IsAlphaFields GRAIDBfields GRAIMndtry">
        ...
        <div class="form-row">
            <div class="col">
                  <div class="md-form">
                    <input type="text" id="GRAI_STATE" disabled name="GRAI_STATE" class="form-control IsAlphaFields RSADDR GRAIDBfields GRAIMndtry">
                    <label for="GRAI_STATE" class="ADDR">State<span class="MndtryAstr">*</span></label>
                  </div>
                </div>
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="GRAI_LNDMARK" maxlength="20" name="GRAI_LNDMARK" class="form-control IsAlphaFields RSADDR GRAIDBfields GRAIMndtry">
...
<div class="col-md-5">
        ...
        <div class="form-row">
            <div class="col">
                  <div class="md-form">
                    <input type="text" id="GRAI_PREMADDRLINI" maxlength="30"  name="GRAI_PREMADDRLINI" class="form-control PRADDR AddrNoSpecialChar GRAIDBfields GRAIMndtry">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_PERMADDRLINII" maxlength="30" name="GRAI_PERMADDRLINII" class="form-control AddrNoSpecialChar PRADDR GRAIDBfields">
        ...
        <div class="form-row">
            <div class="col"> 
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_PERMCITY" disabled name="GRAI_PERMCITY"  class="form-control IsAlphaFields PRADDR GRAIDBfields GRAIMndtry">
        ...
        <div class="form-row">
            ...
            <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_PERMSTATE" disabled name="GRAI_PERMSTATE" class="form-control PRADDR IsAlphaFields GRAIDBfields GRAIMndtry">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_PERMLNDMARK" maxlength="20" name="GRAI_PERMLNDMARK" class="form-control IsAlphaFields PRADDR GRAIDBfields GRAIMndtry">
        ...
        <div class="form-row">
            <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_ORGADDRLINI"  maxlength="30" name="GRAI_ORGADDRLINI" class="form-control AddrNoSpecialChar  GRAIDBfields GRAIMndtry">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_ORGADDRLINII" maxlength="30"  name="GRAI_ORGADDRLINII" class="form-control AddrNoSpecialChar GRAIDBfields">
        ...
        <div class="form-row">
            ...
            <div class="col">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="GRAI_ORGLNDMARK" maxlength="20" name="GRAI_ORGLNDMARK" class="form-control IsAlphaFields GRAIDBfields GRAIMndtry">
                        ...
                        <div class="DynamicPageGrid" data-val="PROPTXTHDR|Employment" id="BankDetail1" style="display:none">
                           ...
                           <form>
                              ...
                              <div class="form-row">
                                 <div class="col">
                                    <div class="md-form">
                                       <input type="text" id="GREI_ADDRLINEI" maxlength="30"  name="GREI_ADDRLINEI" class="form-control AddrNoSpecialChar GREIDBfields GREIMndtry">
                                       <label for="GREI_ADDRLINEI" class="">Address Line 1<span class="MndtryAstr">*</span></label>
                                    </div>
                                 </div>
                                 <div class="col">
                                    <div class="md-form">
                                       <input type="text" id="GREI_ADDRLINEII" maxlength="30"  name="GREI_ADDRLINEII" class="form-control AddrNoSpecialChar GREIDBfields">
                              ...
                              <div class="form-row">
                                 <div class="col">
                                    <div class="md-form">
                                       <input type="text" id="GREI_DATOFESTABLIS" maxlength="10" onblur="CompareJointoDOB(this,GRBI_DOB,GREI_NOOFYERBUSINESS,'GRBI_PROFILE');ExpYearvalid(this,GREI_NOOFYERBUSINESS);" name="GREI_DATOFESTABLIS" class="form-control  ISFutureDateFields GREIDBfields IsNumberFields ISDatefield ">
      ...
      <div class="card-body px-lg-5 pt-0">
        ...
        <div class="form-row">
            <div class="col">
               ...
               <div class="col">
                  <div class="md-form">
                    <input type="text" id="GUOA_INCORPDT" maxlength="10"  name="GUOA_INCORPDT" class="form-control ISFutureDateFields GUOADBfields IsNumberFields ISDatefield  NoSpecialChar GUOAMndtry">
