...
<!-- 			 <div class="col-md-6  INDU">
  ...
  <div class="INDU">
        ...
        <div class="form-row">
            <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_ADDRLINI" maxlength="40" name="CADI_ADDRLINI" class="form-control  AddrNoSpecialChar RSADDR RESSTAT CADIDBfields CADIMndtry">
                    <label for="CADI_ADDRLINI" class="">Address Line 1<span class="MndtryAstr">*</span></label>
                  </div>
                </div>
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_ADDRLINII" maxlength="40" name="CADI_ADDRLINII" class="form-control AddrNoSpecialChar RSADDR RESSTAT  CADIDBfields">
...
<div class="col-md-5">
                              ...
                              <form>
					        	...
					        	<div class="col Btxt10">	 DETAILS</div>
                                 ...
                                 <div class="form-row">
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_ADDRLINEI" maxlength="40" name="CEMI_ADDRLINEI" class="form-control CEMIDBfields OFFADDR CEMIMndtry AddrNoSpecialChar CEMIMndtry PROCHGS">
                                          <label for="CEMI_ADDRLINEI" class="OADDR PROCHGAC">Address Line 1<span class="MndtryAstr">*</span></label>
                                       </div>
                                    </div>
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_ADDRLINEII" maxlength="40" name="CEMI_ADDRLINEII" class="form-control CEMIDBfields OFFADDR AddrNoSpecialChar PROCHGS">
  ...
  <div class="card NINDU ORG">
    ...
    <div class="card-header Btxt7" role="tab" id="headingFour4">
      <a class="collapsed Btxt7 AFormaccordion ORGDETL ACCRDISB" data-toggle="collapse" data-multidata="" data-form="Organisation Details" data-aria="LSW_TCUSORGDTL|CDOG|CDOG_CUSID|CBSI_CUSID" data-load="" data-parent="#accordionEx" href="#collapseFour4"
