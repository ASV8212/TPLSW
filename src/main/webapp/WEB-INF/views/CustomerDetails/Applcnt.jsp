    ...
    <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
      ...
      <div class="card-body px-lg-5 pt-0">
        ...
        <div class="form-row VERIFYBTNPOSITION ">
			...
			<div class="col-md-6  ">
		            <div class="md-form">
                    <input type="text" id="CADI_CGEOLIMIT" disabled maxlength="20" name="CADI_CGEOLIMIT" class="form-control IsNumberFields IsCURCommaFields CADIMndtry CADIDBfields  NoSpecialChar   ">
					<button type="button" class=" btn   btn-Verify waves-effect btn-yelInplain btn-sm BTNVerify VERIFYBTNPOSITIONRIGHT GEOLIMIT " onclick="getLocation('CADI_CUSID','CADI_LAT','CADI_LONG','CADI_CGEOLIMIT')" ><i class="fa fa-map-marker"></i> Initiate Geo Tagging</button>
...
<div class="col-md-5">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <div class="col">
                  <div class="md-form">
                    <input type="text" id="CADI_PERMADDRLINII" maxlength="60" name="CADI_PERMADDRLINII" class="form-control AddrNoSpecialChar PRADDR CADIMndtry CADIDBfields">
		...
		<div class="col-md-4">
                     <div class="md-form">
						...
						<label for="" class="active">Permanent Address<span class="MndtryAstr"></span></label>
						 </br>

                          <textarea class="form-control CADIDBfields DSVLBL Btxt10 DataNormal" disabled rows="5" id="CADI_PERMANENTNAME" name="CADI_PERMANENTNAME" style="height: 100px;width:380px;" disabled="disabled"></textarea>
        ...
        <div class="form-row">
              <div class="col">
                ...
                <div class="col">
                  ...
                  <div class="md-form">
                    <input type="text" id="CADI_ORGADDRLINII" maxlength="60"  name="CADI_ORGADDRLINII" class="form-control ORGADD AddrNoSpecialChar CADIMndtry CADIDBfields">
                              ...
                              <form>
					        	...
					        	<div class="col Btxt10">	 DETAILS</div>
                                 ...
                                 <div class="form-row">
                                    ...
                                    <div class="col">
                                       <div class="md-form">
                                          <input type="text" id="CEMI_ADDRLINEII" maxlength="60" name="CEMI_ADDRLINEII" class="form-control CEMIDBfields OFFADDR AddrNoSpecialChar CEMIMndtry PROCHGS">
                                          <label for="CEMI_ADDRLINEII" class="OADDR PROCHGAC">Address Line 2<span class="MndtryAstr">*</span></label>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="form-row">
		...
		<div class="form-row">
		    ...
		    <div class="form-row">
				...
				<div class="col-md-6">
                    ...
                    <label for="CDOG_KYCCATEGORY" class="">KYC Risk Category<span class="MndtryAstr"></span></label>
					</div>
					</div>
				</div>
      <!--<div class="form-row">
  ...
  if (navigator.geolocation) {
		...
		if((($("#"+Lat).val()) !=  "") && (($("#"+Long).val()) != ""))
	{
		...
		GetCoordinateDistance(Lat+"~"+obj.data.lat,Long+"~"+obj.data.lang,"CADI_GEOFLDGHTMLTOAPI","HTML TO API");
	 	 /*  var ca = UI_getdata($("#PrcsID").val(),"","","","","LSW_SGETCUSLTLNPOSITION1");
		var Lat1 = $(ca).find("Lat").text();
		var Long1 = $(ca).find("Long").text(); */  
		//obj.data.lat  obj.data.lang
		//GetCoordinateDistance(Lat+"~"+Lat1,Long+"~"+Long1,"CADI_GEOFLDGHTMLTOAPI","HTML TO API");
