...
<div class="col-md-8  Formcol-mdLR">
<div class="md-form">
<input type="text" id="COBI_PAN" name="COBI_PAN" onchange="InactivePanCheck();" maxlength="10" data-link="COBI_PAN|COBI_PANVERIFY|pan|panupload|panview|COBI_PANATTACHMENT|Upload PAN ID" data-validate="COBI_CUSTYPE|COBI_CONSTITUTION" class=" COBIDBfields datalink NoSpecialChar IsPanFields form-control validate" onblur="DupPanval('COBI_PRCSID','COBI_PAN','COBI_CONSTITUTION','COBI_CUSID');CheckPanORNot();">
...
<button type="button" data-Validatearia="COBI_PANVERIFY" onclick="CheckValidPanKyc('COBI_PAN','COBI_PANVERIFY','COBI_CUSFISNAM','COBI_CUSLSTNAM','COBI_CUSTYPE','COBI_CUSID','COAI_ADDRLINI','COAI_ADDRLINII','COEI_INCCONSID','COOA_INCCONSID','COBI_PROFILE');FncallDocChkLst(this,'Table3',{spname:'LSW_SNONIGSTLIST',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:$('#COBI_CUSID').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||3','PANKARZAGRD');"  data-validate="pan"   class="btn COBI_PAN waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>
</div>
</div>  
</div>
...
<div class="col-md-8  Formcol-mdLR">
<div class="md-form">
<input type="text" id="COBI_CKYC" maxlength="14" data-link="COBI_CKYC|COBI_CKYCVERIFY" name="COBI_CKYC" disabled class="COBIDBfields datalink NoSpecialChar IsNumberFields form-control validate">
...
<button type="button" data-Validatearia="COBI_CKYCVERIFY"  data-validate="CKYC" class="btn COBI_CKYC waves-effect btn-yelInplain btn-sm BTNVerify">Verify</button>
</div>
</div>  
</div>
</div>
...
<button type="button" data-Validatearia="COBI_VOTERIDVEIRFY" onclick="FncallDocChkLst(this,'Table2',{spname:'LSW_SKARZALIST',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:$('#COBI_CUSID').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||7','KARZAGRD');CheckValidKyc('COBI_VOTERID','voter','COBI_VOTERIDVEIRFY','','','','','COBI_CUSID');"  data-validate="voter" class="btn COBI_VOTERID waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>
...
<div class="md-form">
<input type="text" id="COBI_DRIVLICNS"  maxlength="20" data-FetchValidateArea="dl" data-FetchValidate="COBI_DRIVLICNS" onblur="CHKSAMEKYC('COBI_DRIVLICNS','DL');"   data-link="COBI_DRIVLICNS|COBI_DRIVLICNSVERIFY|dl|dlupload|dlview|COBI_DRIVLICATTACHMENT" name="COBI_DRIVLICNS" class="COBIDBfields datalink form-control validate">
...
<div class="md-form">
<input type="text" id="COBI_PASSPORT" maxlength="24" data-FetchValidateArea="Passport"  data-FetchValidate="COBI_PASSPORT" data-link="COBI_PASSPORT|COBI_PASSPORTVERIFY|passport|passportupload|passportview|COBI_PASSPORTATTACHMENT" onblur="CHKSAMEKYC('COBI_PASSPORT','PASSPORT');" name="COBI_PASSPORT" class="COBIDBfields datalink form-control validate">
...
<button type="button" data-Validatearia="COBI_PASSPORTVERIFY" onclick="FncallDocChkLst(this,'Table2',{spname:'LSW_SKARZALIST',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:$('#COBI_CUSID').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||7','KARZAGRD');CheckValidKyc('COBI_PASSPORT','passport','COBI_PASSPORTVERIFY','COBI_CUSFISNAM','COBI_CUSLSTNAM','','COBI_DOB','COBI_CUSID');" data-validate="passport"  class="btn  COBI_PASSPORT waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>
