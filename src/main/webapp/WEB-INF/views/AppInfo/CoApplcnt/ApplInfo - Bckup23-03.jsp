...
<button type="button" onclick="CheckKYCUPLOADDOC(this,'COBI_PANATTACHMENT','COBI_PANUPLOADVERIFY','KYC OCR');" data-field="COBI_CUSFISNAM|COBI_CUSLSTNAM|COBI_CUSTYPE|COBI_CUSID|PAN|COBI_PAN|COBI_CONSTITUTION" data-Validatearia="COBI_PANUPLOADVERIFY" data-validate="pan" class="btn COBI_PANATTACHMENT waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Upload Verify</button>
</div>
</div>
</div>  
</div> 
...
<div class="row AUPL">
<!--First column-->
<div class="col-md-8  Formcol-mdLR Aadharupload">
<div class="md-form">
<table>
 <tr>
  <td>
   <div id="COBI_AADHARATTACHMENTUPLOAD"  class="file-field AUPLD">
    <a class="">
...
<img src="ThemeproLO/Common/Images/UploadImg.png"  title="UPLOAD"  onclick="ReuploadFile(COBI_AADHARATTACHMENT);" class="rounded ReUpld" alt="Cinque Terre" width="20" height="20">  <img src="ThemeproLO/Common/Images/Eyeview.png"  title="VIEW"  onclick="GrdDocDwnld('COBI_AADHARATTACHMENT')" class="rounded " alt="Cinque Terre" width="35" height="25"> 
...
<!--First column-->
<div class="col-md-8  Formcol-mdLR dlupload DUPL">
<div class="md-form">
<table>
<tr>
<td>
