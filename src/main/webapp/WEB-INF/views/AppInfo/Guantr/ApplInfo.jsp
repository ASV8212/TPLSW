...
<div class="col-md-8  Formcol-mdLR">
<div class="md-form">
<input type="text" id="GRBI_PAN" maxlength="10" data-link="GRBI_PAN|GRBI_PANVERIFY|pan|panupload|panview|GRBI_PANATTACHMENT|Upload PAN ID" name="GRBI_PAN" data-validate="GRBI_CUSTYPE|GRBI_CONSTITUTION"   class="GRBIDBfields datalink NoSpecialChar form-control IsPanFields validate" onblur="DupPanval('GRBI_PRCSID','GRBI_PAN','GRBI_CONSTITUTION','GRBI_CUSID');CheckPanORNot();" >
...
<div class="col-md-8  Formcol-mdLR">
<div class="md-form">
<input type="text" id="GRBI_CKYC" maxlength="14" data-link="GRBI_CKYC|GRBI_CKYCVERIFY|voter|voterupload|voterview" disabled name="GRBI_CKYC" class="GRBIDBfields datalink NoSpecialChar IsNumberFields form-control validate">
...
<button type="button" data-Validatearia="GRBI_CKYCVERIFY"  data-validate="CKYC" class="btn GRBI_CKYC waves-effect btn-yelInplain btn-sm BTNVerify">Verify</button>
</div>
</div>  
</div>
  </div>
...
<div class="col-md-8  Formcol-mdLR">
<div class="md-form">
<input type="text" id="GRBI_VOTERID" data-FetchValidateArea="voter" data-FetchValidate="GRBI_VOTERID" data-link="GRBI_VOTERID|GRBI_VOTERIDVEIRFY|voter|voterupload|voterview|GRBI_VOTERIDATTACHMENT" maxlength="10" name="GRBI_VOTERID" class="GRBIDBfields datalink IsVoterFields form-control validate">
...
<button type="button" data-Validatearia="GRBI_DRIVLICNSVERIFY" onclick="FncallDocChkLst(this,'Table2',{spname:'LSW_SKARZALIST',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:$('#GRBI_CUSID').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||7','KARZAGRD');CheckValidKyc('GRBI_DRIVLICNS','dl','GRBI_DRIVLICNSVERIFY','','','','GRBI_DOB','GRBI_CUSID')" data-validate="dl"  class="btn GRBI_DRIVLICNS waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>
...
<button type="button" data-Validatearia="GRBI_PASSPORTVERIFY" onclick="FncallDocChkLst(this,'Table2',{spname:'LSW_SKARZALIST',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:$('#GRBI_CUSID').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||7','KARZAGRD');CheckValidKyc('GRBI_PASSPORT','passport','GRBI_PASSPORTVERIFY','GRBI_CUSFISNAM','GRBI_CUSLSTNAM','','GRBI_DOB','GRBI_CUSID')" data-validate="Passport"  class="btn GRBI_PASSPORT waves-effect btn-yelInplain btn-sm BTNVerify INTDSBV">Verify</button>
