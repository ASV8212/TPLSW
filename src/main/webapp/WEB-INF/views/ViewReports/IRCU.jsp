...
<div class="">
   ...
   <div class="admin-panel">
	  ...
	  <input type="text" id="IRCM_DOCUMNTS" hidden="hidden" name="IRCM_DOCUMNTS" class="form-control IRCMDBfields">
	  <input type="text" id="DOCTYPE" hidden="hidden" name="DOCTYPE" class="form-control">
	  <input type="text" id="DOCNAME" hidden="hidden" name="DOCNAME" class="form-control">
...
<% editData.EditData1(); %>
      ...
      <div class="card cardNS">
         ...
         <div class="card-body px-lg-5 pt-0">
			...
			<div style="display:none;color:red;" class="banner">The Screen Will be Freezed untill External RCU Process Complete</div>
			   ...
			   <div class="col-md-6">
			   <div class="md-form"> <!--btn-sm-->
                  <button type="button" id="MULTIDOWNLOADER" class="btn  waves-effect  btn-yelInplain liSubpageTabIcons" onclick="MULTIDOWNLOADER1('IRCM_CUSID')"><i class="fa fa-eye"></i>View All Documents</button>
               </div>
			   </div>
			   </div>
               </br>
      ...
      <div class="card cardNS">
         ...
         <div class="card-body px-lg-5 pt-0">
            <form >
               ...
               <div class="form-row">
                  <div class="col Btxt3">Post Sanction Documents</div>
               </div>
               </br>
               <div class="form-row">
                  <div class="col">
                     <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'Table5',{spname:'LSW_TGETDOCUMTEMPLE',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:'Others',brid:$('#PrcsID').val(),MnuId:$('#UPDC_CUSID').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||8','DocumentTEMPLATES');" id="BTNKYCOthers" name="BTNKYCOthers" />
                                          ...
                                          <tr>
                                             <td>
                                                <div id="KYCD_DOCATTACHMENTUPLOAD"  class="file-field DDU">
                                                   ...
                                                   <input type="file"  name="datafile" onchange="DocFldUpldHndlr1(KYCD_DOCATTACHMENT,'KYCD_DOCATTACHMENT')" class="KYCD_DOCATTACHMENT"  >
                                                   </a>
   ...
   <table style="display:none" id="GridTable5">
      <thead>
         ...
         <th>RCUD_NAME</th>
         <th>RCUD_UPLOAD</th>
		 <th>RCUD_INITESIGN</th>
		 <th>RCUD_RETERIVEREPORT</th>
		 <th>RCUD_GRIDUPLOAD</th>
		 <th>OPTION</th>
		 <th>RCUD_RCUSTATUS</th>
		 <th>RCUD_RSQURY</th>
		 <th>RCUD_RESULT</th>
		 <th>RCUD_VERFBY</th>
		 <th>RCUD_REMARK</th> 
