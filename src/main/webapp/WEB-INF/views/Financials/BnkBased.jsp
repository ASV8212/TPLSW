...
<th>PVCS_CUSID</th>
  ...
  <script type="text/javascript" src="ThemeproLO/Financials/Script/BNKBased/LoadSubmit.js${DMY13}"></script>
  <script type="text/javascript" src="ThemeproLO/Financials/Script/BNKBased/Validation.js${DMY13}"></script>
