...
<script type="text/javascript" src="ThemeproLO/Financials/Script/TakeoverUBL/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/Financials/Script/TakeoverUBL/Validation.js${DMY13}"></script>                            
