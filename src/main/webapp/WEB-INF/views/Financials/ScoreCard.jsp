  ...
  <div class="card">
	...
	<div class="card-body px-lg-5 pt-0" >
        ...
        <form>
		 ...
		 <div class="form-row">
           <div class="col">
             <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'Table2',{spname:'LSW_SGETSCORECARDDETMSME',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:'',MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||','RCU');" id="BTNRCUGRD" name="BTNRCUGRD" />
...
<script type="text/javascript" src="ThemeproLO/Financials/Script/Scorecard/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/Financials/Script/Scorecard/Validation.js${DMY13}"></script>
