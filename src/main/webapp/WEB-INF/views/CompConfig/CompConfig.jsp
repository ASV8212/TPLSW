...
<label for="description" data-error="wrong" data-success="right" class="">Corporate Code</label>
    ...
    <script type="text/javascript" src="/jw/js/jquery/jquerycluetip/jquery.cluetip.js${DMY13}"></script>
       ...
       <script type="text/javascript" src="ThemeproLO/CompConfig/Script/CompConfig/LoadSubmit/LoadSubmit.js${DMY13}"></script>
      <script type="text/javascript" src="ThemeproLO/CompConfig/Script/CompConfig/Validation/Validation.js${DMY13}"></script>
