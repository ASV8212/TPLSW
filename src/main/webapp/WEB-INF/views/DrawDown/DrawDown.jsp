               ...
               <div class="form-row ">
                ...
                <div class="col-md-9">
                   <div class="HyperControls FltRight"> 
                       <a class="Btxt4 ADDBTN FltRight NEWDRAWDOWN" onclick="InitNewUser();" href="#">Create New Draw Down</a>
     </div> 
      </div>
          </div>
               <div class="form-row">
                  <div class="col">
					 ...
					 <input type="button" style="display:none" class="DashTrg" onclick="FncallMultiPagingGrd(this,'Table2',{spname:'LSW_SLISTUSRWSDRAWDOWN',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#LogUsr').val(),brid:$('#VERTICAL').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||','DRAWDOWN');" id="BTNSANCCONFR" name="BTNSANCCONFR">
...
<script type="text/javascript" src="ThemeproLO/DrawDown/DrawDown/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/DrawDown/DrawDown/Validation.js${DMY13}"></script>                            