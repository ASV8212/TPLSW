	...
	<div class="col-lg-12">
      ...
      <div class="card">
         ...
         <div data-row="" class="card-body px-lg-5 pt-0  ">
		    ...
		    <input type="text" id="TRANCHELON" hidden="hidden" name="TRANCHELON" class="form-control DBMMDBfields">
     ...
     <div class="form-row">
      ...
      <div data-row="" class="DYNROW">
		...
		<input type="text" id="DISB_DISBROI" hidden="hidden" name="DISB_DISBROI" class="form-control DISBDBfields">
		<input type="text" id="DISB_DISBTENURE" hidden="hidden" name="DISB_DISBTENURE" class="form-control DISBDBfields">
		
		<input type="text" id="DISB_OVDISBAMT" hidden="hidden" name="DISB_OVDISBAMT" class="form-control DISBDBfields">
	    ...
	    <div class="col-md-3">
          <div class="HyperControls form-row FltRight" > 
            ...
            <div class="col-md-4">
               <div class="md-form">
                 <input type="text" maxlength="10" class="Btxt14 IsNumberFields ISPastDateFields NoSpecialChar ISFutureDateFields ISDatefield DISBDBfields form-control DISBMndtry " id="DISB_DISBREQDATE" name="DISB_DISBREQDATE" >
                        ...
                        <div class="md-form">
                           <div id="PRO"  class="select-radio ">
							  ...
							  class="custom-control custom-radio custom-control-inline">
                                 <input type="radio" class="custom-control-input DISBDBfields " value="Yes" onclick="HndlPEMI($(this).closest('.DYNROW'))" id="DISBPEMIYES" name="DISB_PEMID">
                                 <label class="custom-control-label" for="DISBPEMIYES">Yes</label>
                              </div>
                              <div class="custom-control custom-radio custom-control-inline ">
                                 <input type="radio" class="custom-control-input DISBDBfields "  value="No"  onclick="HndlPEMI($(this).closest('.DYNROW'))" id="DISBPEMINO" name="DISB_PEMID">
        ...
        <div class="form-row">	   
           ...
           <div class="col-md-4">
               <div class="md-form">
	                <input type="text" id="DISB_ENACHURMNO" disabled name="DISB_ENACHURMNO" class="form-control DISBDBfields"> 
    ...
    <!--Main layout-->
      ...
      <div class="modal-footer align-middle">
       <button type="button" class="btn btn-secondary DISBDBfields" data-dismiss="modal">Close</button>
        ...
        <div class="HyperControls form-row FltRight" > 
	        <a onclick="AddPageMultiData('',$('#DBFD_PRCSID').val(),'','Memo','DBFDDBfields');CheckFavLon();" class="Btxt4 FltRight ADDBTN"  href="#">+ Another Favouring</a>
		 </div>
      </br>     
      ...
      <div data-row="" class="DYNROW">
        ...
        <input type="text" id="DBFD_TRANCHNAME" hidden="hidden" name="DBFD_TRANCHNAME" class="form-control DBFDDBfields">
          ...
          <div class="form-row">
            <div class="col-md-4">
               <div class="md-form">
                    <select class="md-form colorful-select dropdown-primary DBFDDBfields DBFDMndtry DataToFld" data-change="DBFD_FAVORINGHIDDEN"  onchange="DataToFavrFld(this,'Page');GetBnkName($(this).closest('.DYNROW'),'Change',this.value,'DBFD_PAYMODE'+$(this).closest('.DYNROW').attr('data-row')); Chkfav(this);" id="DBFD_FAVOURTYPE" name="DBFD_FAVOURTYPE">
...
<div class="modal fade" id="ODEDUCPOPUP" tabindex="-1" role="dialog" aria-labelledby="ODEDUCPOPUPLabel"
  ...
  <a type="button" id="Popup1" class="btn btn-floating btn-large red KrazaPopup" style="display:none"  data-toggle="modal" data-target="#KrazaPopupIFSC">
 <i class="fa fa-plus"></i></a>
                             
<div class="modal fade" id="KrazaPopupIFSC" tabindex="-1" role="dialog" aria-labelledby="KarzaPopupLabel"
  aria-hidden="true">
  <div class="modal-dialog" style="max-width:1250px" role="document">
    <div class="modal-content">
       <div class="modal-header">
       <div class="Btxt10"></div> 
   <a href="#"><img id="KarzaPopupClose" class="close KrazaPopupIFSC" data-dismiss="modal" aria-label="Close" src="ThemeproLO/Common/FEP/images/Close1.png" alt="DashSearch"></img></a>      
      </div>  
      <div class="modal-body">
         <div class="">
    <!-- Card body -->
     <div class="">
        ...
        <div class="form-row">
           <div class="col">
             <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'Table2',{spname:'LSW_SKARZALISTIFSC',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:$('#PrcsID').val(),brid:$('#DBFD_FAVOURTYPE').val(),MnuId:''},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||4,'KARZAGRDIFSC');" id="BTNKARZAGRDIFSC" name="BTNKARZAGRDIFSC" />
