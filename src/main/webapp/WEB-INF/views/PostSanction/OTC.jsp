   ...
   <div class="card-body px-lg-5 pt-0 BSbrdlight">
	...
	<div class="col-lg-12">
       ...
       <li id="DisbursementChecklist" value="Disbrsmnt" title="Disbursement Checklist" class="nav-item ">
            ...
            <li id="OTC" value="OTC" title="OTC" class="nav-item active">
               <a>
...
<script type="text/javascript" src="ThemeproLO/PostSanction/Script/OTC/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/PostSanction/Script/OTC/Validation.js${DMY13}"></script>                            
