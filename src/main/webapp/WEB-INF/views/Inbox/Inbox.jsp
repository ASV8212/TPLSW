...
InbxRghts()
 ...
 <script type="text/javascript">
   ...
   <script type="text/javascript" src="ThemeproLO/Inbox/Script/Inbox/LoadSubmit/LoadSubmit.js${DMY13}"></script>
    <script type="text/javascript" src="ThemeproLO/Inbox/Script/Inbox/Validation/Validation.js${DMY13}"></script>
