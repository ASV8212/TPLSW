      ...
      <div class="card cardNS">
         ...
         <div class="card-body px-lg-5 pt-0">
            <form >
               ...
               <div class="form-row">
                  <div class="col">
                     <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'Table3',{spname:'LSW_SGETDOCUMTEMPLE',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:'Others',brid:$('#PrcsID').val(),MnuId:$('#UPDC_CUSID').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||8','DocumentTEMPLATES');" id="BTNKYCOthers" name="BTNKYCOthers" />
               ...
               <div class="">
                  ...
                  <div class="">
                     <form>
                       ...
                       <div class="col-md-6">
                <div class="md-form">
                    <input type="text" id="KYCD_DATE" name="KYCD_DATE" class="form-control NoSpecialChar ISPastDateFields KYCDMndtry IsNumberFields ISDatefield FIOVDBfields">
                    <label for="KYCD_DATE" class=""> Date<span class="MndtryAstr"></span></label>
...
<script type="text/javascript" src="ThemeproLO/Commonpage/Doctemplates/LoadSubmit/LoadSubmit.js"></script>
<script type="text/javascript" src="ThemeproLO/Commonpage/Doctemplates/Validation/Validation.js"></script> 
