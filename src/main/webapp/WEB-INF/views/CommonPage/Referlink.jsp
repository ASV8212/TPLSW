  ...
  <!--  card -->
   ...
   <div class="card cardNS">
           <div class="card-body px-lg-5 pt-0">
            <div class="form-row">
        		<div class="col Btxt3">Reference Link</div>
        	</div>
        	
        	</div>
        	
       <div class="HyperControls FltRight" > 
      <a onclick="AddPageMultiData('','','','RFERLINK','OWNADBfields')" class="Btxt4 ADDBTN FltRight"  href="#">+ Add Link</a>
     </div> 
        <div class="card-body px-lg-5 pt-0">
        <form>
     <div data-for="RFERLINK" class="RFERLINK"> 
      </div>
       <div class="DynamicPageGrid" data-val="PROPTXTHDR|" id="RFERLINK" style="display:none" >
       ...
       <div class="form-row">
	        ...
	        <div class=" col-md-1"> 
                  <div class="md-form">
                   <img src="ThemeproLO/Common/Images/Delete_Img.png"   class="DeleteREF DELBTN" alt="Cinque Terre" width="20" height="20"> 
                   </div>
                   </div>
               ...
               <div class=" col-md-5">
                 <div class="md-form">
                   <input type="text" id="OWNA_ENGNAME" maxlength="25" name="OWNA_ENGNAME" class="form-control  OWNADBfields  RELINK">
                    <label for="ENGNAME" class="">English Name<span class="MndtryAstr"></span></label>
                  </div>

                  </div>
               <div class=" col-md-6">
                 <div class="md-form">
                   <input type="text" id="OWNA_URL" maxlength="25" name="OWNA_URL" class="form-control  OWNADBfields  RELINK">
                    <label for="URL" class="">Link<span class="MndtryAstr"></span></label>
                  </div>
...
<script type="text/javascript" src="ThemeproLO/Common/FEP/Calendar/js/monthly.js${DMY13}"></script>
 <script type="text/javascript" src="ThemeproLO/Commonpage/Reflink/LoadSubmit.js${DMY13}"></script>
  <script type="text/javascript" src="ThemeproLO/Commonpage/Reflink/Validation.js${DMY13}"></script>
