...
<script type="text/javascript" src="ThemeproLO/Forms/Script/Tabs.js${DMY13}"></script>
	  ...
	  <script>
	  var encdata="<%=request.getParameter("encdata")%>";
	 // alert(encdata);
	  </script>
   </head>
   <body>
    ...
    <!-- Card body -->   
		   ...
		   <input type="text" id="DMSID" name="DMSID" hidden="hidden" value="${DMSID}" disabled class="Btxt14 DSVLBL form-control">
		   <input type="text" id="UNIQID" name="UNIQID" hidden="hidden" value="${UNIQID}" disabled class="Btxt14 DSVLBL form-control">
           ...
           <div class="col-md-4">
             <div class="md-form">
               <input type="text" id="TXNID" name="TXNID" value="${TXNID}" disabled class="Btxt14 DSVLBL form-control">
       ...
       <div class="col-md-4">
            <div class="md-form">
             <input type="text" id="Message" disabled name="Message" value="${Message}"  class="Btxt14 DSVLBL IsNumberFields NoSpecialChar form-control">
...
$(document).ready(function() {
		...
		//UI_getdata("",$("#UNIQID").val(),$("#DMSID").val(),$("#TXNID").val(),"","LSW_SSTRGSTANALYSISDATA")
    	}
    	else
    	{
    		$(".Fail").show()
