   ...
   <body>
    ...
    <!-- Card body -->   
        ...
        <div class="form-row">
           ...
           <div class="col-md-4">
             <div class="md-form">
               <input type="text" id="TXNID" name="TXNID" value="${TXNID}" disabled class="Btxt14 DSVLBL IsAlphaFields form-control">
                <label for="TXNID"  class="Btxt9 active">Bank Transaction ID</label>
             </div>
           </div> 
         </div>
