...
<script type="text/javascript" src="ThemeproLO/Interface/Atom/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/Interface/Atom/Validation.js${DMY13}"></script> 
    <script>
