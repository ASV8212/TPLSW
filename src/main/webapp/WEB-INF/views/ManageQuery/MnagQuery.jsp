...
<div class="modal fade" id="ESCALATEQUERYModal" tabindex="-1" role="dialog" aria-labelledby="ESCALATEQUERYModalLabel"
 ...
 <div class="form-row">            
  ...
  <div class="modal-dialog" style="max-width:550px" role="document">
   ...
   <script type="text/javascript" src="ThemeproLO/ManageQuery/Script/MnagQuery/LoadSubmit.js${DMY13}"></script>
   <script type="text/javascript" src="ThemeproLO/ManageQuery/Script/MnagQuery/Validation.js${DMY13}"></script>
