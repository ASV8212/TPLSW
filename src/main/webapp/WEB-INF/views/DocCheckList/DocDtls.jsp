      ...
      <div class="card cardNS">
         ...
         <div class="card-body px-lg-5 pt-0">
            <form >
               ...
               <div class="form-row">
                  <div class="col">
                     <input type="button" style="display:none" class="DashTrg" onclick="FncallDocChkLst(this,'Table2',{spname:'LSW_TKYCDOCCHECKLIST1',DBSrc:'currentProfile',TableHeader:'card-headerGridAsh',Mode:'',Param:'KYCDOC',brid:$('#PrcsID').val(),MnuId:$('#UPDC_CUSID').val()},{0:$('#LOCC_BrID'),1:$('#LOCC_BrName')},'||8','DocumentCheckList');" id="BTNKYCDOC" name="BTNKYCDOC" />
...
<script type="text/javascript" src="ThemeproLO/DocCheckList/Script/LoadSubmit/LoadSubmit.js${DMY13}"></script>
<script type="text/javascript" src="ThemeproLO/DocCheckList/Script/Validation/Validation.js${DMY13}"></script> 
