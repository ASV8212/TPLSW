...
<div class="col-md-6">
      <div class="md-form">
        ...
        <label for="LPDT_VREGNO" class="ADDACTVEC">Reg No <span class="MndtryAstr">*</span> </label>
				...
				<div class="col-md-6">
				<div class="md-form">
                    <select class="mdb-select md-form colorful-select dropdown-primary ADDPro LPDTDBfields VEMVAL  vehile"  id="LPDT_VEHILECLASS" name="LPDT_VEHILECLASS">
                  	<option value="">Select</option>	
		...
		<div class="col-md-6">
		 ...
		 <div class="form-row">
		    ...
		    <div class="form-row"> 
			   <div class="col-md-6">
				  <div class="md-form">
                  	<input type="text" id="LPDT_VIDV" name="LPDT_VIDV" maxlength="6"  class="IsGreaterzeroFld form-control ADDPro VEMVAL IsCURCommaFields LPDTDBfields vehile ">
