...
public class UI_formdata_GetHistoryQueuePageHTML {
	...
	public String UI_formdata_GetHistoryQueuePageHTML() throws SQLException {
		...
		preparedStatement = con
				.prepareStatement("{ call SAM_SGetHistQueuePage(?,?) }");
