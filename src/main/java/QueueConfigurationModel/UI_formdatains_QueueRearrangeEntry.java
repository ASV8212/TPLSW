...
public class UI_formdatains_QueueRearrangeEntry {
	private String xml;
	...
	public String UI_formdatains_QueueRearrangeEntry() throws SQLException {
		...
		preparedStatement = con
				.prepareStatement("{ call SAM_sQueueTableConfig(?) }");
