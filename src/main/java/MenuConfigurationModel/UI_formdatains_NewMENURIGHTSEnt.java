...
public class UI_formdatains_NewMENURIGHTSEnt {
	...
	public String UI_formdatains_NewMENURIGHTSEnt() throws SQLException {
		...
		preparedStatement = con
				.prepareStatement("{ call SAM_sMENULEVELGROUPINSERT(?,?,?,?) }");
