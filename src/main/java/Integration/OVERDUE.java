...
public class OVERDUE {
  ...
  public static String OVERDUEFETCH(String Param1,String Param2,String Param3,String Param4,String Param5,String SPName) {
    ...
    try {
    	...
    	REQTYPE="REQ-1";
		proc_stmt = con.prepareStatement("{ call LSW_SOVERDUEFETCH (?,?,?,?,?) }");		
