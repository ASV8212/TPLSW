	...
	/*public static void main(String ap[])
{
	try
	{
		new EmailService().EmailServiceCall("LSW_SGETSCHMAILDTLS", "", "", "");
	...
	public String EmailServiceCall(String spname,String Input1,String Input2,String Processid) throws Exception
	{
		String Result="";
		...
		try
		{
			...
			prs=cons.prepareStatement("{ call LSW_SGETSCHMAILDTLS (?,?,?,?,?) }");
