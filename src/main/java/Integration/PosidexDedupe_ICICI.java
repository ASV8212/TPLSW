...
public class PosidexDedupe_ICICI {
...
//		String contentType="";
		...
		try
		{
			...
			prsPS.setString(1, processid );
			prsPS.setString(2, Input1);
			prsPS.setString(3, Input2);
			prsPS.setString(4, Input3);
    		prsPS.setString(5, Input4);
		    ...
		    */
			 ...
			 // 	{ 
			 proc_stmt1 = con.prepareStatement("{ call SAM_SACCTS_MOBILE_LOS (?,?,?,?,?) }");
			 ...
			 Connections.Call(proc_stmt,rs,con1,"Commit");
