...
//       new FinancialStatement().FinancialServiceCall("LSW_SFINANCIALSTMTCREATE", "X9CN1645871022400", "Review","","", "tdsfds1232");
      // new FinancialStatement().FinancialServiceCall("LSW_SFINANCIALSTMTCREATE", "X9CN1645871022400", "Retrieve","pdf","FSA000007", "tdsfds1232");
//     String json = createJson();
//     System.out.println("JSon value "+json );
//    sendPOST(json);       
    }
    
    public String FinancialServiceCall(String spname,String input1,String input2,String input3,String input4,String processid) throws Exception
    {
...
//			    	  String pwd = "";
			    	...
			    	Result="<Header>"
				  			+ "<APITYPE>"+Filename+"</APITYPE>"
				  			+ "<URL>"+URL+"</URL>"
				  			+ "<SIGNATURE>"+pwdEncrypted+"</SIGNATURE>"
				  			+ "</Header>";
//			    	String finaloutput="password="+signature+"&vendorId="+vendorID;
	        ...
	        Rslt=InterfaceFSAAPI.InterfaceFSAService(URL, finaloutput, contentType, signature);
